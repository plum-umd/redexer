...
.method public getCount()I
    ...
    iget-boolean v5, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mDataValid:Z

    if-eqz v5, :cond_0

    iget-object v5, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mCursor:Landroid/database/Cursor;
...
.method public getFilter()Landroid/widget/Filter;
    ...
    iget-object v5, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mCursorFilter:Landroidx/cursoradapter/widget/CursorFilter;

    if-nez v5, :cond_0

    new-instance v5, Landroidx/cursoradapter/widget/CursorFilter;

    invoke-direct {v5, p0}, Landroidx/cursoradapter/widget/CursorFilter;-><init>(Landroidx/cursoradapter/widget/CursorFilter$CursorFilterClient;)V

    iput-object v5, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mCursorFilter:Landroidx/cursoradapter/widget/CursorFilter;
...
.method public getFilterQueryProvider()Landroid/widget/FilterQueryProvider;
    ...
    const-string v1, "getFilterQueryProvider"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mFilterQueryProvider:Landroid/widget/FilterQueryProvider;
...
.method public getItemId(I)J
    ...
    iget v5, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mRowIDColumn:I
...
.method init(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    iput-boolean v7, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mAutoRequery:Z

    goto/16 :goto_0

    :cond_0
    iput-boolean v6, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mAutoRequery:Z
    ...
    iput-boolean v6, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mDataValid:Z
    ...
    const-string v1, "getColumnIndexOrThrow"
...
.method protected onContentChanged()V
    ...
    iget-boolean v5, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mAutoRequery:Z
...
.method public runQueryOnBackgroundThread(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    const-string v0, "Landroid/widget/FilterQueryProvider;"

    const-string v1, "runQuery"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-interface {v5, p1}, Landroid/widget/FilterQueryProvider;->runQuery(Ljava/lang/CharSequence;)Landroid/database/Cursor;
...
.method public setFilterQueryProvider(Landroid/widget/FilterQueryProvider;)V
    ...
    const-string v1, "setFilterQueryProvider"
...
.method public swapCursor(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    iget-object v6, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mChangeObserver:Landroidx/cursoradapter/widget/CursorAdapter$ChangeObserver;
    ...
    invoke-interface {v5, v6}, Landroid/database/Cursor;->unregisterContentObserver(Landroid/database/ContentObserver;)V
    ...
    :cond_1
    iget-object v6, p0, Landroidx/cursoradapter/widget/CursorAdapter;->mDataSetObserver:Landroid/database/DataSetObserver;
    ...
    invoke-interface {v5, v6}, Landroid/database/Cursor;->unregisterDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-interface {p1, v6}, Landroid/database/Cursor;->registerContentObserver(Landroid/database/ContentObserver;)V
    ...
    invoke-interface {p1, v6}, Landroid/database/Cursor;->registerDataSetObserver(Landroid/database/DataSetObserver;)V

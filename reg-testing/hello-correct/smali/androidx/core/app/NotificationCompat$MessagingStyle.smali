...
.method public static extractMessagingStyleFromNotification(Landroid/app/Notification;)Landroidx/core/app/NotificationCompat$MessagingStyle;
    ...
    const-string v0, "Landroidx/core/app/NotificationCompat$MessagingStyle;"

    const-string v1, "extractMessagingStyleFromNotification"
    ...
    const-string v6, "android.selfDisplayName"
    ...
    const-string v6, "android.messagingStyleUser"
    ...
    invoke-direct {v6}, Landroidx/core/app/NotificationCompat$MessagingStyle;-><init>()V

    invoke-virtual {v6, p0}, Landroidx/core/app/NotificationCompat$MessagingStyle;->restoreFromCompatExtras(Landroid/os/Bundle;)V
    :try_end_0
...
.method private findLatestIncomingMessage()Landroidx/core/app/NotificationCompat$MessagingStyle$Message;
    ...
    const-string v1, "findLatestIncomingMessage"
    ...
    invoke-virtual {v6}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->getPerson()Landroidx/core/app/Person;
...
.method private hasMessagesWithoutSender()Z
    ...
    const-string v1, "hasMessagesWithoutSender"
    ...
    invoke-virtual {v7}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->getPerson()Landroidx/core/app/Person;
...
.method private makeFontColorSpan(I)Landroid/text/style/TextAppearanceSpan;
    ...
    const-string v1, "makeFontColorSpan"
...
.method private makeMessageLine(Landroidx/core/app/NotificationCompat$MessagingStyle$Message;)Ljava/lang/CharSequence;
    ...
    const-string v1, "makeMessageLine"
    ...
    iget-object v9, p0, Landroidx/core/app/NotificationCompat$MessagingStyle;->mUser:Landroidx/core/app/Person;
    ...
    :cond_3
    invoke-virtual {v5, v9}, Landroidx/core/text/BidiFormatter;->unicodeWrap(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v8}, Landroidx/core/app/NotificationCompat$MessagingStyle;->makeFontColorSpan(I)Landroid/text/style/TextAppearanceSpan;
    ...
    invoke-virtual {v6, v8, v9, v7, v11}, Landroid/text/SpannableStringBuilder;->setSpan(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v5, v10}, Landroidx/core/text/BidiFormatter;->unicodeWrap(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method public addCompatExtras(Landroid/os/Bundle;)V
    ...
    const-string v1, "addCompatExtras"
    ...
    invoke-virtual {p1, v6, v5}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    iget-object v5, p0, Landroidx/core/app/NotificationCompat$MessagingStyle;->mConversationTitle:Ljava/lang/CharSequence;

    const-string v6, "android.hiddenConversationTitle"
    ...
    iget-object v5, p0, Landroidx/core/app/NotificationCompat$MessagingStyle;->mIsGroupConversation:Ljava/lang/Boolean;
    ...
    invoke-static {v5}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->getBundleArrayForMessages(Ljava/util/List;)[Landroid/os/Bundle;
    ...
    invoke-virtual {p1, v6, v5}, Landroid/os/Bundle;->putParcelableArray(Ljava/lang/String;[Landroid/os/Parcelable;)V
...
.method public addMessage(Ljava/lang/CharSequence;JLandroidx/core/app/Person;)Landroidx/core/app/NotificationCompat$MessagingStyle;
    ...
    invoke-direct {v5, p1, p2, p3, p4}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;-><init>(Ljava/lang/CharSequence;JLandroidx/core/app/Person;)V

    invoke-virtual {p0, v5}, Landroidx/core/app/NotificationCompat$MessagingStyle;->addMessage(Landroidx/core/app/NotificationCompat$MessagingStyle$Message;)Landroidx/core/app/NotificationCompat$MessagingStyle;
...
.method public addMessage(Ljava/lang/CharSequence;JLjava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$MessagingStyle;
    ...
    invoke-virtual {v7, p4}, Landroidx/core/app/Person$Builder;->setName(Ljava/lang/CharSequence;)Landroidx/core/app/Person$Builder;
    ...
    invoke-direct {v6, p1, p2, p3, p4}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;-><init>(Ljava/lang/CharSequence;JLandroidx/core/app/Person;)V
...
.method public apply(Landroidx/core/app/NotificationBuilderWithBuilderAccessor;)V
    ...
    invoke-virtual {p0, v5}, Landroidx/core/app/NotificationCompat$MessagingStyle;->setGroupConversation(Z)Landroidx/core/app/NotificationCompat$MessagingStyle;
    ...
    invoke-direct {v5, v8}, Landroid/app/Notification$MessagingStyle;-><init>(Landroid/app/Person;)V
    ...
    invoke-direct {v5, v8}, Landroid/app/Notification$MessagingStyle;-><init>(Ljava/lang/CharSequence;)V
    ...
    const-string v0, "Landroid/app/Notification$MessagingStyle;"

    const-string v1, "setConversationTitle"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v5, v8}, Landroid/app/Notification$MessagingStyle;->setConversationTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$MessagingStyle;
    ...
    const-string v1, "setGroupConversation"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v5, v8}, Landroid/app/Notification$MessagingStyle;->setGroupConversation(Z)Landroid/app/Notification$MessagingStyle;
    ...
    :cond_4
    invoke-virtual {v10}, Landroidx/core/app/Person;->toAndroidPerson()Landroid/app/Person;

    move-result-object v10

    :goto_2
    invoke-direct {v11, v12, v13, v14, v10}, Landroid/app/Notification$MessagingStyle$Message;-><init>(Ljava/lang/CharSequence;JLandroid/app/Person;)V
    ...
    invoke-direct {v11, v12, v13, v14, v10}, Landroid/app/Notification$MessagingStyle$Message;-><init>(Ljava/lang/CharSequence;JLjava/lang/CharSequence;)V
    ...
    invoke-virtual {v9}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->getDataUri()Landroid/net/Uri;
    ...
    const-string v0, "Landroid/app/Notification$MessagingStyle$Message;"

    const-string v1, "setData"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v11, v10, v9}, Landroid/app/Notification$MessagingStyle$Message;->setData(Ljava/lang/String;Landroid/net/Uri;)Landroid/app/Notification$MessagingStyle$Message;
    ...
    invoke-virtual {v5, v11}, Landroid/app/Notification$MessagingStyle;->addMessage(Landroid/app/Notification$MessagingStyle$Message;)Landroid/app/Notification$MessagingStyle;
    ...
    invoke-interface/range {v0 .. v0}, Landroidx/core/app/NotificationBuilderWithBuilderAccessor;->getBuilder()Landroid/app/Notification$Builder;
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/app/Notification$MessagingStyle;->setBuilder(Landroid/app/Notification$Builder;)V
    ...
    iget-object v7, p0, Landroidx/core/app/NotificationCompat$MessagingStyle;->mIsGroupConversation:Ljava/lang/Boolean;
    ...
    :goto_8
    iget-object v10, p0, Landroidx/core/app/NotificationCompat$MessagingStyle;->mMessages:Ljava/util/List;
    ...
    invoke-direct {p0, v11}, Landroidx/core/app/NotificationCompat$MessagingStyle;->makeMessageLine(Landroidx/core/app/NotificationCompat$MessagingStyle$Message;)Ljava/lang/CharSequence;
    ...
    :goto_a
    iget-object v12, p0, Landroidx/core/app/NotificationCompat$MessagingStyle;->mMessages:Ljava/util/List;
    ...
    invoke-virtual {v5, v8, v11}, Landroid/text/SpannableStringBuilder;->insert(ILjava/lang/CharSequence;)Landroid/text/SpannableStringBuilder;
    ...
    invoke-direct/range {v0 .. v1}, Landroid/app/Notification$BigTextStyle;-><init>(Landroid/app/Notification$Builder;)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/app/Notification$BigTextStyle;->bigText(Ljava/lang/CharSequence;)Landroid/app/Notification$BigTextStyle;
...
.method public getConversationTitle()Ljava/lang/CharSequence;
    ...
    const-string v1, "getConversationTitle"
...
.method public getUserDisplayName()Ljava/lang/CharSequence;
    ...
    const-string v1, "getUserDisplayName"
...
.method protected restoreFromCompatExtras(Landroid/os/Bundle;)V
    ...
    const-string v1, "restoreFromCompatExtras"
    ...
    invoke-static {v5}, Landroidx/core/app/Person;->fromBundle(Landroid/os/Bundle;)Landroidx/core/app/Person;

    move-result-object v5

    iput-object v5, p0, Landroidx/core/app/NotificationCompat$MessagingStyle;->mUser:Landroidx/core/app/Person;
    ...
    iput-object v5, p0, Landroidx/core/app/NotificationCompat$MessagingStyle;->mConversationTitle:Ljava/lang/CharSequence;

    iget-object v5, p0, Landroidx/core/app/NotificationCompat$MessagingStyle;->mConversationTitle:Ljava/lang/CharSequence;

    if-nez v5, :cond_1

    const-string v5, "android.hiddenConversationTitle"
    ...
    const-string v1, "getParcelableArray"
    ...
    invoke-static {v5}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->getMessagesFromBundleArray([Landroid/os/Parcelable;)Ljava/util/List;

...
.method public static buildActionExtrasMap(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    const-string v0, "Landroidx/core/app/NotificationCompatJellybean;"

    const-string v1, "buildActionExtrasMap"
...
.method private static ensureActionReflectionReadyLocked()Z
    ...
    const-string v1, "ensureActionReflectionReadyLocked"
    ...
    sget-boolean v7, Landroidx/core/app/NotificationCompatJellybean;->sActionsAccessFailed:Z
    ...
    :try_start_0
    sget-object v8, Landroidx/core/app/NotificationCompatJellybean;->sActionsField:Ljava/lang/reflect/Field;

    if-nez v8, :cond_1

    const-string v8, "android.app.Notification$Action"
    :try_end_0
    ...
    :try_start_2
    sput-object v8, Landroidx/core/app/NotificationCompatJellybean;->sActionClass:Ljava/lang/Class;

    sget-object v8, Landroidx/core/app/NotificationCompatJellybean;->sActionClass:Ljava/lang/Class;
    ...
    :try_start_4
    sput-object v8, Landroidx/core/app/NotificationCompatJellybean;->sActionIconField:Ljava/lang/reflect/Field;
    ...
    :try_start_6
    sput-object v8, Landroidx/core/app/NotificationCompatJellybean;->sActionTitleField:Ljava/lang/reflect/Field;
    ...
    :try_start_8
    sput-object v8, Landroidx/core/app/NotificationCompatJellybean;->sActionIntentField:Ljava/lang/reflect/Field;
    ...
    :try_start_a
    sput-object v8, Landroidx/core/app/NotificationCompatJellybean;->sActionsField:Ljava/lang/reflect/Field;
    ...
    sput-boolean v7, Landroidx/core/app/NotificationCompatJellybean;->sActionsAccessFailed:Z
    ...
    :cond_1
    :goto_0
    sget-boolean v5, Landroidx/core/app/NotificationCompatJellybean;->sActionsAccessFailed:Z
...
.method private static fromBundle(Landroid/os/Bundle;)Landroidx/core/app/RemoteInput;
    ...
    const-string v1, "getCharSequenceArray"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0, v6}, Landroid/os/Bundle;->getCharSequenceArray(Ljava/lang/String;)[Ljava/lang/CharSequence;
...
.method private static fromBundleArray([Landroid/os/Bundle;)[Landroidx/core/app/RemoteInput;
    ...
    const-string v1, "fromBundleArray"
    ...
    invoke-static {v7}, Landroidx/core/app/NotificationCompatJellybean;->fromBundle(Landroid/os/Bundle;)Landroidx/core/app/RemoteInput;
...
.method static getActionFromBundle(Landroid/os/Bundle;)Landroidx/core/app/NotificationCompat$Action;
    ...
    const-string v1, "getActionFromBundle"
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/os/Bundle;->getBundle(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/os/Bundle;->getCharSequence(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/os/Bundle;->getParcelable(Ljava/lang/String;)Landroid/os/Parcelable;
    ...
    invoke-static/range {v0 .. v1}, Landroidx/core/app/NotificationCompatJellybean;->getBundleArrayFromBundle(Landroid/os/Bundle;Ljava/lang/String;)[Landroid/os/Bundle;
...
.method private static getBundleArrayFromBundle(Landroid/os/Bundle;Ljava/lang/String;)[Landroid/os/Bundle;
    ...
    const-string v1, "getBundleArrayFromBundle"
    ...
    invoke-virtual {p0, p1, v5}, Landroid/os/Bundle;->putParcelableArray(Ljava/lang/String;[Landroid/os/Parcelable;)V
...
.method static getBundleForAction(Landroidx/core/app/NotificationCompat$Action;)Landroid/os/Bundle;
    ...
    const-string v1, "getBundleForAction"
...
.method public static readAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;)Landroidx/core/app/NotificationCompat$Action;
    ...
    const-string v5, "android.support.remoteInputs"
    ...
    const-string v6, "android.support.dataRemoteInputs"
    ...
    invoke-direct/range {v5 .. v14}, Landroidx/core/app/NotificationCompat$Action;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Landroidx/core/app/RemoteInput;[Landroidx/core/app/RemoteInput;ZIZ)V
...
.method private static toBundle(Landroidx/core/app/RemoteInput;)Landroid/os/Bundle;
    ...
    const-string v1, "putCharSequenceArray"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v5, v7, v6}, Landroid/os/Bundle;->putCharSequenceArray(Ljava/lang/String;[Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v5, p0, v6}, Landroid/os/Bundle;->putStringArrayList(Ljava/lang/String;Ljava/util/ArrayList;)V
...
.method private static toBundleArray([Landroidx/core/app/RemoteInput;)[Landroid/os/Bundle;
    ...
    invoke-static {v7}, Landroidx/core/app/NotificationCompatJellybean;->toBundle(Landroidx/core/app/RemoteInput;)Landroid/os/Bundle;
...
.method public static writeActionAndGetExtras(Landroid/app/Notification$Builder;Landroidx/core/app/NotificationCompat$Action;)Landroid/os/Bundle;
    ...
    const-string v1, "writeActionAndGetExtras"
    ...
    invoke-virtual {p0, v5, v6, v7}, Landroid/app/Notification$Builder;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;
    ...
    invoke-direct {p0, v5}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V
    ...
    const-string v6, "android.support.remoteInputs"
    ...
    invoke-virtual {p0, v6, v5}, Landroid/os/Bundle;->putParcelableArray(Ljava/lang/String;[Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, v5, p1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

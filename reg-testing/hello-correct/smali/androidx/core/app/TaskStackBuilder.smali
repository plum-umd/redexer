...
.method public static create(Landroid/content/Context;)Landroidx/core/app/TaskStackBuilder;
    ...
    const-string v0, "Landroidx/core/app/TaskStackBuilder;"
    ...
    invoke-direct {v5, p0}, Landroidx/core/app/TaskStackBuilder;-><init>(Landroid/content/Context;)V
...
.method public addNextIntent(Landroid/content/Intent;)Landroidx/core/app/TaskStackBuilder;
    ...
    const-string v1, "addNextIntent"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/core/app/TaskStackBuilder;->mIntents:Ljava/util/ArrayList;
...
.method public addNextIntentWithParentStack(Landroid/content/Intent;)Landroidx/core/app/TaskStackBuilder;
    ...
    iget-object v5, p0, Landroidx/core/app/TaskStackBuilder;->mSourceContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v5}, Landroidx/core/app/TaskStackBuilder;->addParentStack(Landroid/content/ComponentName;)Landroidx/core/app/TaskStackBuilder;
...
.method public addParentStack(Landroid/app/Activity;)Landroidx/core/app/TaskStackBuilder;
    ...
    const-string v1, "addParentStack"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    instance-of v5, p1, Landroidx/core/app/TaskStackBuilder$SupportParentable;

    if-eqz v5, :cond_0

    move-object v5, p1

    check-cast v5, Landroidx/core/app/TaskStackBuilder$SupportParentable;
    ...
    invoke-interface {v5}, Landroidx/core/app/TaskStackBuilder$SupportParentable;->getSupportParentActivityIntent()Landroid/content/Intent;
    ...
    invoke-virtual {p0, v5}, Landroidx/core/app/TaskStackBuilder;->addNextIntent(Landroid/content/Intent;)Landroidx/core/app/TaskStackBuilder;
...
.method public addParentStack(Landroid/content/ComponentName;)Landroidx/core/app/TaskStackBuilder;
    ...
    :try_start_0
    iget-object v6, p0, Landroidx/core/app/TaskStackBuilder;->mSourceContext:Landroid/content/Context;

    invoke-static {v6, p1}, Landroidx/core/app/NavUtils;->getParentActivityIntent(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Intent;
    ...
    iget-object v6, p0, Landroidx/core/app/TaskStackBuilder;->mIntents:Ljava/util/ArrayList;
    :try_end_0
    ...
    invoke-direct {v5, p1}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/Throwable;)V
...
.method public addParentStack(Ljava/lang/Class;)Landroidx/core/app/TaskStackBuilder;
    ...
    invoke-direct {v5, v6, p1}, Landroid/content/ComponentName;-><init>(Landroid/content/Context;Ljava/lang/Class;)V
...
.method public getIntentCount()I
    ...
    const-string v1, "getIntentCount"
...
.method public getIntents()[Landroid/content/Intent;
    ...
    iget-object v7, p0, Landroidx/core/app/TaskStackBuilder;->mIntents:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Landroidx/core/app/TaskStackBuilder;->mIntents:Ljava/util/ArrayList;
...
.method public getPendingIntent(II)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, p2, v5}, Landroidx/core/app/TaskStackBuilder;->getPendingIntent(IILandroid/os/Bundle;)Landroid/app/PendingIntent;
...
.method public getPendingIntent(IILandroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {v6, p1, v5, p2, p3}, Landroid/app/PendingIntent;->getActivities(Landroid/content/Context;I[Landroid/content/Intent;ILandroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    invoke-static {p3, p1, v5, p2}, Landroid/app/PendingIntent;->getActivities(Landroid/content/Context;I[Landroid/content/Intent;I)Landroid/app/PendingIntent;
...
.method public startActivities()V
    ...
    invoke-virtual {p0, v5}, Landroidx/core/app/TaskStackBuilder;->startActivities(Landroid/os/Bundle;)V
...
.method public startActivities(Landroid/os/Bundle;)V
    ...
    invoke-static {v6, v5, p1}, Landroidx/core/content/ContextCompat;->startActivities(Landroid/content/Context;[Landroid/content/Intent;Landroid/os/Bundle;)Z
    ...
    invoke-direct {p1, v5}, Landroid/content/Intent;-><init>(Landroid/content/Intent;)V
    ...
    const-string v5, "No intents added to TaskStackBuilder; cannot startActivities"

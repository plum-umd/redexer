...
.method static getBundleArrayForMessages(Ljava/util/List;)[Landroid/os/Bundle;
    ...
    const-string v0, "Landroidx/core/app/NotificationCompat$MessagingStyle$Message;"

    const-string v1, "getBundleArrayForMessages"
    ...
    check-cast v8, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;

    invoke-direct {v8}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->toBundle()Landroid/os/Bundle;
...
.method static getMessageFromBundle(Landroid/os/Bundle;)Landroidx/core/app/NotificationCompat$MessagingStyle$Message;
    ...
    const-string v1, "getMessageFromBundle"
    ...
    :try_start_0
    invoke-virtual {p0, v12}, Landroid/os/Bundle;->containsKey(Ljava/lang/String;)Z
    ...
    :try_start_2
    invoke-virtual {p0, v11}, Landroid/os/Bundle;->containsKey(Ljava/lang/String;)Z
    ...
    :try_start_7
    invoke-static {v8}, Landroidx/core/app/Person;->fromBundle(Landroid/os/Bundle;)Landroidx/core/app/Person;
    ...
    invoke-static {v8}, Landroidx/core/app/Person;->fromAndroidPerson(Landroid/app/Person;)Landroidx/core/app/Person;
    ...
    :try_start_f
    invoke-virtual {v9, v8}, Landroidx/core/app/Person$Builder;->setName(Ljava/lang/CharSequence;)Landroidx/core/app/Person$Builder;
    ...
    :goto_0
    new-instance v9, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;
    :try_end_f
    ...
    :try_start_10
    invoke-virtual {p0, v12}, Landroid/os/Bundle;->getCharSequence(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    :try_start_12
    invoke-direct {v9, v10, v11, v12, v8}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;-><init>(Ljava/lang/CharSequence;JLandroidx/core/app/Person;)V
    :try_end_12
    ...
    move-result v8
    :try_end_13
    .catch Ljava/lang/ClassCastException; {:try_start_13 .. :try_end_13} :catch_0
    ...
    if-eqz v8, :cond_4
    :try_end_14
    .catch Ljava/lang/ClassCastException; {:try_start_14 .. :try_end_14} :catch_0
    ...
    move-result v8
    :try_end_15
    .catch Ljava/lang/ClassCastException; {:try_start_15 .. :try_end_15} :catch_0
    ...
    if-eqz v8, :cond_4
    :try_end_16
    .catch Ljava/lang/ClassCastException; {:try_start_16 .. :try_end_16} :catch_0
    ...
    :try_end_17
    .catch Ljava/lang/ClassCastException; {:try_start_17 .. :try_end_17} :catch_0
    ...
    :try_end_18
    .catch Ljava/lang/ClassCastException; {:try_start_18 .. :try_end_18} :catch_0
    ...
    invoke-virtual {v9, v7, v5}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->setData(Ljava/lang/String;Landroid/net/Uri;)Landroidx/core/app/NotificationCompat$MessagingStyle$Message;
    :try_end_19
    .catch Ljava/lang/ClassCastException; {:try_start_19 .. :try_end_19} :catch_0
    ...
    invoke-virtual {v9}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->getExtras()Landroid/os/Bundle;

    move-result-object v5
    :try_end_1b
    .catch Ljava/lang/ClassCastException; {:try_start_1b .. :try_end_1b} :catch_0
    ...
    :try_start_1d
    invoke-virtual {v5, p0}, Landroid/os/Bundle;->putAll(Landroid/os/Bundle;)V
    :try_end_1d
...
.method static getMessagesFromBundleArray([Landroid/os/Parcelable;)Ljava/util/List;
    ...
    const-string v1, "getMessagesFromBundleArray"
    ...
    invoke-static {v7}, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->getMessageFromBundle(Landroid/os/Bundle;)Landroidx/core/app/NotificationCompat$MessagingStyle$Message;
...
.method private toBundle()Landroid/os/Bundle;
    ...
    iget-object v6, p0, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->mText:Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-wide v6, p0, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->mTimestamp:J
    ...
    iget-object v6, p0, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->mPerson:Landroidx/core/app/Person;
    ...
    invoke-virtual {v6}, Landroidx/core/app/Person;->toBundle()Landroid/os/Bundle;
    ...
    :cond_2
    :goto_0
    iget-object v6, p0, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->mDataMimeType:Ljava/lang/String;
    ...
    :cond_3
    iget-object v6, p0, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->mDataUri:Landroid/net/Uri;
    ...
    :cond_4
    iget-object v6, p0, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->mExtras:Landroid/os/Bundle;
...
.method public getDataMimeType()Ljava/lang/String;
    ...
    const-string v1, "getDataMimeType"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->mDataMimeType:Ljava/lang/String;
...
.method public getPerson()Landroidx/core/app/Person;
    ...
    iget-object v5, p0, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->mPerson:Landroidx/core/app/Person;
...
.method public getText()Ljava/lang/CharSequence;
    ...
    iget-object v5, p0, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->mText:Ljava/lang/CharSequence;
...
.method public getTimestamp()J
    ...
    iget-wide v5, p0, Landroidx/core/app/NotificationCompat$MessagingStyle$Message;->mTimestamp:J

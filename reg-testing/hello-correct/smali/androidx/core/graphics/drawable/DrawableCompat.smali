...
.method public static applyTheme(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources$Theme;)V
    ...
    const-string v0, "Landroidx/core/graphics/drawable/DrawableCompat;"
...
.method public static clearColorFilter(Landroid/graphics/drawable/Drawable;)V
    ...
    const-string v0, "Landroid/graphics/drawable/InsetDrawable;"
    ...
    const-string v0, "Landroid/graphics/drawable/DrawableContainer;"
    ...
    const-string v0, "Landroid/graphics/drawable/DrawableContainer$DrawableContainerState;"
    ...
    invoke-virtual {p0, v5}, Landroid/graphics/drawable/DrawableContainer$DrawableContainerState;->getChild(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v7}, Landroidx/core/graphics/drawable/DrawableCompat;->clearColorFilter(Landroid/graphics/drawable/Drawable;)V
...
.method public static getLayoutDirection(Landroid/graphics/drawable/Drawable;)I
    ...
    sget-boolean v5, Landroidx/core/graphics/drawable/DrawableCompat;->sGetLayoutDirectionMethodFetched:Z
    ...
    const-string v9, "getLayoutDirection"
    ...
    :try_start_2
    sput-object v8, Landroidx/core/graphics/drawable/DrawableCompat;->sGetLayoutDirectionMethod:Ljava/lang/reflect/Method;

    sget-object v8, Landroidx/core/graphics/drawable/DrawableCompat;->sGetLayoutDirectionMethod:Ljava/lang/reflect/Method;
    :try_end_2
    ...
    const-string v9, "Failed to retrieve getLayoutDirection() method"
    ...
    :cond_1
    sget-object v5, Landroidx/core/graphics/drawable/DrawableCompat;->sGetLayoutDirectionMethod:Ljava/lang/reflect/Method;
    ...
    const-string v5, "Failed to invoke getLayoutDirection() via reflection"
...
.method public static setLayoutDirection(Landroid/graphics/drawable/Drawable;I)Z
    ...
    sget-boolean v5, Landroidx/core/graphics/drawable/DrawableCompat;->sSetLayoutDirectionMethodFetched:Z
    ...
    :try_start_2
    sput-object v5, Landroidx/core/graphics/drawable/DrawableCompat;->sSetLayoutDirectionMethod:Ljava/lang/reflect/Method;

    sget-object v5, Landroidx/core/graphics/drawable/DrawableCompat;->sSetLayoutDirectionMethod:Ljava/lang/reflect/Method;
    :try_end_2
    .catch Ljava/lang/NoSuchMethodException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    const-string v9, "Failed to retrieve setLayoutDirection(int) method"
    ...
    invoke-static {v6, v9, v5}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    :goto_0
    sput-boolean v8, Landroidx/core/graphics/drawable/DrawableCompat;->sSetLayoutDirectionMethodFetched:Z
    ...
    invoke-static {v6, p1, p0}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method public static setTint(Landroid/graphics/drawable/Drawable;I)V
    ...
    :cond_0
    instance-of v5, p0, Landroidx/core/graphics/drawable/TintAwareDrawable;
...
.method public static wrap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v5, p0}, Landroidx/core/graphics/drawable/WrappedDrawableApi21;-><init>(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {v5, p0}, Landroidx/core/graphics/drawable/WrappedDrawableApi14;-><init>(Landroid/graphics/drawable/Drawable;)V

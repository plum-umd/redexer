...
.method public static getColor(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)I
    ...
    const-string v0, "Landroidx/core/content/res/ResourcesCompat;"
...
.method private static loadFont(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v6, p1, p2, v5}, Landroid/content/res/Resources;->getValue(ILandroid/util/TypedValue;Z)V
    ...
    invoke-static/range {v5 .. v12}, Landroidx/core/content/res/ResourcesCompat;->loadFont(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
...
.method private static loadFont(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    const-string v16, "ResourcesCompat"
    ...
    invoke-virtual/range {v0 .. v1}, Ljava/lang/String;->startsWith(Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {v5, v9, v10}, Landroidx/core/graphics/TypefaceCompat;->findFromCache(Landroid/content/res/Resources;II)Landroid/graphics/Typeface;
    ...
    :try_start_5
    invoke-static {v6, v5}, Landroidx/core/content/res/FontResourcesParserCompat;->parse(Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources;)Landroidx/core/content/res/FontResourcesParserCompat$FamilyResourceEntry;
    ...
    invoke-static/range {v0 .. v4}, Landroidx/core/graphics/TypefaceCompat;->createFromResourcesFontFile(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v14, v5, v15}, Landroidx/core/content/res/ResourcesCompat$FontCallback;->callbackSuccessAsync(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    const-string v7, "Failed to parse xml resource "
    ...
    invoke-virtual {v5, v9}, Landroid/content/res/Resources;->getResourceName(I)Ljava/lang/String;
    ...
    invoke-direct {v7, v5}, Landroid/content/res/Resources$NotFoundException;-><init>(Ljava/lang/String;)V

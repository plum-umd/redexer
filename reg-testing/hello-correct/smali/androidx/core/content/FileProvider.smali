...
.method private static varargs buildPath(Ljava/io/File;[Ljava/lang/String;)Ljava/io/File;
    ...
    const-string v0, "Landroidx/core/content/FileProvider;"

    const-string v1, "buildPath"
...
.method private static copyOf([Ljava/lang/Object;I)[Ljava/lang/Object;
    ...
    invoke-static {p0, v6, v5, v6, p1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
...
.method private static parsePathStrategy(Landroid/content/Context;Ljava/lang/String;)Landroidx/core/content/FileProvider$PathStrategy;
    ...
    const-string v1, "parsePathStrategy"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Landroidx/core/content/FileProvider$SimplePathStrategy;

    invoke-direct {v5, p1}, Landroidx/core/content/FileProvider$SimplePathStrategy;-><init>(Ljava/lang/String;)V
    ...
    const-string v0, "Landroid/content/pm/ProviderInfo;"

    const-string v1, "loadXmlMetaData"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p1, v6, v7}, Landroid/content/pm/ProviderInfo;->loadXmlMetaData(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/res/XmlResourceParser;
    ...
    invoke-interface {p1, v8, v10}, Landroid/content/res/XmlResourceParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v8}, Landroidx/core/content/ContextCompat;->getExternalFilesDirs(Landroid/content/Context;Ljava/lang/String;)[Ljava/io/File;
    ...
    invoke-virtual {v5, v9, v6}, Landroidx/core/content/FileProvider$SimplePathStrategy;->addRoot(Ljava/lang/String;Ljava/io/File;)V
...
.method public attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V
    ...
    const-string v0, "Landroid/content/ContentProvider;"
    ...
    iget-boolean v5, p2, Landroid/content/pm/ProviderInfo;->exported:Z

    if-nez v5, :cond_1

    iget-boolean v5, p2, Landroid/content/pm/ProviderInfo;->grantUriPermissions:Z
...
.method public getType(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v5, p0, Landroidx/core/content/FileProvider;->mStrategy:Landroidx/core/content/FileProvider$PathStrategy;
    ...
    invoke-interface {v5, p1}, Landroidx/core/content/FileProvider$PathStrategy;->getFileForUri(Landroid/net/Uri;)Ljava/io/File;
    ...
    const-string v0, "Landroid/webkit/MimeTypeMap;"

    const-string v1, "getSingleton"
    ...
    const-string v1, "getMimeTypeFromExtension"
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :cond_3
    invoke-static {p3, v6}, Landroidx/core/content/FileProvider;->copyOf([Ljava/lang/String;I)[Ljava/lang/String;

    move-result-object p1

    invoke-static {p4, v6}, Landroidx/core/content/FileProvider;->copyOf([Ljava/lang/Object;I)[Ljava/lang/Object;
    ...
    const-string v0, "Landroid/database/MatrixCursor;"

...
.method public static createShortcutResultIntent(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Landroid/content/Intent;
    ...
    const-string v0, "Landroidx/core/content/pm/ShortcutManagerCompat;"
    ...
    const-string v0, "Landroid/content/pm/ShortcutManager;"

    const-string v1, "createShortcutResultIntent"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0, v5}, Landroid/content/pm/ShortcutManager;->createShortcutResultIntent(Landroid/content/pm/ShortcutInfo;)Landroid/content/Intent;
...
.method public static isRequestPinShortcutSupported(Landroid/content/Context;)Z
    ...
    :cond_0
    const-string v5, "com.android.launcher.permission.INSTALL_SHORTCUT"
    ...
    invoke-virtual {p0, v6, v7}, Landroid/content/pm/PackageManager;->queryBroadcastReceivers(Landroid/content/Intent;I)Ljava/util/List;
...
.method public static requestPinShortcut(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;Landroid/content/IntentSender;)Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroidx/core/content/pm/ShortcutInfoCompat;->toShortcutInfo()Landroid/content/pm/ShortcutInfo;
    ...
    invoke-virtual/range {v0 .. v2}, Landroid/content/pm/ShortcutManager;->requestPinShortcut(Landroid/content/pm/ShortcutInfo;Landroid/content/IntentSender;)Z
    ...
    invoke-virtual/range {v0 .. v1}, Landroidx/core/content/pm/ShortcutInfoCompat;->addToIntent(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    new-instance v10, Landroidx/core/content/pm/ShortcutManagerCompat$1;

    move-object/from16 v0, v10

    move-object/from16 v1, p2

    invoke-direct/range {v0 .. v1}, Landroidx/core/content/pm/ShortcutManagerCompat$1;-><init>(Landroid/content/IntentSender;)V
    ...
    const-string v1, "sendOrderedBroadcast"

...
.method private computeTargetVelocity(IFFF)F
    ...
    const-string v1, "computeTargetVelocity"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/core/widget/AutoScrollHelper;->mRelativeEdges:[F

    aget v5, v5, p1

    iget-object v6, p0, Landroidx/core/widget/AutoScrollHelper;->mMaximumEdges:[F

    aget v6, v6, p1

    invoke-direct {p0, v5, p3, v6, p2}, Landroidx/core/widget/AutoScrollHelper;->getEdgeValue(FFFF)F
    ...
    :cond_0
    iget-object v5, p0, Landroidx/core/widget/AutoScrollHelper;->mRelativeVelocity:[F

    aget v5, v5, p1

    iget-object v6, p0, Landroidx/core/widget/AutoScrollHelper;->mMinimumVelocity:[F

    aget v6, v6, p1

    iget-object v7, p0, Landroidx/core/widget/AutoScrollHelper;->mMaximumVelocity:[F
    ...
    invoke-static {p2, v6, p1}, Landroidx/core/widget/AutoScrollHelper;->constrain(FFF)F
...
.method private constrainEdgeValue(FF)F
    ...
    const-string v1, "constrainEdgeValue"
    ...
    :cond_0
    iget v6, p0, Landroidx/core/widget/AutoScrollHelper;->mEdgeType:I
...
.method private getEdgeValue(FFFF)F
    ...
    invoke-static {p1, v5, p3}, Landroidx/core/widget/AutoScrollHelper;->constrain(FFF)F
...
.method private requestStop()V
    ...
    iget-boolean v5, p0, Landroidx/core/widget/AutoScrollHelper;->mNeedsReset:Z
    ...
    invoke-virtual {v5}, Landroidx/core/widget/AutoScrollHelper$ClampedScroller;->requestStop()V
...
.method private startAnimating()V
    ...
    iget-object v5, p0, Landroidx/core/widget/AutoScrollHelper;->mRunnable:Ljava/lang/Runnable;

    if-nez v5, :cond_0

    new-instance v5, Landroidx/core/widget/AutoScrollHelper$ScrollAnimationRunnable;

    invoke-direct {v5, p0}, Landroidx/core/widget/AutoScrollHelper$ScrollAnimationRunnable;-><init>(Landroidx/core/widget/AutoScrollHelper;)V

    iput-object v5, p0, Landroidx/core/widget/AutoScrollHelper;->mRunnable:Ljava/lang/Runnable;
    ...
    iget-boolean v6, p0, Landroidx/core/widget/AutoScrollHelper;->mAlreadyDelayed:Z

    if-nez v6, :cond_1

    iget v6, p0, Landroidx/core/widget/AutoScrollHelper;->mActivationDelay:I

    if-lez v6, :cond_1

    iget-object v7, p0, Landroidx/core/widget/AutoScrollHelper;->mTarget:Landroid/view/View;

    iget-object v8, p0, Landroidx/core/widget/AutoScrollHelper;->mRunnable:Ljava/lang/Runnable;

    int-to-long v9, v6

    invoke-static {v7, v8, v9, v10}, Landroidx/core/view/ViewCompat;->postOnAnimationDelayed(Landroid/view/View;Ljava/lang/Runnable;J)V

    goto :goto_0

    :cond_1
    iget-object v6, p0, Landroidx/core/widget/AutoScrollHelper;->mRunnable:Ljava/lang/Runnable;
...
.method cancelTargetTouch()V
    ...
    const-string v1, "cancelTargetTouch"
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_2
    iput-boolean v7, p0, Landroidx/core/widget/AutoScrollHelper;->mNeedsCancel:Z

    iput-boolean v6, p0, Landroidx/core/widget/AutoScrollHelper;->mAlreadyDelayed:Z
    ...
    iget-object v9, p0, Landroidx/core/widget/AutoScrollHelper;->mTarget:Landroid/view/View;
    ...
    invoke-direct {p0, v6, v5, v8, v9}, Landroidx/core/widget/AutoScrollHelper;->computeTargetVelocity(IFFF)F
    ...
    iget-object v8, p0, Landroidx/core/widget/AutoScrollHelper;->mTarget:Landroid/view/View;
    ...
    invoke-direct {p0, v7, p2, p1, v8}, Landroidx/core/widget/AutoScrollHelper;->computeTargetVelocity(IFFF)F
    ...
    invoke-virtual {p2, v5, p1}, Landroidx/core/widget/AutoScrollHelper$ClampedScroller;->setTargetVelocity(FF)V
...
.method public setActivationDelay(I)Landroidx/core/widget/AutoScrollHelper;
    ...
    const-string v1, "setActivationDelay"
...
.method public setMaximumEdges(FF)Landroidx/core/widget/AutoScrollHelper;
    ...
    const-string v1, "setMaximumEdges"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/core/widget/AutoScrollHelper;->mMaximumEdges:[F
...
.method public setMaximumVelocity(FF)Landroidx/core/widget/AutoScrollHelper;
    ...
    const-string v1, "setMaximumVelocity"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/core/widget/AutoScrollHelper;->mMaximumVelocity:[F
...
.method public setMinimumVelocity(FF)Landroidx/core/widget/AutoScrollHelper;
    ...
    const-string v1, "setMinimumVelocity"
...
.method public setRampDownDuration(I)Landroidx/core/widget/AutoScrollHelper;
    ...
    invoke-virtual {v5, p1}, Landroidx/core/widget/AutoScrollHelper$ClampedScroller;->setRampDownDuration(I)V
...
.method public setRampUpDuration(I)Landroidx/core/widget/AutoScrollHelper;
    ...
    invoke-virtual {v5, p1}, Landroidx/core/widget/AutoScrollHelper$ClampedScroller;->setRampUpDuration(I)V
...
.method public setRelativeEdges(FF)Landroidx/core/widget/AutoScrollHelper;
    ...
    const-string v1, "setRelativeEdges"
...
.method public setRelativeVelocity(FF)Landroidx/core/widget/AutoScrollHelper;
    ...
    const-string v1, "setRelativeVelocity"
...
.method shouldAnimate()Z
    ...
    invoke-virtual {v5}, Landroidx/core/widget/AutoScrollHelper$ClampedScroller;->getVerticalDirection()I

    move-result v6

    invoke-virtual {v5}, Landroidx/core/widget/AutoScrollHelper$ClampedScroller;->getHorizontalDirection()I
    ...
    const-string v1, "canTargetScrollVertically"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0, v6}, Landroidx/core/widget/AutoScrollHelper;->canTargetScrollVertically(I)Z
    ...
    const-string v1, "canTargetScrollHorizontally"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0, v5}, Landroidx/core/widget/AutoScrollHelper;->canTargetScrollHorizontally(I)Z

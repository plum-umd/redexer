...
.method public static getAutoSizeMaxTextSize(Landroid/widget/TextView;)I
    ...
    const-string v0, "Landroidx/core/widget/TextViewCompat;"
    ...
    :cond_0
    instance-of v5, p0, Landroidx/core/widget/AutoSizeableTextView;
...
.method public static getFirstBaselineToTopHeight(Landroid/widget/TextView;)I
    ...
    const-string v1, "getFontMetricsInt"
...
.method public static getMaxLines(Landroid/widget/TextView;)I
    ...
    :cond_0
    sget-boolean v5, Landroidx/core/widget/TextViewCompat;->sMaxModeFieldFetched:Z

    const/4 v6, 0x1

    if-nez v5, :cond_1

    const-string v5, "mMaxMode"

    invoke-static {v5}, Landroidx/core/widget/TextViewCompat;->retrieveField(Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v5

    sput-object v5, Landroidx/core/widget/TextViewCompat;->sMaxModeField:Ljava/lang/reflect/Field;

    sput-boolean v6, Landroidx/core/widget/TextViewCompat;->sMaxModeFieldFetched:Z

    :cond_1
    sget-object v5, Landroidx/core/widget/TextViewCompat;->sMaxModeField:Ljava/lang/reflect/Field;

    if-eqz v5, :cond_3

    invoke-static {v5, p0}, Landroidx/core/widget/TextViewCompat;->retrieveIntFromField(Ljava/lang/reflect/Field;Landroid/widget/TextView;)I

    move-result v5

    if-ne v5, v6, :cond_3

    sget-boolean v5, Landroidx/core/widget/TextViewCompat;->sMaximumFieldFetched:Z

    if-nez v5, :cond_2

    const-string v5, "mMaximum"

    invoke-static {v5}, Landroidx/core/widget/TextViewCompat;->retrieveField(Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v5

    sput-object v5, Landroidx/core/widget/TextViewCompat;->sMaximumField:Ljava/lang/reflect/Field;

    sput-boolean v6, Landroidx/core/widget/TextViewCompat;->sMaximumFieldFetched:Z

    :cond_2
    sget-object v5, Landroidx/core/widget/TextViewCompat;->sMaximumField:Ljava/lang/reflect/Field;
...
.method public static getMinLines(Landroid/widget/TextView;)I
    ...
    :cond_0
    sget-boolean v5, Landroidx/core/widget/TextViewCompat;->sMinModeFieldFetched:Z

    const/4 v6, 0x1

    if-nez v5, :cond_1

    const-string v5, "mMinMode"

    invoke-static {v5}, Landroidx/core/widget/TextViewCompat;->retrieveField(Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v5

    sput-object v5, Landroidx/core/widget/TextViewCompat;->sMinModeField:Ljava/lang/reflect/Field;

    sput-boolean v6, Landroidx/core/widget/TextViewCompat;->sMinModeFieldFetched:Z

    :cond_1
    sget-object v5, Landroidx/core/widget/TextViewCompat;->sMinModeField:Ljava/lang/reflect/Field;
    ...
    sget-boolean v5, Landroidx/core/widget/TextViewCompat;->sMinimumFieldFetched:Z

    if-nez v5, :cond_2

    const-string v5, "mMinimum"

    invoke-static {v5}, Landroidx/core/widget/TextViewCompat;->retrieveField(Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v5

    sput-object v5, Landroidx/core/widget/TextViewCompat;->sMinimumField:Ljava/lang/reflect/Field;

    sput-boolean v6, Landroidx/core/widget/TextViewCompat;->sMinimumFieldFetched:Z

    :cond_2
    sget-object v5, Landroidx/core/widget/TextViewCompat;->sMinimumField:Ljava/lang/reflect/Field;
...
.method private static getTextDirection(Landroid/text/TextDirectionHeuristic;)I
    ...
    const-string v1, "getTextDirection"
...
.method private static getTextDirectionHeuristic(Landroid/widget/TextView;)Landroid/text/TextDirectionHeuristic;
    ...
    const-string v0, "Landroid/icu/text/DecimalFormatSymbols;"
    ...
    const-string v1, "getDigitStrings"
...
.method public static getTextMetricsParams(Landroid/widget/TextView;)Landroidx/core/text/PrecomputedTextCompat$Params;
    ...
    new-instance v5, Landroidx/core/text/PrecomputedTextCompat$Params;
    ...
    invoke-direct {v5, p0}, Landroidx/core/text/PrecomputedTextCompat$Params;-><init>(Landroid/text/PrecomputedText$Params;)V
    ...
    :cond_0
    new-instance v5, Landroidx/core/text/PrecomputedTextCompat$Params$Builder;
    ...
    invoke-direct {v5, v6}, Landroidx/core/text/PrecomputedTextCompat$Params$Builder;-><init>(Landroid/text/TextPaint;)V
    ...
    invoke-virtual {v5, v6}, Landroidx/core/text/PrecomputedTextCompat$Params$Builder;->setBreakStrategy(I)Landroidx/core/text/PrecomputedTextCompat$Params$Builder;
    ...
    invoke-virtual {v5, v6}, Landroidx/core/text/PrecomputedTextCompat$Params$Builder;->setHyphenationFrequency(I)Landroidx/core/text/PrecomputedTextCompat$Params$Builder;
    ...
    invoke-virtual {v5, p0}, Landroidx/core/text/PrecomputedTextCompat$Params$Builder;->setTextDirection(Landroid/text/TextDirectionHeuristic;)Landroidx/core/text/PrecomputedTextCompat$Params$Builder;

    :cond_2
    invoke-virtual {v5}, Landroidx/core/text/PrecomputedTextCompat$Params$Builder;->build()Landroidx/core/text/PrecomputedTextCompat$Params;
...
.method private static retrieveField(Ljava/lang/String;)Ljava/lang/reflect/Field;
    ...
    const-string v7, "Could not retrieve "
    ...
    const-string v6, "TextViewCompat"
...
.method private static retrieveIntFromField(Ljava/lang/reflect/Field;Landroid/widget/TextView;)I
    ...
    const-string v1, "retrieveIntFromField"
...
.method public static setCompoundDrawablesRelative(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v5, p2, p1, p4}, Landroid/widget/TextView;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public static setCompoundDrawablesRelativeWithIntrinsicBounds(Landroid/widget/TextView;IIII)V
    ...
    invoke-virtual {p0, v5, p2, p1, p4}, Landroid/widget/TextView;->setCompoundDrawablesWithIntrinsicBounds(IIII)V
...
.method public static setCompoundDrawablesRelativeWithIntrinsicBounds(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v5, p2, p1, p4}, Landroid/widget/TextView;->setCompoundDrawablesWithIntrinsicBounds(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public static setFirstBaselineToTopHeight(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {p0, v5, p1, v6, v7}, Landroid/widget/TextView;->setPadding(IIII)V
...
.method public static setLastBaselineToBottomHeight(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {p0, v5, v6, v7, p1}, Landroid/widget/TextView;->setPadding(IIII)V
...
.method public static setLineHeight(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {p0, p1, v5}, Landroid/widget/TextView;->setLineSpacing(FF)V
...
.method public static setPrecomputedText(Landroid/widget/TextView;Landroidx/core/text/PrecomputedTextCompat;)V
    ...
    invoke-virtual {v5, v6}, Landroidx/core/text/PrecomputedTextCompat$Params;->equalsWithoutTextDirection(Landroidx/core/text/PrecomputedTextCompat$Params;)Z
...
.method public static setTextAppearance(Landroid/widget/TextView;I)V
    ...
    invoke-virtual {p0, v5, p1}, Landroid/widget/TextView;->setTextAppearance(Landroid/content/Context;I)V
...
.method public static setTextMetricsParams(Landroid/widget/TextView;Landroidx/core/text/PrecomputedTextCompat$Params;)V
    ...
    const-string v1, "setTextMetricsParams"
    ...
    invoke-static {v5}, Landroidx/core/widget/TextViewCompat;->getTextDirection(Landroid/text/TextDirectionHeuristic;)I
    ...
    invoke-virtual {p0, v5}, Landroid/widget/TextView;->setTextDirection(I)V
    ...
    invoke-virtual {p0, v5}, Landroid/widget/TextView;->setTextScaleX(F)V
    ...
    invoke-virtual {p0, v5}, Landroid/widget/TextView;->setBreakStrategy(I)V
...
.method public static wrapCustomSelectionActionModeCallback(Landroid/widget/TextView;Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode$Callback;
    ...
    const-string v1, "wrapCustomSelectionActionModeCallback"
    ...
    instance-of v5, p1, Landroidx/core/widget/TextViewCompat$OreoCallback;
    ...
    :cond_0
    new-instance v5, Landroidx/core/widget/TextViewCompat$OreoCallback;

    invoke-direct {v5, p1, p0}, Landroidx/core/widget/TextViewCompat$OreoCallback;-><init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V

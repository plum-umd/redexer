...
.method static getCurrentScene(Landroid/view/View;)Landroidx/transition/Scene;
    ...
    const-string v0, "Landroidx/transition/Scene;"

    const-string v1, "getCurrentScene"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget v5, Landroidx/transition/R$id;->transition_current_scene:I
...
.method public static getSceneForLayout(Landroid/view/ViewGroup;ILandroid/content/Context;)Landroidx/transition/Scene;
    ...
    const-string v1, "getSceneForLayout"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget v5, Landroidx/transition/R$id;->transition_scene_layoutid_cache:I
    ...
    invoke-virtual {p0, v6, v5}, Landroid/view/ViewGroup;->setTag(ILjava/lang/Object;)V
    ...
    check-cast v6, Landroidx/transition/Scene;
    ...
    :cond_1
    new-instance v6, Landroidx/transition/Scene;

    invoke-direct {v6, p0, p1, p2}, Landroidx/transition/Scene;-><init>(Landroid/view/ViewGroup;ILandroid/content/Context;)V
...
.method public enter()V
    ...
    iget v5, p0, Landroidx/transition/Scene;->mLayoutId:I

    if-gtz v5, :cond_0

    iget-object v5, p0, Landroidx/transition/Scene;->mLayout:Landroid/view/View;
    ...
    iget-object v5, p0, Landroidx/transition/Scene;->mContext:Landroid/content/Context;
    ...
    iget v6, p0, Landroidx/transition/Scene;->mLayoutId:I

    iget-object v7, p0, Landroidx/transition/Scene;->mSceneRoot:Landroid/view/ViewGroup;
    ...
    :cond_1
    iget-object v5, p0, Landroidx/transition/Scene;->mSceneRoot:Landroid/view/ViewGroup;

    iget-object v6, p0, Landroidx/transition/Scene;->mLayout:Landroid/view/View;
    ...
    :cond_2
    :goto_0
    iget-object v5, p0, Landroidx/transition/Scene;->mEnterAction:Ljava/lang/Runnable;
    ...
    invoke-static {v5, p0}, Landroidx/transition/Scene;->setCurrentScene(Landroid/view/View;Landroidx/transition/Scene;)V
...
.method public exit()V
    ...
    iget-object v5, p0, Landroidx/transition/Scene;->mExitAction:Ljava/lang/Runnable;
...
.method isCreatedFromLayoutResource()Z
    ...
    const-string v1, "isCreatedFromLayoutResource"
...
.method public setEnterAction(Ljava/lang/Runnable;)V
    ...
    const-string v1, "setEnterAction"

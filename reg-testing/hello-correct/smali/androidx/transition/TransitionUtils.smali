...
.method static copyViewImage(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
    ...
    const-string v0, "Landroidx/transition/TransitionUtils;"

    const-string v1, "copyViewImage"
    ...
    invoke-virtual {v5, v6, p2}, Landroid/graphics/Matrix;->setTranslate(FF)V
    ...
    invoke-static {p1, v5}, Landroidx/transition/ViewUtils;->transformMatrixToGlobal(Landroid/view/View;Landroid/graphics/Matrix;)V

    invoke-static {p0, v5}, Landroidx/transition/ViewUtils;->transformMatrixToLocal(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    invoke-direct {p2, v8, v8, v6, v7}, Landroid/graphics/RectF;-><init>(FFFF)V
    ...
    invoke-virtual {v5, p2}, Landroid/graphics/Matrix;->mapRect(Landroid/graphics/RectF;)Z
    ...
    invoke-static {p1, v5, p2, p0}, Landroidx/transition/TransitionUtils;->createViewBitmap(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v10, p0}, Landroid/widget/ImageView;->setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v10, p0, p1}, Landroid/widget/ImageView;->measure(II)V
...
.method private static createViewBitmap(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
    ...
    const-string v1, "createViewBitmap"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-boolean v5, Landroidx/transition/TransitionUtils;->HAS_IS_ATTACHED_TO_WINDOW:Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/view/ViewGroup;->isAttachedToWindow()Z
    ...
    :goto_1
    sget-boolean v8, Landroidx/transition/TransitionUtils;->HAS_OVERLAY:Z
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/view/ViewGroup;->getOverlay()Landroid/view/ViewGroupOverlay;
    ...
    const-string v0, "Landroid/view/ViewGroupOverlay;"

    const-string v1, "add"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v8, p0}, Landroid/view/ViewGroupOverlay;->add(Landroid/view/View;)V
    ...
    invoke-virtual/range {v0 .. v2}, Landroid/graphics/Matrix;->postTranslate(FF)Z
    ...
    invoke-direct/range {v0 .. v0}, Landroid/graphics/Picture;-><init>()V
    ...
    const-string v0, "Landroid/graphics/Picture;"
    ...
    invoke-virtual/range {v0 .. v2}, Landroid/graphics/Picture;->beginRecording(II)Landroid/graphics/Canvas;
    ...
    invoke-virtual/range {v0 .. v0}, Landroid/graphics/Picture;->endRecording()V
    ...
    invoke-static/range {v0 .. v0}, Landroid/graphics/Bitmap;->createBitmap(Landroid/graphics/Picture;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v0 .. v2}, Landroid/graphics/Bitmap;->createBitmap(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-direct/range {v0 .. v1}, Landroid/graphics/Canvas;-><init>(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/graphics/Canvas;->concat(Landroid/graphics/Matrix;)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/view/View;->draw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v7, p0, v6}, Landroid/view/ViewGroup;->addView(Landroid/view/View;I)V
...
.method static mergeAnimators(Landroid/animation/Animator;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    const-string v1, "mergeAnimators"

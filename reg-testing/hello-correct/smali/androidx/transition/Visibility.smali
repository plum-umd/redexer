...
.method private captureValues(Landroidx/transition/TransitionValues;)V
    ...
    const-string v7, "android:visibility:visibility"
    ...
    const-string v7, "android:visibility:parent"
...
.method private getVisibilityChangeInfo(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroidx/transition/Visibility$VisibilityInfo;
    ...
    const-string v1, "getVisibilityChangeInfo"
    ...
    iget-object v11, p1, Landroidx/transition/TransitionValues;->values:Ljava/util/Map;
    ...
    iput v11, v5, Landroidx/transition/Visibility$VisibilityInfo;->mStartVisibility:I
    ...
    iput-object v11, v5, Landroidx/transition/Visibility$VisibilityInfo;->mStartParent:Landroid/view/ViewGroup;

    goto/16 :goto_0

    :cond_0
    iput v9, v5, Landroidx/transition/Visibility$VisibilityInfo;->mStartVisibility:I
    ...
    iget-object v11, p2, Landroidx/transition/TransitionValues;->values:Ljava/util/Map;
    ...
    iput v8, v5, Landroidx/transition/Visibility$VisibilityInfo;->mEndVisibility:I
    ...
    iput-object v7, v5, Landroidx/transition/Visibility$VisibilityInfo;->mEndParent:Landroid/view/ViewGroup;

    goto/16 :goto_1

    :cond_1
    iput v9, v5, Landroidx/transition/Visibility$VisibilityInfo;->mEndVisibility:I
    ...
    iget p1, v5, Landroidx/transition/Visibility$VisibilityInfo;->mStartVisibility:I

    iget p2, v5, Landroidx/transition/Visibility$VisibilityInfo;->mEndVisibility:I

    if-ne p1, p2, :cond_2

    iget-object p1, v5, Landroidx/transition/Visibility$VisibilityInfo;->mStartParent:Landroid/view/ViewGroup;

    iget-object p2, v5, Landroidx/transition/Visibility$VisibilityInfo;->mEndParent:Landroid/view/ViewGroup;
    ...
    iput-boolean v7, v5, Landroidx/transition/Visibility$VisibilityInfo;->mVisibilityChange:Z

    goto/16 :goto_2

    :cond_3
    iget p1, v5, Landroidx/transition/Visibility$VisibilityInfo;->mEndVisibility:I

    if-nez p1, :cond_8

    iput-boolean v7, v5, Landroidx/transition/Visibility$VisibilityInfo;->mFadeIn:Z
    ...
    :cond_4
    iget-object p1, v5, Landroidx/transition/Visibility$VisibilityInfo;->mEndParent:Landroid/view/ViewGroup;
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    invoke-direct/range {v0 .. v2}, Landroidx/transition/Visibility;->getVisibilityChangeInfo(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroidx/transition/Visibility$VisibilityInfo;
    ...
    iget v10, v5, Landroidx/transition/Visibility$VisibilityInfo;->mStartVisibility:I

    iget v12, v5, Landroidx/transition/Visibility$VisibilityInfo;->mEndVisibility:I
    ...
    invoke-virtual/range {v7 .. v12}, Landroidx/transition/Visibility;->onAppear(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;ILandroidx/transition/TransitionValues;I)Landroid/animation/Animator;
    ...
    :cond_1
    iget v8, v5, Landroidx/transition/Visibility$VisibilityInfo;->mStartVisibility:I

    iget v10, v5, Landroidx/transition/Visibility$VisibilityInfo;->mEndVisibility:I
...
.method public onAppear(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;ILandroidx/transition/TransitionValues;I)Landroid/animation/Animator;
    ...
    invoke-direct {p0, v6, p3}, Landroidx/transition/Visibility;->getVisibilityChangeInfo(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroidx/transition/Visibility$VisibilityInfo;
...
.method public onDisappear(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;ILandroidx/transition/TransitionValues;I)Landroid/animation/Animator;
    ...
    iget-object v7, p4, Landroidx/transition/TransitionValues;->view:Landroid/view/View;
    ...
    :cond_5
    iget-boolean v7, p0, Landroidx/transition/Visibility;->mCanRemoveViews:Z
    ...
    invoke-virtual {p0, v7, v8}, Landroidx/transition/Visibility;->getTransitionValues(Landroid/view/View;Z)Landroidx/transition/TransitionValues;
    ...
    invoke-virtual {p0, v7, v8}, Landroidx/transition/Visibility;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/TransitionValues;
    ...
    invoke-direct {p0, v9, v10}, Landroidx/transition/Visibility;->getVisibilityChangeInfo(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroidx/transition/Visibility$VisibilityInfo;
    ...
    invoke-virtual {p3, v6}, Landroid/view/View;->offsetLeftAndRight(I)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/view/View;->offsetTopAndBottom(I)V
    ...
    invoke-interface/range {v0 .. v1}, Landroidx/transition/ViewGroupOverlayImpl;->add(Landroid/view/View;)V
    ...
    invoke-interface/range {v0 .. v1}, Landroidx/transition/ViewGroupOverlayImpl;->remove(Landroid/view/View;)V
    ...
    invoke-direct/range {v0 .. v3}, Landroidx/transition/Visibility$1;-><init>(Landroidx/transition/Visibility;Landroidx/transition/ViewGroupOverlayImpl;Landroid/view/View;)V
    ...
    invoke-static {v7, v9}, Landroidx/transition/ViewUtils;->setTransitionVisibility(Landroid/view/View;I)V
    ...
    invoke-direct/range {v0 .. v3}, Landroidx/transition/Visibility$DisappearListener;-><init>(Landroid/view/View;IZ)V
...
.method public setMode(I)V
    ...
    const-string v5, "Only MODE_IN and MODE_OUT flags are allowed"

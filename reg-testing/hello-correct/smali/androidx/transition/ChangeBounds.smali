...
.method private captureValues(Landroidx/transition/TransitionValues;)V
    ...
    const-string v0, "Landroidx/transition/ChangeBounds;"
    ...
    iget-boolean v6, p0, Landroidx/transition/ChangeBounds;->mReparent:Z

    if-eqz v6, :cond_1

    iget-object v6, p1, Landroidx/transition/TransitionValues;->view:Landroid/view/View;

    iget-object v7, p0, Landroidx/transition/ChangeBounds;->mTempLocation:[I
    ...
    :cond_1
    iget-boolean v6, p0, Landroidx/transition/ChangeBounds;->mResizeClip:Z
    ...
    const-string v6, "android:changeBounds:clip"
...
.method private parentMatches(Landroid/view/View;Landroid/view/View;)Z
    ...
    const-string v1, "parentMatches"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v5, p0, Landroidx/transition/ChangeBounds;->mReparent:Z
    ...
    invoke-virtual {p0, p1, v6}, Landroidx/transition/ChangeBounds;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/TransitionValues;
    ...
    :cond_1
    iget-object p1, v5, Landroidx/transition/TransitionValues;->view:Landroid/view/View;
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    iget-object v9, v6, Landroidx/transition/TransitionValues;->values:Ljava/util/Map;

    const-string v10, "android:changeBounds:parent"
    ...
    :cond_1
    iget-object v14, v6, Landroidx/transition/TransitionValues;->view:Landroid/view/View;

    invoke-direct {v13, v8, v9}, Landroidx/transition/ChangeBounds;->parentMatches(Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {v5, v14}, Landroid/graphics/Rect;->equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v14, v13, Landroidx/transition/ChangeBounds;->mResizeClip:Z
    ...
    invoke-static/range {v0 .. v4}, Landroidx/transition/ViewUtils;->setLeftTopRightBottom(Landroid/view/View;IIII)V
    ...
    invoke-virtual {v5, v6, v7, v8, v9}, Landroidx/transition/PathMotion;->getPath(FFFF)Landroid/graphics/Path;
    ...
    invoke-static {v14, v6, v5}, Landroidx/transition/ObjectAnimatorUtils;->ofPointF(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    :cond_c
    new-instance v6, Landroidx/transition/ChangeBounds$ViewBounds;

    invoke-direct {v6, v14}, Landroidx/transition/ChangeBounds$ViewBounds;-><init>(Landroid/view/View;)V
    ...
    invoke-virtual {v7, v9, v10, v11, v12}, Landroidx/transition/PathMotion;->getPath(FFFF)Landroid/graphics/Path;
    ...
    invoke-static {v6, v9, v7}, Landroidx/transition/ObjectAnimatorUtils;->ofPointF(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-virtual {v9, v10, v8, v11, v12}, Landroidx/transition/PathMotion;->getPath(FFFF)Landroid/graphics/Path;
    ...
    invoke-static {v6, v9, v8}, Landroidx/transition/ObjectAnimatorUtils;->ofPointF(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v5, v13, v6}, Landroidx/transition/ChangeBounds$7;-><init>(Landroidx/transition/ChangeBounds;Landroidx/transition/ChangeBounds$ViewBounds;)V
    ...
    sget-object v6, Landroidx/transition/ChangeBounds;->BOTTOM_RIGHT_ONLY_PROPERTY:Landroid/util/Property;
    ...
    sget-object v6, Landroidx/transition/ChangeBounds;->TOP_LEFT_ONLY_PROPERTY:Landroid/util/Property;
    ...
    invoke-virtual/range {v0 .. v4}, Landroidx/transition/PathMotion;->getPath(FFFF)Landroid/graphics/Path;
    ...
    invoke-static {v14, v8, v6}, Landroidx/transition/ObjectAnimatorUtils;->ofPointF(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v6, v8, v8, v10, v7}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-direct {v7, v8, v8, v15, v9}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-static {v14, v6}, Landroidx/core/view/ViewCompat;->setClipBounds(Landroid/view/View;Landroid/graphics/Rect;)V

    sget-object v9, Landroidx/transition/ChangeBounds;->sRectEvaluator:Landroidx/transition/RectEvaluator;
    ...
    invoke-static {v14, v6, v9, v5}, Landroid/animation/ObjectAnimator;->ofObject(Ljava/lang/Object;Ljava/lang/String;Landroid/animation/TypeEvaluator;[Ljava/lang/Object;)Landroid/animation/ObjectAnimator;
    ...
    new-instance v18, Landroidx/transition/ChangeBounds$8;
    ...
    invoke-direct/range {v5 .. v12}, Landroidx/transition/ChangeBounds$8;-><init>(Landroidx/transition/ChangeBounds;Landroid/view/View;Landroid/graphics/Rect;IIII)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V
    ...
    invoke-static/range {v0 .. v1}, Landroidx/transition/TransitionUtils;->mergeAnimators(Landroid/animation/Animator;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    invoke-static {v6, v7}, Landroidx/transition/ViewGroupUtils;->suppressLayout(Landroid/view/ViewGroup;Z)V

    new-instance v7, Landroidx/transition/ChangeBounds$9;

    invoke-direct {v7, v13, v6}, Landroidx/transition/ChangeBounds$9;-><init>(Landroidx/transition/ChangeBounds;Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v13, v7}, Landroidx/transition/ChangeBounds;->addListener(Landroidx/transition/Transition$TransitionListener;)Landroidx/transition/Transition;
    ...
    const-string v9, "android:changeBounds:windowY"
    ...
    :cond_19
    :goto_a
    iget-object v9, v13, Landroidx/transition/ChangeBounds;->mTempLocation:[I
    ...
    invoke-virtual {v10, v9}, Landroid/view/ViewGroup;->getLocationInWindow([I)V
    ...
    invoke-virtual {v14, v11}, Landroid/view/View;->draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v14}, Landroidx/transition/ViewUtils;->getTransitionAlpha(Landroid/view/View;)F

    move-result v12

    const/4 v9, 0x0

    invoke-static {v14, v9}, Landroidx/transition/ViewUtils;->setTransitionAlpha(Landroid/view/View;F)V
    ...
    invoke-interface {v9, v11}, Landroidx/transition/ViewOverlayImpl;->add(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v15, v13, Landroidx/transition/ChangeBounds;->mTempLocation:[I
    ...
    invoke-virtual {v9, v7, v5, v8, v6}, Landroidx/transition/PathMotion;->getPath(FFFF)Landroid/graphics/Path;
    ...
    invoke-static {v6, v5}, Landroidx/transition/PropertyValuesHolderUtils;->ofPointF(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
    ...
    new-instance v16, Landroidx/transition/ChangeBounds$10;
...
.method public getResizeClip()Z
    ...
    const-string v1, "getResizeClip"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v5, p0, Landroidx/transition/ChangeBounds;->mResizeClip:Z

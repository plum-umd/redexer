...
.method private captureValues(Landroidx/transition/TransitionValues;)V
    ...
    const-string v0, "Landroidx/transition/ChangeImageTransform;"
    ...
    invoke-direct {v10, v7, v8, v9, v5}, Landroid/graphics/Rect;-><init>(IIII)V

    const-string v5, "android:changeImageTransform:bounds"
    ...
    invoke-static {v6}, Landroidx/transition/ChangeImageTransform;->copyImageMatrix(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
...
.method private static centerCropMatrix(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    const-string v1, "centerCropMatrix"
...
.method private static copyImageMatrix(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    const-string v1, "copyImageMatrix"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-object v5, Landroidx/transition/ChangeImageTransform$3;->$SwitchMap$android$widget$ImageView$ScaleType:[I
    ...
    const-string v0, "Landroid/widget/ImageView$ScaleType;"
...
.method private createMatrixAnimator(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
    ...
    const-string v1, "createMatrixAnimator"
    ...
    invoke-direct {v6}, Landroidx/transition/TransitionUtils$MatrixEvaluator;-><init>()V
    ...
    invoke-static {p1, v5, v6, v7}, Landroid/animation/ObjectAnimator;->ofObject(Ljava/lang/Object;Landroid/util/Property;Landroid/animation/TypeEvaluator;[Ljava/lang/Object;)Landroid/animation/ObjectAnimator;
...
.method private createNullAnimator(Landroid/widget/ImageView;)Landroid/animation/ObjectAnimator;
    ...
    const-string v1, "createNullAnimator"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-object v5, Landroidx/transition/ChangeImageTransform;->ANIMATED_TRANSFORM_PROPERTY:Landroid/util/Property;

    sget-object v6, Landroidx/transition/ChangeImageTransform;->NULL_MATRIX_EVALUATOR:Landroid/animation/TypeEvaluator;
...
.method private static fitXYMatrix(Landroid/widget/ImageView;)Landroid/graphics/Matrix;
    ...
    invoke-virtual {v6, v7, p0}, Landroid/graphics/Matrix;->postScale(FF)Z
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    const-string v7, "android:changeImageTransform:matrix"
    ...
    invoke-virtual {p2, v7}, Landroid/graphics/Matrix;->equals(Ljava/lang/Object;)Z
    ...
    sget-object v7, Landroidx/transition/MatrixUtils;->IDENTITY_MATRIX:Landroid/graphics/Matrix;
    ...
    invoke-direct {p0, p1, p2, v7}, Landroidx/transition/ChangeImageTransform;->createMatrixAnimator(Landroid/widget/ImageView;Landroid/graphics/Matrix;Landroid/graphics/Matrix;)Landroid/animation/ObjectAnimator;
...
.method public getTransitionProperties()[Ljava/lang/String;
    ...
    sget-object v5, Landroidx/transition/ChangeImageTransform;->sTransitionProperties:[Ljava/lang/String;

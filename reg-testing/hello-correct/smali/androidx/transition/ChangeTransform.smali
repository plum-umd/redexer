...
.method private captureValues(Landroidx/transition/TransitionValues;)V
    ...
    const-string v0, "Landroidx/transition/ChangeTransform;"
    ...
    new-instance v6, Landroidx/transition/ChangeTransform$Transforms;

    invoke-direct {v6, v5}, Landroidx/transition/ChangeTransform$Transforms;-><init>(Landroid/view/View;)V
    ...
    invoke-static {v7, v6}, Landroidx/transition/ViewUtils;->transformMatrixToGlobal(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    invoke-virtual {v7}, Landroid/view/ViewGroup;->getScrollX()I
    ...
    const-string v1, "preTranslate"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v6, v8, v7}, Landroid/graphics/Matrix;->preTranslate(FF)Z
    ...
    sget v7, Landroidx/transition/R$id;->transition_transform:I
...
.method private createGhostView(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)V
    ...
    const-string v1, "createGhostView"
    ...
    invoke-static {p1, v7}, Landroidx/transition/ViewUtils;->transformMatrixToLocal(Landroid/view/View;Landroid/graphics/Matrix;)V

    invoke-static {v5, p1, v7}, Landroidx/transition/GhostViewUtils;->addGhost(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Matrix;)Landroidx/transition/GhostViewImpl;
    ...
    invoke-interface {p1, v6, v7}, Landroidx/transition/GhostViewImpl;->reserveEndViewTransition(Landroid/view/ViewGroup;Landroid/view/View;)V
    ...
    :cond_1
    new-instance v7, Landroidx/transition/ChangeTransform$GhostListener;

    invoke-direct {v7, v5, p1}, Landroidx/transition/ChangeTransform$GhostListener;-><init>(Landroid/view/View;Landroidx/transition/GhostViewImpl;)V
    ...
    invoke-static {v5, p1}, Landroidx/transition/ViewUtils;->setTransitionAlpha(Landroid/view/View;F)V
...
.method private createTransformAnimator(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;Z)Landroid/animation/ObjectAnimator;
    ...
    const-string v1, "createTransformAnimator"
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/graphics/Matrix;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v10}, Landroidx/transition/ChangeTransform;->setIdentityTransforms(Landroid/view/View;)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/graphics/Matrix;->getValues([F)V
    ...
    invoke-direct {v12, v10, v5}, Landroidx/transition/ChangeTransform$PathAnimatorMatrix;-><init>(Landroid/view/View;[F)V

    sget-object v6, Landroidx/transition/ChangeTransform;->NON_TRANSLATIONS_PROPERTY:Landroid/util/Property;
    ...
    invoke-direct/range {v0 .. v1}, Landroidx/transition/FloatArrayEvaluator;-><init>([F)V
    ...
    invoke-virtual/range {v0 .. v0}, Landroidx/transition/ChangeTransform;->getPathMotion()Landroidx/transition/PathMotion;
    ...
    invoke-static/range {v0 .. v1}, Landroidx/transition/PropertyValuesHolderUtils;->ofPointF(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
    ...
    aput-object v6, p2, v13

    aput-object p1, p2, v14
    ...
    invoke-static/range {v0 .. v1}, Landroid/animation/ObjectAnimator;->ofPropertyValuesHolder(Ljava/lang/Object;[Landroid/animation/PropertyValuesHolder;)Landroid/animation/ObjectAnimator;
    ...
    invoke-direct/range {v6 .. v12}, Landroidx/transition/ChangeTransform$3;-><init>(Landroidx/transition/ChangeTransform;ZLandroid/graphics/Matrix;Landroid/view/View;Landroidx/transition/ChangeTransform$Transforms;Landroidx/transition/ChangeTransform$PathAnimatorMatrix;)V
    ...
    invoke-static/range {v0 .. v1}, Landroidx/transition/AnimatorUtils;->addPauseListener(Landroid/animation/Animator;Landroid/animation/AnimatorListenerAdapter;)V
...
.method private parentsMatch(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    invoke-virtual {p0, p1, v6}, Landroidx/transition/ChangeTransform;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/TransitionValues;
...
.method static setIdentityTransforms(Landroid/view/View;)V
    ...
    const-string v1, "setIdentityTransforms"
...
.method private setMatricesForParent(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)V
    ...
    const-string v1, "setMatricesForParent"
    ...
    sget v7, Landroidx/transition/R$id;->parent_matrix:I
    ...
    invoke-virtual {p2, v7, v5}, Landroid/view/View;->setTag(ILjava/lang/Object;)V
    ...
    invoke-virtual {v5, p2}, Landroid/graphics/Matrix;->invert(Landroid/graphics/Matrix;)Z
...
.method public captureStartValues(Landroidx/transition/TransitionValues;)V
    ...
    sget-boolean v5, Landroidx/transition/ChangeTransform;->SUPPORTS_VIEW_REMOVAL_SUPPRESSION:Z
    ...
    invoke-virtual {v5, p1}, Landroid/view/ViewGroup;->startViewTransition(Landroid/view/View;)V
...
.method public createAnimator(Landroid/view/ViewGroup;Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    iget-boolean v7, p0, Landroidx/transition/ChangeTransform;->mReparent:Z

    if-eqz v7, :cond_1

    invoke-direct {p0, v5, v6}, Landroidx/transition/ChangeTransform;->parentsMatch(Landroid/view/ViewGroup;Landroid/view/ViewGroup;)Z
    ...
    :cond_4
    invoke-direct {p0, p2, p3, v6}, Landroidx/transition/ChangeTransform;->createTransformAnimator(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;Z)Landroid/animation/ObjectAnimator;
...
.method public getReparent()Z
    ...
    const-string v1, "getReparent"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v5, p0, Landroidx/transition/ChangeTransform;->mReparent:Z
...
.method public getReparentWithOverlay()Z
    ...
    const-string v1, "getReparentWithOverlay"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v5, p0, Landroidx/transition/ChangeTransform;->mUseOverlay:Z
...
.method public getTransitionProperties()[Ljava/lang/String;
    ...
    sget-object v5, Landroidx/transition/ChangeTransform;->sTransitionProperties:[Ljava/lang/String;
...
.method public setReparentWithOverlay(Z)V
    ...
    const-string v1, "setReparentWithOverlay"

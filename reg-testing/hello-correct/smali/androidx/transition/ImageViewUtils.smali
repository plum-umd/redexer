...
.method static animateTransform(Landroid/widget/ImageView;Landroid/graphics/Matrix;)V
    ...
    const-string v0, "Landroidx/transition/ImageViewUtils;"
    ...
    sget-object v5, Landroidx/transition/ImageViewUtils;->sAnimateTransformMethod:Ljava/lang/reflect/Method;
...
.method private static fetchAnimateTransformMethod()V
    ...
    const-string v1, "fetchAnimateTransformMethod"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-boolean v5, Landroidx/transition/ImageViewUtils;->sAnimateTransformMethodFetched:Z
    ...
    const-string v7, "animateTransform"
    ...
    :try_start_2
    sput-object v6, Landroidx/transition/ImageViewUtils;->sAnimateTransformMethod:Ljava/lang/reflect/Method;

    sget-object v6, Landroidx/transition/ImageViewUtils;->sAnimateTransformMethod:Ljava/lang/reflect/Method;
    :try_end_2
    ...
    const-string v7, "ImageViewUtils"

    const-string v8, "Failed to retrieve animateTransform method"
    ...
    :goto_0
    sput-boolean v5, Landroidx/transition/ImageViewUtils;->sAnimateTransformMethodFetched:Z
...
.method static reserveEndAnimateTransform(Landroid/widget/ImageView;Landroid/animation/Animator;)V
    ...
    const-string v1, "reserveEndAnimateTransform"
    ...
    new-instance v5, Landroidx/transition/ImageViewUtils$1;

    invoke-direct {v5, p0}, Landroidx/transition/ImageViewUtils$1;-><init>(Landroid/widget/ImageView;)V
...
.method static startAnimateTransform(Landroid/widget/ImageView;)V
    ...
    const-string v1, "startAnimateTransform"
    ...
    sget v6, Landroidx/transition/R$id;->save_scale_type:I
    ...
    invoke-virtual {p0, v6, v5}, Landroid/widget/ImageView;->setTag(ILjava/lang/Object;)V
    ...
    invoke-virtual {p0, v5, v6}, Landroid/widget/ImageView;->setTag(ILjava/lang/Object;)V

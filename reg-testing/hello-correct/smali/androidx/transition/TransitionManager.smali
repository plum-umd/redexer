...
.method public static beginDelayedTransition(Landroid/view/ViewGroup;)V
    ...
    const-string v0, "Landroidx/transition/TransitionManager;"
...
.method public static beginDelayedTransition(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    ...
    invoke-static {p0, v5}, Landroidx/transition/Scene;->setCurrentScene(Landroid/view/View;Landroidx/transition/Scene;)V
...
.method private static changeScene(Landroidx/transition/Scene;Landroidx/transition/Transition;)V
    ...
    invoke-virtual {p1, v5}, Landroidx/transition/Transition;->setSceneRoot(Landroid/view/ViewGroup;)Landroidx/transition/Transition;
    ...
    invoke-virtual {v6}, Landroidx/transition/Scene;->isCreatedFromLayoutResource()Z
    ...
    invoke-virtual {p1, v6}, Landroidx/transition/Transition;->setCanRemoveViews(Z)V

    :cond_1
    invoke-static {v5, p1}, Landroidx/transition/TransitionManager;->sceneChangeSetup(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V

    invoke-virtual {p0}, Landroidx/transition/Scene;->enter()V

    invoke-static {v5, p1}, Landroidx/transition/TransitionManager;->sceneChangeRunTransition(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
...
.method public static endTransitions(Landroid/view/ViewGroup;)V
    ...
    const-string v1, "endTransitions"
    ...
    invoke-virtual {v5, p0}, Landroidx/collection/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v7, p0}, Landroidx/transition/Transition;->forceToEnd(Landroid/view/ViewGroup;)V
...
.method static getRunningTransitions()Landroidx/collection/ArrayMap;
    ...
    const-string v1, "getRunningTransitions"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-object v5, Landroidx/transition/TransitionManager;->sRunningTransitions:Ljava/lang/ThreadLocal;
    ...
    sget-object v7, Landroidx/transition/TransitionManager;->sRunningTransitions:Ljava/lang/ThreadLocal;
...
.method private getTransition(Landroidx/transition/Scene;)Landroidx/transition/Transition;
    ...
    iget-object v6, p0, Landroidx/transition/TransitionManager;->mScenePairTransitions:Landroidx/collection/ArrayMap;
    ...
    invoke-virtual {v6, p1}, Landroidx/collection/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static go(Landroidx/transition/Scene;)V
    ...
    invoke-static {p0, v5}, Landroidx/transition/TransitionManager;->changeScene(Landroidx/transition/Scene;Landroidx/transition/Transition;)V
...
.method private static sceneChangeRunTransition(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    ...
    const-string v1, "sceneChangeRunTransition"
    ...
    new-instance v5, Landroidx/transition/TransitionManager$MultiListener;

    invoke-direct {v5, p1, p0}, Landroidx/transition/TransitionManager$MultiListener;-><init>(Landroidx/transition/Transition;Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {p0, v5}, Landroid/view/ViewTreeObserver;->addOnPreDrawListener(Landroid/view/ViewTreeObserver$OnPreDrawListener;)V
...
.method private static sceneChangeSetup(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    ...
    const-string v1, "sceneChangeSetup"
    ...
    invoke-virtual {v6, p0}, Landroidx/transition/Transition;->pause(Landroid/view/View;)V
    ...
    invoke-virtual {p1, p0, v5}, Landroidx/transition/Transition;->captureValues(Landroid/view/ViewGroup;Z)V
...
.method public setTransition(Landroidx/transition/Scene;Landroidx/transition/Scene;Landroidx/transition/Transition;)V
    ...
    invoke-virtual {v5, p2}, Landroidx/collection/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v5, p1, p3}, Landroidx/collection/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public transitionTo(Landroidx/transition/Scene;)V
    ...
    invoke-static {p1, v5}, Landroidx/transition/TransitionManager;->changeScene(Landroidx/transition/Scene;Landroidx/transition/Transition;)V

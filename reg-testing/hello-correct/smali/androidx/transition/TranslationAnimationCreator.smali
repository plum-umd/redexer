...
.method static createAnimation(Landroid/view/View;Landroidx/transition/TransitionValues;IIFFFFLandroid/animation/TimeInterpolator;)Landroid/animation/Animator;
    ...
    const-string v0, "Landroidx/transition/TranslationAnimationCreator;"
    ...
    iget-object v9, v6, Landroidx/transition/TransitionValues;->view:Landroid/view/View;

    sget v10, Landroidx/transition/R$id;->transition_position:I
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/view/View;->setTranslationX(F)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/view/View;->setTranslationY(F)V
    ...
    cmpl-float v15, v12, p6

    if-nez v15, :cond_1

    cmpl-float v15, v9, p7
    ...
    invoke-static/range {v0 .. v1}, Landroid/animation/PropertyValuesHolder;->ofFloat(Landroid/util/Property;[F)Landroid/animation/PropertyValuesHolder;
    ...
    new-instance v10, Landroidx/transition/TranslationAnimationCreator$TransitionPositionListener;

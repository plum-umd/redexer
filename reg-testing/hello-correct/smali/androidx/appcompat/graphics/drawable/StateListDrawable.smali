...
.method private inflateChildElements(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iget-object v5, p0, Landroidx/appcompat/graphics/drawable/StateListDrawable;->mStateListState:Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;
    ...
    sget v11, Landroidx/appcompat/R$styleable;->StateListDrawableItem_android_drawable:I
    ...
    invoke-static {p1, v11}, Landroidx/appcompat/content/res/AppCompatResources;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual/range {v0 .. v1}, Landroidx/appcompat/graphics/drawable/StateListDrawable;->extractStateSet(Landroid/util/AttributeSet;)[I
    ...
    invoke-interface/range {v0 .. v0}, Lorg/xmlpull/v1/XmlPullParser;->getPositionDescription()Ljava/lang/String;
    ...
    :cond_8
    :goto_2
    invoke-virtual {v5, v8, v9}, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->addStateSet([ILandroid/graphics/drawable/Drawable;)I
...
.method private updateStateFromTypedArray(Landroid/content/res/TypedArray;)V
    ...
    iget v6, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mChangingConfigurations:I
    ...
    iput v6, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mChangingConfigurations:I

    :cond_0
    sget v6, Landroidx/appcompat/R$styleable;->StateListDrawable_android_variablePadding:I

    iget-boolean v7, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mVariablePadding:Z
    ...
    iput-boolean v6, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mVariablePadding:Z

    sget v6, Landroidx/appcompat/R$styleable;->StateListDrawable_android_constantSize:I

    iget-boolean v7, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mConstantSize:Z
    ...
    iput-boolean v6, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mConstantSize:Z

    sget v6, Landroidx/appcompat/R$styleable;->StateListDrawable_android_enterFadeDuration:I

    iget v7, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mEnterFadeDuration:I
    ...
    iput v6, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mEnterFadeDuration:I

    sget v6, Landroidx/appcompat/R$styleable;->StateListDrawable_android_exitFadeDuration:I

    iget v7, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mExitFadeDuration:I
    ...
    iput v6, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mExitFadeDuration:I

    sget v6, Landroidx/appcompat/R$styleable;->StateListDrawable_android_dither:I

    iget-boolean v7, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mDither:Z
    ...
    iput-boolean p1, v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mDither:Z
...
.method public addState([ILandroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v5, p1, p2}, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->addStateSet([ILandroid/graphics/drawable/Drawable;)I
...
.method clearMutated()V
    ...
    iput-boolean v5, p0, Landroidx/appcompat/graphics/drawable/StateListDrawable;->mMutated:Z
...
.method cloneConstantState()Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;
    ...
    new-instance v5, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;

    iget-object v6, p0, Landroidx/appcompat/graphics/drawable/StateListDrawable;->mStateListState:Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;

    const/4 v7, 0x0

    invoke-direct {v5, v6, p0, v7}, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;-><init>(Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;Landroidx/appcompat/graphics/drawable/StateListDrawable;Landroid/content/res/Resources;)V
...
.method extractStateSet(Landroid/util/AttributeSet;)[I
    ...
    const-string v1, "getAttributeCount"
    ...
    const-string v1, "getAttributeNameResource"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-interface {p1, v8}, Landroid/util/AttributeSet;->getAttributeNameResource(I)I
    ...
    const-string v1, "getAttributeBooleanValue"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-interface {p1, v8, v7}, Landroid/util/AttributeSet;->getAttributeBooleanValue(IZ)Z
    ...
    const-string v0, "Landroid/util/StateSet;"

    const-string v1, "trimStateSet"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-static {v6, v9}, Landroid/util/StateSet;->trimStateSet([II)[I
...
.method getStateDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->getChild(I)Landroid/graphics/drawable/Drawable;
...
.method getStateDrawableIndex([I)I
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->indexOfStateSet([I)I
...
.method getStateListState()Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;
    ...
    const-string v1, "getStateListState"
...
.method public inflate(Landroid/content/Context;Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    sget-object v5, Landroidx/appcompat/R$styleable;->StateListDrawable:[I
    ...
    sget v6, Landroidx/appcompat/R$styleable;->StateListDrawable_android_visible:I
    ...
    invoke-virtual {p0, v6, v7}, Landroidx/appcompat/graphics/drawable/StateListDrawable;->setVisible(ZZ)Z
    ...
    invoke-direct {p0, v5}, Landroidx/appcompat/graphics/drawable/StateListDrawable;->updateStateFromTypedArray(Landroid/content/res/TypedArray;)V
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean v5, p0, Landroidx/appcompat/graphics/drawable/StateListDrawable;->mMutated:Z
    ...
    invoke-virtual {v5}, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->mutate()V
...
.method protected onStateChange([I)Z
    ...
    invoke-virtual {v6, p1}, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->indexOfStateSet([I)I
    ...
    invoke-virtual {p1, v6}, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;->indexOfStateSet([I)I
...
.method protected setConstantState(Landroidx/appcompat/graphics/drawable/DrawableContainer$DrawableContainerState;)V
    ...
    instance-of v5, p1, Landroidx/appcompat/graphics/drawable/StateListDrawable$StateListState;

...
.method private applyTickMarkTint()V
    ...
    const-string v0, "Landroidx/appcompat/widget/AppCompatSeekBarHelper;"

    const-string v1, "applyTickMarkTint"
    ...
    iget-boolean v5, p0, Landroidx/appcompat/widget/AppCompatSeekBarHelper;->mHasTickMarkTint:Z

    if-nez v5, :cond_0

    iget-boolean v5, p0, Landroidx/appcompat/widget/AppCompatSeekBarHelper;->mHasTickMarkTintMode:Z
    ...
    iput-object v5, p0, Landroidx/appcompat/widget/AppCompatSeekBarHelper;->mTickMark:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/AppCompatSeekBarHelper;->mTickMarkTintList:Landroid/content/res/ColorStateList;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/AppCompatSeekBarHelper;->mTickMarkTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    const-string v0, "Landroid/widget/SeekBar;"
...
.method drawTickMarks(Landroid/graphics/Canvas;)V
    ...
    iget-object v7, p0, Landroidx/appcompat/widget/AppCompatSeekBarHelper;->mTickMark:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v9, p0, Landroidx/appcompat/widget/AppCompatSeekBarHelper;->mTickMark:Landroid/graphics/drawable/Drawable;
...
.method drawableStateChanged()V
    ...
    invoke-virtual {v6, v5}, Landroid/widget/SeekBar;->invalidateDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method getTickMarkTintList()Landroid/content/res/ColorStateList;
    ...
    const-string v1, "getTickMarkTintList"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/appcompat/widget/AppCompatSeekBarHelper;->mTickMarkTintList:Landroid/content/res/ColorStateList;
...
.method getTickMarkTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    const-string v1, "getTickMarkTintMode"
...
.method loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    const-string v1, "setThumb"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v5, p2}, Landroid/widget/SeekBar;->setThumb(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p2, v6}, Landroidx/appcompat/widget/DrawableUtils;->parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, p0, Landroidx/appcompat/widget/AppCompatSeekBarHelper;->mTickMarkTintMode:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v5, p0, Landroidx/appcompat/widget/AppCompatSeekBarHelper;->mHasTickMarkTintMode:Z
    ...
    iput-boolean v5, p0, Landroidx/appcompat/widget/AppCompatSeekBarHelper;->mHasTickMarkTint:Z
...
.method setTickMark(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v5}, Landroid/widget/SeekBar;->getDrawableState()[I
...
.method setTickMarkTintList(Landroid/content/res/ColorStateList;)V
    ...
    const-string v1, "setTickMarkTintList"
...
.method setTickMarkTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    const-string v1, "setTickMarkTintMode"

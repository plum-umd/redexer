...
.method private createSpinner()Landroid/widget/Spinner;
    ...
    const-string v0, "Landroidx/appcompat/widget/ScrollingTabContainerView;"

    const-string v1, "createSpinner"
    ...
    invoke-direct {v5, v6, v8, v7}, Landroidx/appcompat/widget/AppCompatSpinner;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v5, v6}, Landroid/widget/Spinner;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
...
.method private createTabLayout()Landroidx/appcompat/widget/LinearLayoutCompat;
    ...
    const-string v1, "createTabLayout"
    ...
    sget v7, Landroidx/appcompat/R$attr;->actionBarTabBarStyle:I

    const/4 v8, 0x0

    invoke-direct {v5, v6, v8, v7}, Landroidx/appcompat/widget/LinearLayoutCompat;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    const/4 v6, 0x1

    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/LinearLayoutCompat;->setMeasureWithLargestChildEnabled(Z)V

    const/16 v6, 0x11

    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/LinearLayoutCompat;->setGravity(I)V
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/LinearLayoutCompat;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
...
.method private isCollapsed()Z
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/ScrollingTabContainerView;->mTabSpinner:Landroid/widget/Spinner;
...
.method private performCollapse()V
    ...
    const-string v1, "performCollapse"
    ...
    iput-object v5, p0, Landroidx/appcompat/widget/ScrollingTabContainerView;->mTabSpinner:Landroid/widget/Spinner;
    ...
    invoke-virtual {p0, v5}, Landroidx/appcompat/widget/ScrollingTabContainerView;->removeView(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v5, v6}, Landroidx/appcompat/widget/ScrollingTabContainerView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    new-instance v6, Landroidx/appcompat/widget/ScrollingTabContainerView$TabAdapter;

    invoke-direct {v6, p0}, Landroidx/appcompat/widget/ScrollingTabContainerView$TabAdapter;-><init>(Landroidx/appcompat/widget/ScrollingTabContainerView;)V
    ...
    :cond_2
    iget-object v5, p0, Landroidx/appcompat/widget/ScrollingTabContainerView;->mTabSelector:Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, v5}, Landroidx/appcompat/widget/ScrollingTabContainerView;->removeCallbacks(Ljava/lang/Runnable;)Z
    ...
    iput-object v5, p0, Landroidx/appcompat/widget/ScrollingTabContainerView;->mTabSelector:Ljava/lang/Runnable;
...
.method private performExpand()Z
    ...
    invoke-virtual {p0, v5, v7}, Landroidx/appcompat/widget/ScrollingTabContainerView;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0, v5}, Landroidx/appcompat/widget/ScrollingTabContainerView;->setTabSelected(I)V
...
.method public addTab(Landroidx/appcompat/app/ActionBar$Tab;IZ)V
    ...
    invoke-direct {v7, v5, v8, v9}, Landroidx/appcompat/widget/LinearLayoutCompat$LayoutParams;-><init>(IIF)V
    ...
    invoke-virtual {v6, p1, p2, v7}, Landroidx/appcompat/widget/LinearLayoutCompat;->addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
...
.method public addTab(Landroidx/appcompat/app/ActionBar$Tab;Z)V
    ...
    invoke-virtual {v6, p1, v7}, Landroidx/appcompat/widget/LinearLayoutCompat;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method public animateToTab(I)V
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/widget/LinearLayoutCompat;->getChildAt(I)Landroid/view/View;
    ...
    invoke-direct {v5, p0, p1}, Landroidx/appcompat/widget/ScrollingTabContainerView$1;-><init>(Landroidx/appcompat/widget/ScrollingTabContainerView;Landroid/view/View;)V
...
.method public animateToVisibility(I)V
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/ScrollingTabContainerView;->mVisibilityAnim:Landroid/view/ViewPropertyAnimator;
    ...
    invoke-virtual {p0, v7}, Landroidx/appcompat/widget/ScrollingTabContainerView;->setAlpha(F)V
    ...
    sget-object v5, Landroidx/appcompat/widget/ScrollingTabContainerView;->sAlphaInterpolator:Landroid/view/animation/Interpolator;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/ScrollingTabContainerView;->mVisAnimListener:Landroidx/appcompat/widget/ScrollingTabContainerView$VisibilityAnimListener;

    invoke-virtual {v5, v7, p1}, Landroidx/appcompat/widget/ScrollingTabContainerView$VisibilityAnimListener;->withFinalVisibility(Landroid/view/ViewPropertyAnimator;I)Landroidx/appcompat/widget/ScrollingTabContainerView$VisibilityAnimListener;
    ...
    invoke-virtual {v7, p1}, Landroid/view/ViewPropertyAnimator;->setListener(Landroid/animation/Animator$AnimatorListener;)Landroid/view/ViewPropertyAnimator;
...
.method createTabView(Landroidx/appcompat/app/ActionBar$Tab;Z)Landroidx/appcompat/widget/ScrollingTabContainerView$TabView;
    ...
    const-string v1, "createTabView"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Landroidx/appcompat/widget/ScrollingTabContainerView$TabView;
    ...
    invoke-direct {v5, p0, v6, p1, p2}, Landroidx/appcompat/widget/ScrollingTabContainerView$TabView;-><init>(Landroidx/appcompat/widget/ScrollingTabContainerView;Landroid/content/Context;Landroidx/appcompat/app/ActionBar$Tab;Z)V
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/widget/ScrollingTabContainerView$TabView;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {p1, p2, v6}, Landroid/widget/AbsListView$LayoutParams;-><init>(II)V
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/widget/ScrollingTabContainerView$TabView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/widget/ScrollingTabContainerView$TabView;->setFocusable(Z)V
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/widget/ScrollingTabContainerView$TabView;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method public onAttachedToWindow()V
    ...
    invoke-virtual {p0, v5}, Landroidx/appcompat/widget/ScrollingTabContainerView;->post(Ljava/lang/Runnable;)Z
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, v5}, Landroidx/appcompat/widget/ScrollingTabContainerView;->setContentHeight(I)V
...
.method public onMeasure(II)V
    ...
    invoke-virtual {p0, v8}, Landroidx/appcompat/widget/ScrollingTabContainerView;->setFillViewport(Z)V
    ...
    iget-object v9, p0, Landroidx/appcompat/widget/ScrollingTabContainerView;->mTabLayout:Landroidx/appcompat/widget/LinearLayoutCompat;
    ...
    iput v9, p0, Landroidx/appcompat/widget/ScrollingTabContainerView;->mMaxTabWidth:I
    ...
    iget-boolean v7, p0, Landroidx/appcompat/widget/ScrollingTabContainerView;->mAllowCollapse:Z
    ...
    invoke-virtual {v5, v6, p2}, Landroidx/appcompat/widget/LinearLayoutCompat;->measure(II)V
    ...
    invoke-virtual {v5}, Landroidx/appcompat/widget/LinearLayoutCompat;->getMeasuredWidth()I
...
.method public removeAllTabs()V
    ...
    invoke-virtual {v5}, Landroidx/appcompat/widget/LinearLayoutCompat;->removeAllViews()V
    ...
    :cond_0
    iget-boolean v5, p0, Landroidx/appcompat/widget/ScrollingTabContainerView;->mAllowCollapse:Z
...
.method public removeTabAt(I)V
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/widget/LinearLayoutCompat;->removeViewAt(I)V
...
.method public setAllowCollapse(Z)V
    ...
    const-string v1, "setAllowCollapse"
...
.method public setTabSelected(I)V
    ...
    const-string v1, "setTabSelected"
    ...
    invoke-virtual {v8, v7}, Landroidx/appcompat/widget/LinearLayoutCompat;->getChildAt(I)Landroid/view/View;

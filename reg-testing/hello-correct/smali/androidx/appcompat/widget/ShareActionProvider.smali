...
.method private setActivityChooserPolicyIfNeeded()V
    ...
    const-string v0, "Landroidx/appcompat/widget/ShareActionProvider;"

    const-string v1, "setActivityChooserPolicyIfNeeded"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/appcompat/widget/ShareActionProvider;->mOnShareTargetSelectedListener:Landroidx/appcompat/widget/ShareActionProvider$OnShareTargetSelectedListener;
    ...
    :cond_0
    iget-object v5, p0, Landroidx/appcompat/widget/ShareActionProvider;->mOnChooseActivityListener:Landroidx/appcompat/widget/ActivityChooserModel$OnChooseActivityListener;

    if-nez v5, :cond_1

    new-instance v5, Landroidx/appcompat/widget/ShareActionProvider$ShareActivityChooserModelPolicy;

    invoke-direct {v5, p0}, Landroidx/appcompat/widget/ShareActionProvider$ShareActivityChooserModelPolicy;-><init>(Landroidx/appcompat/widget/ShareActionProvider;)V

    iput-object v5, p0, Landroidx/appcompat/widget/ShareActionProvider;->mOnChooseActivityListener:Landroidx/appcompat/widget/ActivityChooserModel$OnChooseActivityListener;

    :cond_1
    iget-object v5, p0, Landroidx/appcompat/widget/ShareActionProvider;->mContext:Landroid/content/Context;

    iget-object v6, p0, Landroidx/appcompat/widget/ShareActionProvider;->mShareHistoryFileName:Ljava/lang/String;

    invoke-static {v5, v6}, Landroidx/appcompat/widget/ActivityChooserModel;->get(Landroid/content/Context;Ljava/lang/String;)Landroidx/appcompat/widget/ActivityChooserModel;

    move-result-object v5

    iget-object v6, p0, Landroidx/appcompat/widget/ShareActionProvider;->mOnChooseActivityListener:Landroidx/appcompat/widget/ActivityChooserModel$OnChooseActivityListener;

    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/ActivityChooserModel;->setOnChooseActivityListener(Landroidx/appcompat/widget/ActivityChooserModel$OnChooseActivityListener;)V
...
.method public onCreateActionView()Landroid/view/View;
    ...
    new-instance v5, Landroidx/appcompat/widget/ActivityChooserView;

    iget-object v6, p0, Landroidx/appcompat/widget/ShareActionProvider;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v5}, Landroidx/appcompat/widget/ActivityChooserView;->isInEditMode()Z
    ...
    iget-object v7, p0, Landroidx/appcompat/widget/ShareActionProvider;->mShareHistoryFileName:Ljava/lang/String;
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/ActivityChooserView;->setActivityChooserModel(Landroidx/appcompat/widget/ActivityChooserModel;)V
    ...
    sget v8, Landroidx/appcompat/R$attr;->actionModeShareDrawable:I
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/ActivityChooserView;->setExpandActivityOverflowButtonDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v5, p0}, Landroidx/appcompat/widget/ActivityChooserView;->setProvider(Landroidx/core/view/ActionProvider;)V

    sget v6, Landroidx/appcompat/R$string;->abc_shareactionprovider_share_with_application:I

    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/ActivityChooserView;->setDefaultActionButtonContentDescription(I)V

    sget v6, Landroidx/appcompat/R$string;->abc_shareactionprovider_share_with:I

    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/ActivityChooserView;->setExpandActivityOverflowButtonContentDescription(I)V
...
.method public onPrepareSubMenu(Landroid/view/SubMenu;)V
    ...
    invoke-virtual {v5}, Landroidx/appcompat/widget/ActivityChooserModel;->getActivityCount()I

    move-result v7

    iget v8, p0, Landroidx/appcompat/widget/ShareActionProvider;->mMaxShownActivityCount:I
    ...
    invoke-virtual {v5, v10}, Landroidx/appcompat/widget/ActivityChooserModel;->getActivity(I)Landroid/content/pm/ResolveInfo;
    ...
    invoke-interface {p1, v9, v10, v10, v12}, Landroid/view/SubMenu;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-interface {v12, v11}, Landroid/view/MenuItem;->setIcon(Landroid/graphics/drawable/Drawable;)Landroid/view/MenuItem;
    ...
    iget-object v12, p0, Landroidx/appcompat/widget/ShareActionProvider;->mOnMenuItemClickListener:Landroidx/appcompat/widget/ShareActionProvider$ShareMenuItemOnMenuItemClickListener;
    ...
    iget-object v10, p0, Landroidx/appcompat/widget/ShareActionProvider;->mContext:Landroid/content/Context;
    ...
    invoke-interface {p1, v9, v8, v8, v10}, Landroid/view/SubMenu;->addSubMenu(IIILjava/lang/CharSequence;)Landroid/view/SubMenu;
    ...
    invoke-virtual {v5, v8}, Landroidx/appcompat/widget/ActivityChooserModel;->getActivity(I)Landroid/content/pm/ResolveInfo;
    ...
    invoke-interface {p1, v9, v8, v8, v11}, Landroid/view/SubMenu;->add(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    iget-object v11, p0, Landroidx/appcompat/widget/ShareActionProvider;->mOnMenuItemClickListener:Landroidx/appcompat/widget/ShareActionProvider$ShareMenuItemOnMenuItemClickListener;
...
.method public setOnShareTargetSelectedListener(Landroidx/appcompat/widget/ShareActionProvider$OnShareTargetSelectedListener;)V
    ...
    const-string v1, "setOnShareTargetSelectedListener"
...
.method public setShareHistoryFileName(Ljava/lang/String;)V
    ...
    const-string v1, "setShareHistoryFileName"
...
.method public setShareIntent(Landroid/content/Intent;)V
    ...
    const-string v1, "setShareIntent"
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/widget/ActivityChooserModel;->setIntent(Landroid/content/Intent;)V

...
.method private computePosition(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V
    ...
    const-string v0, "Landroidx/appcompat/widget/TooltipPopup;"

    const-string v1, "computePosition"
    ...
    const-string v1, "getApplicationWindowToken"
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/TooltipPopup;->mContext:Landroid/content/Context;
    ...
    sget v6, Landroidx/appcompat/R$dimen;->tooltip_precise_anchor_threshold:I
    ...
    sget v6, Landroidx/appcompat/R$dimen;->tooltip_precise_anchor_extra_offset:I
    ...
    sget v8, Landroidx/appcompat/R$dimen;->tooltip_y_offset_touch:I

    goto/16 :goto_2

    :cond_2
    sget v8, Landroidx/appcompat/R$dimen;->tooltip_y_offset_non_touch:I
    ...
    :cond_3
    iget-object v9, p0, Landroidx/appcompat/widget/TooltipPopup;->mTmpDisplayFrame:Landroid/graphics/Rect;
    ...
    iget-object v9, p0, Landroidx/appcompat/widget/TooltipPopup;->mContext:Landroid/content/Context;
    ...
    iget-object v11, p0, Landroidx/appcompat/widget/TooltipPopup;->mTmpDisplayFrame:Landroid/graphics/Rect;
    ...
    invoke-virtual {v11, v7, v10, v12, v9}, Landroid/graphics/Rect;->set(IIII)V
    ...
    :cond_5
    iget-object v9, p0, Landroidx/appcompat/widget/TooltipPopup;->mTmpAppPos:[I
    ...
    iget-object v9, p0, Landroidx/appcompat/widget/TooltipPopup;->mTmpAnchorPos:[I
    ...
    iget-object v10, p0, Landroidx/appcompat/widget/TooltipPopup;->mTmpAppPos:[I
...
.method private static getAppRootView(Landroid/view/View;)Landroid/view/View;
    ...
    const-string v1, "getAppRootView"
    ...
    :goto_0
    instance-of v6, p0, Landroid/content/ContextWrapper;
...
.method hide()V
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/TooltipPopup;->mContentView:Landroid/view/View;
...
.method isShowing()Z
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/TooltipPopup;->mContentView:Landroid/view/View;
...
.method show(Landroid/view/View;IIZLjava/lang/CharSequence;)V
    ...
    :cond_0
    iget-object v5, p0, Landroidx/appcompat/widget/TooltipPopup;->mMessageView:Landroid/widget/TextView;
    ...
    iget-object v11, p0, Landroidx/appcompat/widget/TooltipPopup;->mLayoutParams:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-direct/range {v6 .. v11}, Landroidx/appcompat/widget/TooltipPopup;->computePosition(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V

...
.method static getInstance(Landroid/content/Context;)Landroidx/appcompat/app/TwilightManager;
    ...
    const-string v0, "Landroidx/appcompat/app/TwilightManager;"

    const-string v1, "getInstance"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-object v5, Landroidx/appcompat/app/TwilightManager;->sInstance:Landroidx/appcompat/app/TwilightManager;
    ...
    new-instance v5, Landroidx/appcompat/app/TwilightManager;
    ...
    invoke-direct {v5, p0, v6}, Landroidx/appcompat/app/TwilightManager;-><init>(Landroid/content/Context;Landroid/location/LocationManager;)V

    sput-object v5, Landroidx/appcompat/app/TwilightManager;->sInstance:Landroidx/appcompat/app/TwilightManager;
...
.method private getLastKnownLocation()Landroid/location/Location;
    ...
    iget-object v5, p0, Landroidx/appcompat/app/TwilightManager;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v5}, Landroidx/appcompat/app/TwilightManager;->getLastKnownLocationForProvider(Ljava/lang/String;)Landroid/location/Location;
    ...
    :goto_0
    iget-object v7, p0, Landroidx/appcompat/app/TwilightManager;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v6}, Landroidx/appcompat/app/TwilightManager;->getLastKnownLocationForProvider(Ljava/lang/String;)Landroid/location/Location;
...
.method private getLastKnownLocationForProvider(Ljava/lang/String;)Landroid/location/Location;
    ...
    const-string v1, "getLastKnownLocationForProvider"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    :try_start_0
    iget-object v5, p0, Landroidx/appcompat/app/TwilightManager;->mLocationManager:Landroid/location/LocationManager;
    :try_end_0
    ...
    :try_start_1
    invoke-virtual {v5, p1}, Landroid/location/LocationManager;->isProviderEnabled(Ljava/lang/String;)Z
    ...
    invoke-static {v5, v6, p1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
...
.method private isStateValid()Z
    ...
    const-string v1, "isStateValid"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/appcompat/app/TwilightManager;->mTwilightState:Landroidx/appcompat/app/TwilightManager$TwilightState;

    iget-wide v5, v5, Landroidx/appcompat/app/TwilightManager$TwilightState;->nextUpdate:J
...
.method private updateState(Landroid/location/Location;)V
    ...
    iget-object v6, v5, Landroidx/appcompat/app/TwilightManager;->mTwilightState:Landroidx/appcompat/app/TwilightManager$TwilightState;
    ...
    invoke-virtual/range {v7 .. v13}, Landroidx/appcompat/app/TwilightCalculator;->calculateTwilight(JDD)V
    ...
    iget-wide v10, v0, Landroidx/appcompat/app/TwilightCalculator;->sunrise:J

    move-object/from16 v0, v16

    iget-wide v8, v0, Landroidx/appcompat/app/TwilightCalculator;->sunset:J
    ...
    iget-wide v7, v0, Landroidx/appcompat/app/TwilightCalculator;->sunrise:J
    ...
    :goto_3
    iput-boolean v5, v6, Landroidx/appcompat/app/TwilightManager$TwilightState;->isNight:Z

    move-wide/from16 v11, v25

    iput-wide v11, v6, Landroidx/appcompat/app/TwilightManager$TwilightState;->yesterdaySunset:J

    move-wide/from16 v2, v17

    iput-wide v2, v6, Landroidx/appcompat/app/TwilightManager$TwilightState;->todaySunrise:J

    move-wide/from16 v2, v19

    iput-wide v2, v6, Landroidx/appcompat/app/TwilightManager$TwilightState;->todaySunset:J

    iput-wide v7, v6, Landroidx/appcompat/app/TwilightManager$TwilightState;->tomorrowSunrise:J

    iput-wide v9, v6, Landroidx/appcompat/app/TwilightManager$TwilightState;->nextUpdate:J
...
.method isNight()Z
    ...
    invoke-direct {p0, v6}, Landroidx/appcompat/app/TwilightManager;->updateState(Landroid/location/Location;)V
    ...
    const-string v0, "Ljava/util/Calendar;"

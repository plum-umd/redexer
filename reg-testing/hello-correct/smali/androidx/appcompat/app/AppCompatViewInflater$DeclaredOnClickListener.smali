...
.method private resolveMethod(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-string v0, "Landroidx/appcompat/app/AppCompatViewInflater$DeclaredOnClickListener;"

    const-string v1, "resolveMethod"
    ...
    iget-object v6, p0, Landroidx/appcompat/app/AppCompatViewInflater$DeclaredOnClickListener;->mMethodName:Ljava/lang/String;
    ...
    const-string v6, "(View) in a parent or ancestor Context for android:onClick "
    ...
    const-string v6, "attribute defined on view "
    ...
    iget-object v6, p0, Landroidx/appcompat/app/AppCompatViewInflater$DeclaredOnClickListener;->mHostView:Landroid/view/View;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v5, p0, Landroidx/appcompat/app/AppCompatViewInflater$DeclaredOnClickListener;->mResolvedMethod:Ljava/lang/reflect/Method;
    ...
    invoke-direct {p0, v5, v6}, Landroidx/appcompat/app/AppCompatViewInflater$DeclaredOnClickListener;->resolveMethod(Landroid/content/Context;Ljava/lang/String;)V

    :cond_0
    :try_start_0
    iget-object v5, p0, Landroidx/appcompat/app/AppCompatViewInflater$DeclaredOnClickListener;->mResolvedMethod:Ljava/lang/reflect/Method;

    iget-object v6, p0, Landroidx/appcompat/app/AppCompatViewInflater$DeclaredOnClickListener;->mResolvedContext:Landroid/content/Context;
    ...
    const-string v6, "Could not execute method for android:onClick"

    invoke-direct {v5, v6, p1}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string v6, "Could not execute non-public method for android:onClick"

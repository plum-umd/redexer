...
.method private findRealOwner(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v0, "Landroidx/appcompat/view/SupportMenuInflater;"

    const-string v1, "findRealOwner"
    ...
    :cond_0
    instance-of v5, p1, Landroid/content/ContextWrapper;
...
.method private parseMenu(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    ...
    new-instance v5, Landroidx/appcompat/view/SupportMenuInflater$MenuState;
    ...
    invoke-direct/range {v0 .. v2}, Landroidx/appcompat/view/SupportMenuInflater$MenuState;-><init>(Landroidx/appcompat/view/SupportMenuInflater;Landroid/view/Menu;)V
    ...
    const-string v5, "Expecting menu, got "
    ...
    invoke-virtual {v5}, Landroidx/appcompat/view/SupportMenuInflater$MenuState;->resetGroup()V
    ...
    invoke-virtual {v5}, Landroidx/appcompat/view/SupportMenuInflater$MenuState;->hasAddedItem()Z

    move-result v11

    if-nez v11, :cond_d

    iget-object v11, v5, Landroidx/appcompat/view/SupportMenuInflater$MenuState;->itemActionProvider:Landroidx/core/view/ActionProvider;
    ...
    invoke-virtual {v5}, Landroidx/appcompat/view/SupportMenuInflater$MenuState;->addSubMenuItem()Landroid/view/SubMenu;

    goto/16 :goto_2

    :cond_6
    invoke-virtual {v5}, Landroidx/appcompat/view/SupportMenuInflater$MenuState;->addItem()V
    ...
    invoke-virtual/range {v0 .. v1}, Landroidx/appcompat/view/SupportMenuInflater$MenuState;->readGroup(Landroid/util/AttributeSet;)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroidx/appcompat/view/SupportMenuInflater$MenuState;->readItem(Landroid/util/AttributeSet;)V
    ...
    invoke-direct/range {v0 .. v3}, Landroidx/appcompat/view/SupportMenuInflater;->parseMenu(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
...
.method getRealOwner()Ljava/lang/Object;
    ...
    const-string v1, "getRealOwner"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/appcompat/view/SupportMenuInflater;->mRealOwner:Ljava/lang/Object;

    if-nez v5, :cond_0

    iget-object v5, p0, Landroidx/appcompat/view/SupportMenuInflater;->mContext:Landroid/content/Context;

    invoke-direct {p0, v5}, Landroidx/appcompat/view/SupportMenuInflater;->findRealOwner(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    iput-object v5, p0, Landroidx/appcompat/view/SupportMenuInflater;->mRealOwner:Ljava/lang/Object;
...
.method public inflate(ILandroid/view/Menu;)V
    ...
    instance-of v6, p2, Landroidx/core/internal/view/SupportMenu;
    ...
    :try_start_0
    iget-object v7, p0, Landroidx/appcompat/view/SupportMenuInflater;->mContext:Landroid/content/Context;
    :try_end_0
    ...
    :try_start_4
    invoke-direct {p0, v6, p1, p2}, Landroidx/appcompat/view/SupportMenuInflater;->parseMenu(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    :try_end_4
    ...
    invoke-direct {p2, v5, p1}, Landroid/view/InflateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_5

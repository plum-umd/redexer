...
.method private createPopup()Landroidx/appcompat/view/menu/MenuPopup;
    ...
    iget-object v6, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mContext:Landroid/content/Context;
    ...
    sget v7, Landroidx/appcompat/R$dimen;->abc_cascading_menus_min_smallest_width:I
    ...
    new-instance v5, Landroidx/appcompat/view/menu/CascadingMenuPopup;

    move-object/from16 v0, p0

    iget-object v7, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mContext:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v8, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mAnchorView:Landroid/view/View;

    move-object/from16 v0, p0

    iget v9, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mPopupStyleAttr:I

    move-object/from16 v0, p0

    iget v10, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mPopupStyleRes:I

    move-object/from16 v0, p0

    iget-boolean v11, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mOverflowOnly:Z
    ...
    iget-object v13, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mContext:Landroid/content/Context;

    move-object/from16 v0, p0

    iget-object v14, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mMenu:Landroidx/appcompat/view/menu/MenuBuilder;

    move-object/from16 v0, p0

    iget-object v15, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mAnchorView:Landroid/view/View;

    move-object/from16 v0, p0

    iget v2, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mPopupStyleAttr:I

    move/from16 v16, v2

    move-object/from16 v0, p0

    iget v2, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mPopupStyleRes:I

    move/from16 v17, v2

    move-object/from16 v0, p0

    iget-boolean v2, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mOverflowOnly:Z

    move/from16 v18, v2

    move-object v12, v5

    invoke-direct/range {v12 .. v18}, Landroidx/appcompat/view/menu/StandardMenuPopup;-><init>(Landroid/content/Context;Landroidx/appcompat/view/menu/MenuBuilder;Landroid/view/View;IIZ)V

    :goto_2
    move-object/from16 v0, p0

    iget-object v6, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mMenu:Landroidx/appcompat/view/menu/MenuBuilder;
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/view/menu/MenuPopup;->addMenu(Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    iget-object v6, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mInternalOnDismissListener:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/view/menu/MenuPopup;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    iget-object v6, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mAnchorView:Landroid/view/View;
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/view/menu/MenuPopup;->setAnchorView(Landroid/view/View;)V
    ...
    iget-object v6, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mPresenterCallback:Landroidx/appcompat/view/menu/MenuPresenter$Callback;
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/view/menu/MenuPopup;->setCallback(Landroidx/appcompat/view/menu/MenuPresenter$Callback;)V
    ...
    iget-boolean v6, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mForceShowIcon:Z
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/view/menu/MenuPopup;->setForceShowIcon(Z)V
    ...
    iget v6, v0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mDropDownGravity:I
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/view/menu/MenuPopup;->setGravity(I)V
...
.method private showPopup(IIZZ)V
    ...
    invoke-virtual {v5, p4}, Landroidx/appcompat/view/menu/MenuPopup;->setShowTitle(Z)V
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/view/menu/MenuPopup;->setHorizontalOffset(I)V
    ...
    invoke-virtual {v5, p2}, Landroidx/appcompat/view/menu/MenuPopup;->setVerticalOffset(I)V
    ...
    invoke-direct {p4, v6, v7, p1, p2}, Landroid/graphics/Rect;-><init>(IIII)V

    invoke-virtual {v5, p4}, Landroidx/appcompat/view/menu/MenuPopup;->setEpicenterBounds(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v5}, Landroidx/appcompat/view/menu/MenuPopup;->show()V
...
.method public dismiss()V
    ...
    iget-object v5, p0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mPopup:Landroidx/appcompat/view/menu/MenuPopup;
    ...
    invoke-virtual {v5}, Landroidx/appcompat/view/menu/MenuPopup;->dismiss()V
...
.method public getListView()Landroid/widget/ListView;
    ...
    invoke-virtual {v5}, Landroidx/appcompat/view/menu/MenuPopup;->getListView()Landroid/widget/ListView;
...
.method public getPopup()Landroidx/appcompat/view/menu/MenuPopup;
    ...
    iput-object v5, p0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mPopup:Landroidx/appcompat/view/menu/MenuPopup;
...
.method public isShowing()Z
    ...
    invoke-virtual {v5}, Landroidx/appcompat/view/menu/MenuPopup;->isShowing()Z
...
.method protected onDismiss()V
    ...
    iget-object v5, p0, Landroidx/appcompat/view/menu/MenuPopupHelper;->mOnDismissListener:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public setForceShowIcon(Z)V
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/view/menu/MenuPopup;->setForceShowIcon(Z)V
...
.method public setPresenterCallback(Landroidx/appcompat/view/menu/MenuPresenter$Callback;)V
    ...
    const-string v1, "setPresenterCallback"
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/view/menu/MenuPopup;->setCallback(Landroidx/appcompat/view/menu/MenuPresenter$Callback;)V
...
.method public show()V
    ...
    const-string v6, "MenuPopupHelper cannot be used without an anchor"
...
.method public tryShow()Z
    ...
    :cond_1
    invoke-direct {p0, v7, v7, v7, v7}, Landroidx/appcompat/view/menu/MenuPopupHelper;->showPopup(IIZZ)V
...
.method public tryShow(II)Z
    ...
    :cond_1
    invoke-direct {p0, p1, p2, v6, v6}, Landroidx/appcompat/view/menu/MenuPopupHelper;->showPopup(IIZZ)V

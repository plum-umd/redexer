...
.method private createPopupWindow()Landroidx/appcompat/widget/MenuPopupWindow;
    ...
    const-string v0, "Landroidx/appcompat/view/menu/CascadingMenuPopup;"

    const-string v1, "createPopupWindow"
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/MenuPopupWindow;->setHoverListener(Landroidx/appcompat/widget/MenuItemHoverListener;)V
    ...
    invoke-virtual {v5, p0}, Landroidx/appcompat/widget/MenuPopupWindow;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v5, p0}, Landroidx/appcompat/widget/MenuPopupWindow;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/MenuPopupWindow;->setAnchorView(Landroid/view/View;)V
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/MenuPopupWindow;->setDropDownGravity(I)V
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/MenuPopupWindow;->setModal(Z)V
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/MenuPopupWindow;->setInputMethodMode(I)V
...
.method private findIndexOfAddedMenu(Landroidx/appcompat/view/menu/MenuBuilder;)I
    ...
    const-string v1, "findIndexOfAddedMenu"
    ...
    iget-object v7, v7, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->menu:Landroidx/appcompat/view/menu/MenuBuilder;
...
.method private findMenuItemForSubmenu(Landroidx/appcompat/view/menu/MenuBuilder;Landroidx/appcompat/view/menu/MenuBuilder;)Landroid/view/MenuItem;
    ...
    const-string v1, "findMenuItemForSubmenu"
    ...
    invoke-virtual {p1, v6}, Landroidx/appcompat/view/menu/MenuBuilder;->getItem(I)Landroid/view/MenuItem;
...
.method private findParentViewForSubmenu(Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;Landroidx/appcompat/view/menu/MenuBuilder;)Landroid/view/View;
    ...
    const-string v1, "findParentViewForSubmenu"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p1, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->menu:Landroidx/appcompat/view/menu/MenuBuilder;

    invoke-direct {p0, v5, p2}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->findMenuItemForSubmenu(Landroidx/appcompat/view/menu/MenuBuilder;Landroidx/appcompat/view/menu/MenuBuilder;)Landroid/view/MenuItem;
    ...
    instance-of v7, v6, Landroid/widget/HeaderViewListAdapter;
    ...
    invoke-virtual {v6, v8}, Landroidx/appcompat/view/menu/MenuAdapter;->getItem(I)Landroidx/appcompat/view/menu/MenuItemImpl;
...
.method private getInitialMenuPosition()I
    ...
    const-string v1, "getInitialMenuPosition"
...
.method private getNextMenuPosition(I)I
    ...
    const-string v1, "getNextMenuPosition"
    ...
    invoke-virtual {v5, v6}, Landroid/widget/ListView;->getLocationOnScreen([I)V
...
.method private showMenu(Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    new-instance v6, Landroidx/appcompat/view/menu/MenuAdapter;

    move-object/from16 v0, p0

    iget-boolean v7, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mOverflowOnly:Z

    sget v8, Landroidx/appcompat/view/menu/CascadingMenuPopup;->ITEM_LAYOUT:I
    ...
    invoke-direct/range {v0 .. v4}, Landroidx/appcompat/view/menu/MenuAdapter;-><init>(Landroidx/appcompat/view/menu/MenuBuilder;Landroid/view/LayoutInflater;ZI)V

    move-object/from16 v0, p0

    invoke-virtual/range {v0 .. v0}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->isShowing()Z
    ...
    iget-boolean v7, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mForceShowIcon:Z

    if-eqz v7, :cond_0

    invoke-virtual {v6, v8}, Landroidx/appcompat/view/menu/MenuAdapter;->setForceShowIcon(Z)V
    ...
    invoke-static/range {v0 .. v0}, Landroidx/appcompat/view/menu/MenuPopup;->shouldPreserveIconSpacing(Landroidx/appcompat/view/menu/MenuBuilder;)Z

    move-result v7

    invoke-virtual {v6, v7}, Landroidx/appcompat/view/menu/MenuAdapter;->setForceShowIcon(Z)V
    ...
    iget v9, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mMenuMaxWidth:I
    ...
    const-string v0, "Landroidx/appcompat/view/menu/MenuPopup;"

    const-string v1, "measureIndividualMenuWidth"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-static {v6, v10, v7, v9}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->measureIndividualMenuWidth(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I
    ...
    invoke-direct/range {v0 .. v0}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->createPopupWindow()Landroidx/appcompat/widget/MenuPopupWindow;
    ...
    invoke-virtual {v9, v6}, Landroidx/appcompat/widget/MenuPopupWindow;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v9, v7}, Landroidx/appcompat/widget/MenuPopupWindow;->setContentWidth(I)V
    ...
    iget v6, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mDropDownGravity:I
    ...
    invoke-virtual {v9, v6}, Landroidx/appcompat/widget/MenuPopupWindow;->setDropDownGravity(I)V
    ...
    invoke-direct/range {v0 .. v2}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->findParentViewForSubmenu(Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;Landroidx/appcompat/view/menu/MenuBuilder;)Landroid/view/View;
    ...
    invoke-virtual {v9, v12}, Landroidx/appcompat/widget/MenuPopupWindow;->setTouchModal(Z)V

    invoke-virtual {v9, v10}, Landroidx/appcompat/widget/MenuPopupWindow;->setEnterTransition(Ljava/lang/Object;)V

    move-object/from16 v0, p0

    move/from16 v1, v7

    invoke-direct/range {v0 .. v1}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->getNextMenuPosition(I)I
    ...
    invoke-virtual {v9, v11}, Landroidx/appcompat/widget/MenuPopupWindow;->setAnchorView(Landroid/view/View;)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/view/View;->getLocationOnScreen([I)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroidx/appcompat/widget/MenuPopupWindow;->setHorizontalOffset(I)V
    ...
    invoke-virtual {v9, v8}, Landroidx/appcompat/widget/MenuPopupWindow;->setOverlapAnchor(Z)V
    ...
    invoke-virtual {v9, v13}, Landroidx/appcompat/widget/MenuPopupWindow;->setVerticalOffset(I)V
    ...
    iget-boolean v7, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mHasXOffset:Z

    if-eqz v7, :cond_a

    move-object/from16 v0, p0

    iget v7, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mXOffset:I
    ...
    invoke-virtual {v9, v7}, Landroidx/appcompat/widget/MenuPopupWindow;->setHorizontalOffset(I)V
    ...
    iget-boolean v7, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mHasYOffset:Z

    if-eqz v7, :cond_b

    move-object/from16 v0, p0

    iget v7, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mYOffset:I
    ...
    invoke-virtual {v9, v7}, Landroidx/appcompat/widget/MenuPopupWindow;->setVerticalOffset(I)V
    ...
    const-string v1, "getEpicenterBounds"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    move-object/from16 v0, p0

    invoke-virtual/range {v0 .. v0}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->getEpicenterBounds()Landroid/graphics/Rect;
    ...
    invoke-virtual {v9, v7}, Landroidx/appcompat/widget/MenuPopupWindow;->setEpicenterBounds(Landroid/graphics/Rect;)V
    ...
    :goto_7
    new-instance v7, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;

    move-object/from16 v0, p0

    iget v8, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mLastPosition:I
    ...
    invoke-direct/range {v0 .. v3}, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;-><init>(Landroidx/appcompat/widget/MenuPopupWindow;Landroidx/appcompat/view/menu/MenuBuilder;I)V
    ...
    invoke-virtual {v9}, Landroidx/appcompat/widget/MenuPopupWindow;->show()V
    ...
    invoke-virtual {v9}, Landroidx/appcompat/widget/MenuPopupWindow;->getListView()Landroid/widget/ListView;
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/widget/ListView;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V
    ...
    iget-boolean v6, v0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mShowTitle:Z

    if-eqz v6, :cond_c

    move-object/from16 v0, p1

    invoke-virtual/range {v0 .. v0}, Landroidx/appcompat/view/menu/MenuBuilder;->getHeaderTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v5, v12}, Landroid/widget/FrameLayout;->setEnabled(Z)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v7, v5, v10, v12}, Landroid/widget/ListView;->addHeaderView(Landroid/view/View;Ljava/lang/Object;Z)V
...
.method public addMenu(Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    invoke-virtual {p1, p0, v5}, Landroidx/appcompat/view/menu/MenuBuilder;->addMenuPresenter(Landroidx/appcompat/view/menu/MenuPresenter;Landroid/content/Context;)V
    ...
    :cond_0
    iget-object v5, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mPendingMenus:Ljava/util/List;
...
.method protected closeMenuOnSubMenuOpened()Z
    ...
    const-string v1, "closeMenuOnSubMenuOpened"
...
.method public dismiss()V
    ...
    new-array v7, v5, [Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;
    ...
    iget-object v8, v7, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->window:Landroidx/appcompat/widget/MenuPopupWindow;
    ...
    invoke-virtual {v8}, Landroidx/appcompat/widget/MenuPopupWindow;->isShowing()Z
    ...
    invoke-virtual {v7}, Landroidx/appcompat/widget/MenuPopupWindow;->dismiss()V
...
.method public onCloseMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
    ...
    iget-object v6, v5, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->window:Landroidx/appcompat/widget/MenuPopupWindow;

    invoke-virtual {v6, v7}, Landroidx/appcompat/widget/MenuPopupWindow;->setExitTransition(Ljava/lang/Object;)V
    ...
    invoke-interface {p2, p1, v5}, Landroidx/appcompat/view/menu/MenuPresenter$Callback;->onCloseMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
    ...
    :cond_5
    iput-object v7, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    invoke-virtual {p1, v8}, Landroidx/appcompat/view/menu/MenuBuilder;->close(Z)V
...
.method public onDismiss()V
    ...
    iget-object v9, v8, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->window:Landroidx/appcompat/widget/MenuPopupWindow;
    ...
    invoke-virtual {v9}, Landroidx/appcompat/widget/MenuPopupWindow;->isShowing()Z
    ...
    iget-object v5, v8, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->menu:Landroidx/appcompat/view/menu/MenuBuilder;
...
.method public onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
    ...
    iget-object v8, v6, Landroidx/appcompat/view/menu/CascadingMenuPopup$CascadingMenuInfo;->menu:Landroidx/appcompat/view/menu/MenuBuilder;
    ...
    iget-object v5, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mPresenterCallback:Landroidx/appcompat/view/menu/MenuPresenter$Callback;
    ...
    invoke-interface {v5, p1}, Landroidx/appcompat/view/menu/MenuPresenter$Callback;->onOpenSubMenu(Landroidx/appcompat/view/menu/MenuBuilder;)Z
...
.method public setGravity(I)V
    ...
    iget v5, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mRawDropDownGravity:I
...
.method public setHorizontalOffset(I)V
    ...
    iput-boolean v5, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mHasXOffset:Z
...
.method public setVerticalOffset(I)V
    ...
    iput-boolean v5, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mHasYOffset:Z
...
.method public show()V
    ...
    invoke-direct {p0, v6}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->showMenu(Landroidx/appcompat/view/menu/MenuBuilder;)V
    ...
    iput-object v5, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mShownAnchorView:Landroid/view/View;

    iget-object v5, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mShownAnchorView:Landroid/view/View;

    if-eqz v5, :cond_4

    iget-object v5, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iput-object v6, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iget-object v6, p0, Landroidx/appcompat/view/menu/CascadingMenuPopup;->mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;
...
.method public updateMenuView(Z)V
    ...
    const-string v1, "toMenuAdapter"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-static {v5}, Landroidx/appcompat/view/menu/CascadingMenuPopup;->toMenuAdapter(Landroid/widget/ListAdapter;)Landroidx/appcompat/view/menu/MenuAdapter;
    ...
    invoke-virtual {v5}, Landroidx/appcompat/view/menu/MenuAdapter;->notifyDataSetChanged()V

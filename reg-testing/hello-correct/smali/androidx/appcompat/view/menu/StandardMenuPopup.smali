...
.method private tryShow()Z
    ...
    const-string v0, "Landroidx/appcompat/view/menu/StandardMenuPopup;"
    ...
    :cond_0
    iget-boolean v5, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mWasDismissed:Z
    ...
    :cond_1
    iput-object v5, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mShownAnchorView:Landroid/view/View;
    ...
    iget-object v8, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mTreeObserver:Landroid/view/ViewTreeObserver;
    ...
    iput-object v9, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mTreeObserver:Landroid/view/ViewTreeObserver;

    if-eqz v8, :cond_3

    iget-object v8, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mTreeObserver:Landroid/view/ViewTreeObserver;

    iget-object v9, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    :cond_3
    iget-object v8, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iget-object v8, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopup:Landroidx/appcompat/widget/MenuPopupWindow;
    ...
    invoke-virtual {v8, v5}, Landroidx/appcompat/widget/MenuPopupWindow;->setAnchorView(Landroid/view/View;)V
    ...
    invoke-virtual {v5, v8}, Landroidx/appcompat/widget/MenuPopupWindow;->setDropDownGravity(I)V
    ...
    iget-boolean v5, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mHasContentWidth:Z
    ...
    iget-object v9, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mContext:Landroid/content/Context;

    iget v10, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopupMaxWidth:I
    ...
    invoke-static {v5, v8, v9, v10}, Landroidx/appcompat/view/menu/StandardMenuPopup;->measureIndividualMenuWidth(Landroid/widget/ListAdapter;Landroid/view/ViewGroup;Landroid/content/Context;I)I
    ...
    iput v5, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mContentWidth:I

    iput-boolean v6, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mHasContentWidth:Z

    :cond_4
    iget-object v5, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopup:Landroidx/appcompat/widget/MenuPopupWindow;

    iget v9, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mContentWidth:I
    ...
    invoke-virtual {v5, v9}, Landroidx/appcompat/widget/MenuPopupWindow;->setContentWidth(I)V
    ...
    invoke-virtual {v5, v9}, Landroidx/appcompat/widget/MenuPopupWindow;->setInputMethodMode(I)V
    ...
    invoke-virtual {v5, v9}, Landroidx/appcompat/widget/MenuPopupWindow;->setEpicenterBounds(Landroid/graphics/Rect;)V
    ...
    iget-boolean v9, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mShowTitle:Z

    if-eqz v9, :cond_6

    iget-object v9, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mMenu:Landroidx/appcompat/view/menu/MenuBuilder;

    invoke-virtual {v9}, Landroidx/appcompat/view/menu/MenuBuilder;->getHeaderTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v9, v10, v5, v7}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    iget-object v11, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mMenu:Landroidx/appcompat/view/menu/MenuBuilder;

    invoke-virtual {v11}, Landroidx/appcompat/view/menu/MenuBuilder;->getHeaderTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v5, v9, v8, v7}, Landroid/widget/ListView;->addHeaderView(Landroid/view/View;Ljava/lang/Object;Z)V
    ...
    invoke-virtual {v5, v7}, Landroidx/appcompat/widget/MenuPopupWindow;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public onCloseMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
    ...
    iget-object v5, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPresenterCallback:Landroidx/appcompat/view/menu/MenuPresenter$Callback;
    ...
    invoke-interface {v5, p1, p2}, Landroidx/appcompat/view/menu/MenuPresenter$Callback;->onCloseMenu(Landroidx/appcompat/view/menu/MenuBuilder;Z)V
...
.method public onDismiss()V
    ...
    iput-boolean v5, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mWasDismissed:Z
    ...
    iget-object v6, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mGlobalLayoutListener:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iget-object v6, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mAttachStateChangeListener:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iget-object v5, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mOnDismissListener:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public onSubMenuSelected(Landroidx/appcompat/view/menu/SubMenuBuilder;)Z
    ...
    iget-object v10, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mShownAnchorView:Landroid/view/View;

    iget-boolean v11, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mOverflowOnly:Z

    iget v12, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopupStyleAttr:I

    iget v13, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPopupStyleRes:I
    ...
    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mPresenterCallback:Landroidx/appcompat/view/menu/MenuPresenter$Callback;

    invoke-virtual {v5, v7}, Landroidx/appcompat/view/menu/MenuPopupHelper;->setPresenterCallback(Landroidx/appcompat/view/menu/MenuPresenter$Callback;)V
    ...
    invoke-virtual {v5, v7}, Landroidx/appcompat/view/menu/MenuPopupHelper;->setForceShowIcon(Z)V

    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mOnDismissListener:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v5, v7}, Landroidx/appcompat/view/menu/MenuPopupHelper;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V

    const/4 v7, 0x0

    iput-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mOnDismissListener:Landroid/widget/PopupWindow$OnDismissListener;

    iget-object v7, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mMenu:Landroidx/appcompat/view/menu/MenuBuilder;

    invoke-virtual {v7, v6}, Landroidx/appcompat/view/menu/MenuBuilder;->close(Z)V
    ...
    invoke-virtual {v7}, Landroidx/appcompat/widget/MenuPopupWindow;->getHorizontalOffset()I
    ...
    invoke-virtual {v8}, Landroidx/appcompat/widget/MenuPopupWindow;->getVerticalOffset()I
    ...
    iget v9, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mDropDownGravity:I

    iget-object v10, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mAnchorView:Landroid/view/View;
    ...
    const-string v0, "Landroid/view/Gravity;"
    ...
    iget-object v9, p0, Landroidx/appcompat/view/menu/StandardMenuPopup;->mAnchorView:Landroid/view/View;
    ...
    :cond_0
    invoke-virtual {v5, v7, v8}, Landroidx/appcompat/view/menu/MenuPopupHelper;->tryShow(II)Z
...
.method public setForceShowIcon(Z)V
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/view/menu/MenuAdapter;->setForceShowIcon(Z)V
...
.method public setHorizontalOffset(I)V
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/widget/MenuPopupWindow;->setHorizontalOffset(I)V
...
.method public setVerticalOffset(I)V
    ...
    invoke-virtual {v5, p1}, Landroidx/appcompat/widget/MenuPopupWindow;->setVerticalOffset(I)V
...
.method public show()V
    ...
    const-string v6, "StandardMenuPopup cannot be used without an anchor"

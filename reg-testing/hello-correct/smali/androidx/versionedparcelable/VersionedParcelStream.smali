...
.method private readObject(ILjava/lang/String;Landroid/os/Bundle;)V
    ...
    const-string v0, "Landroidx/versionedparcelable/VersionedParcelStream;"
    ...
    const-string v1, "readFloatArray"
    ...
    invoke-virtual {p3, p2, v5, v6}, Landroid/os/Bundle;->putLong(Ljava/lang/String;J)V
    ...
    const-string v1, "readDoubleArray"
    ...
    invoke-virtual {p3, p2, v5, v6}, Landroid/os/Bundle;->putDouble(Ljava/lang/String;D)V
    ...
    const-string v1, "readBooleanArray"
...
.method private writeObject(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v5}, Landroidx/versionedparcelable/VersionedParcelStream;->writeInt(I)V
    ...
    const-string v1, "writeBooleanArray"
    ...
    invoke-virtual {p0, v5, v6}, Landroidx/versionedparcelable/VersionedParcelStream;->writeDouble(D)V
    ...
    const-string v1, "writeDoubleArray"
    ...
    invoke-virtual {p0, v5, v6}, Landroidx/versionedparcelable/VersionedParcelStream;->writeLong(J)V
    ...
    const-string v1, "writeLongArray"
    ...
    const-string v1, "writeFloatArray"
...
.method public closeField()V
    ...
    const-string v1, "closeField"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/versionedparcelable/VersionedParcelStream;->mFieldBuffer:Landroidx/versionedparcelable/VersionedParcelStream$FieldBuffer;

    if-eqz v5, :cond_1

    :try_start_0
    iget-object v5, v5, Landroidx/versionedparcelable/VersionedParcelStream$FieldBuffer;->mOutput:Ljava/io/ByteArrayOutputStream;
    :try_end_0
    ...
    invoke-virtual {v5}, Landroidx/versionedparcelable/VersionedParcelStream$FieldBuffer;->flushField()V
    :try_end_2
    ...
    iput-object v5, p0, Landroidx/versionedparcelable/VersionedParcelStream;->mFieldBuffer:Landroidx/versionedparcelable/VersionedParcelStream$FieldBuffer;
    ...
    invoke-direct {v6, v5}, Landroidx/versionedparcelable/VersionedParcel$ParcelException;-><init>(Ljava/lang/Throwable;)V
...
.method protected createSubParcel()Landroidx/versionedparcelable/VersionedParcel;
    ...
    const-string v1, "createSubParcel"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Landroidx/versionedparcelable/VersionedParcelStream;

    iget-object v6, p0, Landroidx/versionedparcelable/VersionedParcelStream;->mCurrentInput:Ljava/io/DataInputStream;

    iget-object v7, p0, Landroidx/versionedparcelable/VersionedParcelStream;->mCurrentOutput:Ljava/io/DataOutputStream;

    invoke-direct {v5, v6, v7}, Landroidx/versionedparcelable/VersionedParcelStream;-><init>(Ljava/io/InputStream;Ljava/io/OutputStream;)V
...
.method public readBundle()Landroid/os/Bundle;
    ...
    invoke-direct {p0, v9, v8, v6}, Landroidx/versionedparcelable/VersionedParcelStream;->readObject(ILjava/lang/String;Landroid/os/Bundle;)V
...
.method public readField(I)Z
    ...
    iget-object v7, p0, Landroidx/versionedparcelable/VersionedParcelStream;->mCachedFields:Landroid/util/SparseArray;
    ...
    iget-object p1, v5, Landroidx/versionedparcelable/VersionedParcelStream$InputBuffer;->mInputStream:Ljava/io/DataInputStream;
    ...
    iget-object v8, p0, Landroidx/versionedparcelable/VersionedParcelStream;->mMasterInput:Ljava/io/DataInputStream;
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    :cond_1
    :try_start_4
    new-instance v9, Landroidx/versionedparcelable/VersionedParcelStream$InputBuffer;

    shr-int/lit8 v5, v5, 0x10

    and-int/2addr v5, v7

    iget-object v7, p0, Landroidx/versionedparcelable/VersionedParcelStream;->mMasterInput:Ljava/io/DataInputStream;

    invoke-direct {v9, v5, v8, v7}, Landroidx/versionedparcelable/VersionedParcelStream$InputBuffer;-><init>(IILjava/io/DataInputStream;)V

    iget v5, v9, Landroidx/versionedparcelable/VersionedParcelStream$InputBuffer;->mFieldId:I

    if-ne v5, p1, :cond_2

    iget-object p1, v9, Landroidx/versionedparcelable/VersionedParcelStream$InputBuffer;->mInputStream:Ljava/io/DataInputStream;
    ...
    iget v7, v9, Landroidx/versionedparcelable/VersionedParcelStream$InputBuffer;->mFieldId:I
    :try_end_5
...
.method public readString()Ljava/lang/String;
    ...
    :try_start_4
    sget-object v7, Landroidx/versionedparcelable/VersionedParcelStream;->UTF_16:Ljava/nio/charset/Charset;
...
.method public readStrongBinder()Landroid/os/IBinder;
    ...
    const-string v1, "readStrongBinder"
...
.method public setOutputField(I)V
    ...
    const-string v1, "setOutputField"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0}, Landroidx/versionedparcelable/VersionedParcelStream;->closeField()V

    new-instance v5, Landroidx/versionedparcelable/VersionedParcelStream$FieldBuffer;

    iget-object v6, p0, Landroidx/versionedparcelable/VersionedParcelStream;->mMasterOutput:Ljava/io/DataOutputStream;

    invoke-direct {v5, p1, v6}, Landroidx/versionedparcelable/VersionedParcelStream$FieldBuffer;-><init>(ILjava/io/DataOutputStream;)V
...
.method public setSerializationFlags(ZZ)V
    ...
    const-string v1, "setSerializationFlags"
...
.method public writeBoolean(Z)V
    ...
    :try_start_0
    iget-object v5, p0, Landroidx/versionedparcelable/VersionedParcelStream;->mCurrentOutput:Ljava/io/DataOutputStream;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :try_start_1
    invoke-virtual {v5, p1}, Ljava/io/DataOutputStream;->writeBoolean(Z)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-direct {v5, p1}, Landroidx/versionedparcelable/VersionedParcel$ParcelException;-><init>(Ljava/lang/Throwable;)V
...
.method public writeBundle(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v6}, Landroidx/versionedparcelable/VersionedParcelStream;->writeString(Ljava/lang/String;)V
    :try_end_8
    ...
    :try_start_a
    invoke-direct {p0, v6}, Landroidx/versionedparcelable/VersionedParcelStream;->writeObject(Ljava/lang/Object;)V
...
.method public writeByteArray([B)V
    ...
    const-string v1, "writeByteArray"
...
.method public writeByteArray([BII)V
    ...
    :try_start_1
    invoke-virtual {v5, p3}, Ljava/io/DataOutputStream;->writeInt(I)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    :try_start_2
    invoke-virtual {v5, p1, p2, p3}, Ljava/io/DataOutputStream;->write([BII)V
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
...
.method public writeDouble(D)V
    ...
    :try_start_1
    invoke-virtual {v5, p1, p2}, Ljava/io/DataOutputStream;->writeDouble(D)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
...
.method public writeFloat(F)V
    ...
    :try_start_1
    invoke-virtual {v5, p1}, Ljava/io/DataOutputStream;->writeFloat(F)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
...
.method public writeLong(J)V
    ...
    :try_start_1
    invoke-virtual {v5, p1, p2}, Ljava/io/DataOutputStream;->writeLong(J)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
...
.method public writeParcelable(Landroid/os/Parcelable;)V
    ...
    const-string v5, "Parcelables cannot be written to an OutputStream"
...
.method public writeString(Ljava/lang/String;)V
    ...
    :try_start_0
    sget-object v5, Landroidx/versionedparcelable/VersionedParcelStream;->UTF_16:Ljava/nio/charset/Charset;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public writeStrongBinder(Landroid/os/IBinder;)V
    ...
    const-string v1, "writeStrongBinder"
    ...
    const-string v5, "Binders cannot be written to an OutputStream"
...
.method public writeStrongInterface(Landroid/os/IInterface;)V
    ...
    const-string v1, "writeStrongInterface"

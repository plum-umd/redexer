...
.method private static getBrowserActionsIntentHandlers(Landroid/content/Context;)Ljava/util/List;
    ...
    const-string v0, "Landroidx/browser/browseractions/BrowserActionsIntent;"

    const-string v1, "getBrowserActionsIntentHandlers"
    ...
    const-string v7, "androidx.browser.browseractions.browser_action_open"
...
.method public static getCreatorPackageName(Landroid/content/Intent;)Ljava/lang/String;
    ...
    const-string v1, "getCreatorPackageName"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    const-string v5, "androidx.browser.browseractions.APP_ID"
    ...
    const-string v1, "getCreatorPackage"
...
.method public static launchIntent(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1, v5}, Landroidx/browser/browseractions/BrowserActionsIntent;->launchIntent(Landroid/content/Context;Landroid/content/Intent;Ljava/util/List;)V
...
.method static launchIntent(Landroid/content/Context;Landroid/content/Intent;Ljava/util/List;)V
    ...
    const-string v7, "https://www.example.com"
...
.method public static openBrowserAction(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    const-string v1, "openBrowserAction"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Landroidx/browser/browseractions/BrowserActionsIntent$Builder;

    invoke-direct {v5, p0, p1}, Landroidx/browser/browseractions/BrowserActionsIntent$Builder;-><init>(Landroid/content/Context;Landroid/net/Uri;)V

    invoke-virtual {v5}, Landroidx/browser/browseractions/BrowserActionsIntent$Builder;->build()Landroidx/browser/browseractions/BrowserActionsIntent;
...
.method public static openBrowserAction(Landroid/content/Context;Landroid/net/Uri;ILjava/util/ArrayList;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {v5, p2}, Landroidx/browser/browseractions/BrowserActionsIntent$Builder;->setUrlType(I)Landroidx/browser/browseractions/BrowserActionsIntent$Builder;
...
.method private static openFallbackBrowserActionsMenu(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    const-string v1, "openFallbackBrowserActionsMenu"
    ...
    const-string v6, "androidx.browser.browseractions.extra.TYPE"
    ...
    const-string v1, "getParcelableArrayListExtra"
    ...
    :goto_0
    invoke-static {p0, v5, v6, p1}, Landroidx/browser/browseractions/BrowserActionsIntent;->openFallbackBrowserActionsMenu(Landroid/content/Context;Landroid/net/Uri;ILjava/util/List;)V
...
.method public static parseBrowserActionItems(Ljava/util/ArrayList;)Ljava/util/List;
    ...
    const-string v1, "parseBrowserActionItems"
    ...
    const-string v8, "androidx.browser.browseractions.TITLE"
    ...
    const-string v9, "androidx.browser.browseractions.ACTION"
    ...
    const-string v10, "androidx.browser.browseractions.ICON_ID"
    ...
    new-instance v10, Landroidx/browser/browseractions/BrowserActionItem;

    invoke-direct {v10, v8, v9, v7}, Landroidx/browser/browseractions/BrowserActionItem;-><init>(Ljava/lang/String;Landroid/app/PendingIntent;I)V
...
.method static setDialogShownListenter(Landroidx/browser/browseractions/BrowserActionsIntent$BrowserActionsFallDialogListener;)V
    ...
    const-string v1, "setDialogShownListenter"
...
.method public getIntent()Landroid/content/Intent;
    ...
    iget-object v5, p0, Landroidx/browser/browseractions/BrowserActionsIntent;->mIntent:Landroid/content/Intent;

...
.method public static createMockSessionForTesting(Landroid/content/ComponentName;)Landroidx/browser/customtabs/CustomTabsSession;
    ...
    const-string v0, "Landroidx/browser/customtabs/CustomTabsSession;"

    const-string v1, "createMockSessionForTesting"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Landroidx/browser/customtabs/CustomTabsSession;

    new-instance v6, Landroidx/browser/customtabs/CustomTabsSessionToken$MockCallback;

    invoke-direct {v6}, Landroidx/browser/customtabs/CustomTabsSessionToken$MockCallback;-><init>()V

    const/4 v7, 0x0

    invoke-direct {v5, v7, v6, p0}, Landroidx/browser/customtabs/CustomTabsSession;-><init>(Landroid/support/customtabs/ICustomTabsService;Landroid/support/customtabs/ICustomTabsCallback;Landroid/content/ComponentName;)V
...
.method getBinder()Landroid/os/IBinder;
    ...
    iget-object v5, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Landroid/support/customtabs/ICustomTabsCallback;
    ...
    invoke-interface {v5}, Landroid/support/customtabs/ICustomTabsCallback;->asBinder()Landroid/os/IBinder;
...
.method getComponentName()Landroid/content/ComponentName;
    ...
    iget-object v5, p0, Landroidx/browser/customtabs/CustomTabsSession;->mComponentName:Landroid/content/ComponentName;
...
.method public mayLaunchUrl(Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
    ...
    :try_start_0
    iget-object v5, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Landroid/support/customtabs/ICustomTabsService;

    iget-object v6, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Landroid/support/customtabs/ICustomTabsCallback;
    :try_end_0
    ...
    :try_start_1
    invoke-interface {v5, v6, p1, p2, p3}, Landroid/support/customtabs/ICustomTabsService;->mayLaunchUrl(Landroid/support/customtabs/ICustomTabsCallback;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
...
.method public requestPostMessageChannel(Landroid/net/Uri;)Z
    ...
    :try_start_1
    invoke-interface {v5, v6, p1}, Landroid/support/customtabs/ICustomTabsService;->requestPostMessageChannel(Landroid/support/customtabs/ICustomTabsCallback;Landroid/net/Uri;)Z
...
.method public setActionButton(Landroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, p2, v5}, Landroid/os/Bundle;->putBundle(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    :try_start_1
    invoke-interface {p2, v5, p1}, Landroid/support/customtabs/ICustomTabsService;->updateVisuals(Landroid/support/customtabs/ICustomTabsCallback;Landroid/os/Bundle;)Z
...
.method public setSecondaryToolbarViews(Landroid/widget/RemoteViews;[ILandroid/app/PendingIntent;)Z
    ...
    const-string v1, "setSecondaryToolbarViews"
    ...
    const-string v6, "android.support.customtabs.extra.EXTRA_REMOTEVIEWS"
    ...
    invoke-virtual {v5, p1, p2}, Landroid/os/Bundle;->putIntArray(Ljava/lang/String;[I)V
    ...
    invoke-virtual {v5, p1, p3}, Landroid/os/Bundle;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V
    ...
    :try_start_1
    invoke-interface {p1, p2, v5}, Landroid/support/customtabs/ICustomTabsService;->updateVisuals(Landroid/support/customtabs/ICustomTabsCallback;Landroid/os/Bundle;)Z
...
.method public setToolbarItem(ILandroid/graphics/Bitmap;Ljava/lang/String;)Z
    ...
    const-string v1, "setToolbarItem"
...
.method public validateRelationship(ILandroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    :cond_0
    :try_start_0
    iget-object v6, p0, Landroidx/browser/customtabs/CustomTabsSession;->mService:Landroid/support/customtabs/ICustomTabsService;

    iget-object v7, p0, Landroidx/browser/customtabs/CustomTabsSession;->mCallback:Landroid/support/customtabs/ICustomTabsCallback;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :try_start_1
    invoke-interface {v6, v7, p1, p2, p3}, Landroid/support/customtabs/ICustomTabsService;->validateRelationship(Landroid/support/customtabs/ICustomTabsCallback;ILandroid/net/Uri;Landroid/os/Bundle;)Z

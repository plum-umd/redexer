...
.method private createTintFilter(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    const-string v0, "Landroidx/cardview/widget/RoundRectDrawable;"
    ...
    invoke-virtual {p1, v5, v6}, Landroid/content/res/ColorStateList;->getColorForState([II)I
    ...
    invoke-direct {v5, p1, p2}, Landroid/graphics/PorterDuffColorFilter;-><init>(ILandroid/graphics/PorterDuff$Mode;)V
...
.method private setBackground(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v5, p0, Landroidx/cardview/widget/RoundRectDrawable;->mBackground:Landroid/content/res/ColorStateList;
    ...
    iget-object v7, p0, Landroidx/cardview/widget/RoundRectDrawable;->mBackground:Landroid/content/res/ColorStateList;
...
.method private updateBounds(Landroid/graphics/Rect;)V
    ...
    iget-object v5, p0, Landroidx/cardview/widget/RoundRectDrawable;->mBoundsI:Landroid/graphics/Rect;
    ...
    iget v5, p0, Landroidx/cardview/widget/RoundRectDrawable;->mRadius:F

    iget-boolean v6, p0, Landroidx/cardview/widget/RoundRectDrawable;->mInsetForRadius:Z

    invoke-static {p1, v5, v6}, Landroidx/cardview/widget/RoundRectDrawableWithShadow;->calculateVerticalPadding(FFZ)F

    move-result p1

    iget v5, p0, Landroidx/cardview/widget/RoundRectDrawable;->mPadding:F

    iget v6, p0, Landroidx/cardview/widget/RoundRectDrawable;->mRadius:F

    iget-boolean v7, p0, Landroidx/cardview/widget/RoundRectDrawable;->mInsetForRadius:Z

    invoke-static {v5, v6, v7}, Landroidx/cardview/widget/RoundRectDrawableWithShadow;->calculateHorizontalPadding(FFZ)F
    ...
    invoke-virtual {v6, v5, p1}, Landroid/graphics/Rect;->inset(II)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v5, p0, Landroidx/cardview/widget/RoundRectDrawable;->mPaint:Landroid/graphics/Paint;

    iget-object v6, p0, Landroidx/cardview/widget/RoundRectDrawable;->mTintFilter:Landroid/graphics/PorterDuffColorFilter;
    ...
    :goto_0
    iget-object v7, p0, Landroidx/cardview/widget/RoundRectDrawable;->mBoundsF:Landroid/graphics/RectF;

    iget v8, p0, Landroidx/cardview/widget/RoundRectDrawable;->mRadius:F
    ...
    invoke-virtual {p1, v7, v8, v8, v5}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public getOutline(Landroid/graphics/Outline;)V
    ...
    const-string v0, "Landroid/graphics/Outline;"

    const-string v1, "setRoundRect"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p1, v5, v6}, Landroid/graphics/Outline;->setRoundRect(Landroid/graphics/Rect;F)V
...
.method public isStateful()Z
    ...
    iget-object v5, p0, Landroidx/cardview/widget/RoundRectDrawable;->mTint:Landroid/content/res/ColorStateList;
...
.method protected onStateChange([I)Z
    ...
    iget-object v7, p0, Landroidx/cardview/widget/RoundRectDrawable;->mPaint:Landroid/graphics/Paint;
    ...
    iget-object v7, p0, Landroidx/cardview/widget/RoundRectDrawable;->mTintMode:Landroid/graphics/PorterDuff$Mode;

    if-eqz v7, :cond_2

    invoke-direct {p0, p1, v7}, Landroidx/cardview/widget/RoundRectDrawable;->createTintFilter(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method setPadding(FZZ)V
    ...
    iget-boolean v5, p0, Landroidx/cardview/widget/RoundRectDrawable;->mInsetForPadding:Z

    if-ne v5, p2, :cond_0

    iget-boolean v5, p0, Landroidx/cardview/widget/RoundRectDrawable;->mInsetForRadius:Z
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v5, p0, Landroidx/cardview/widget/RoundRectDrawable;->mTintMode:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {p0, p1, v5}, Landroidx/cardview/widget/RoundRectDrawable;->createTintFilter(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;

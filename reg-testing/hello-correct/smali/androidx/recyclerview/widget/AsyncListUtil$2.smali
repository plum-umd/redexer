...
.method private acquireTile()Landroidx/recyclerview/widget/TileList$Tile;
    ...
    const-string v0, "Landroidx/recyclerview/widget/AsyncListUtil$2;"

    const-string v1, "acquireTile"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->mRecycledRoot:Landroidx/recyclerview/widget/TileList$Tile;

    if-eqz v5, :cond_0

    iget-object v6, v5, Landroidx/recyclerview/widget/TileList$Tile;->mNext:Landroidx/recyclerview/widget/TileList$Tile;

    iput-object v6, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->mRecycledRoot:Landroidx/recyclerview/widget/TileList$Tile;
    ...
    :cond_0
    new-instance v5, Landroidx/recyclerview/widget/TileList$Tile;

    iget-object v6, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->this$0:Landroidx/recyclerview/widget/AsyncListUtil;

    iget-object v6, v6, Landroidx/recyclerview/widget/AsyncListUtil;->mTClass:Ljava/lang/Class;

    iget-object v7, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->this$0:Landroidx/recyclerview/widget/AsyncListUtil;

    iget v7, v7, Landroidx/recyclerview/widget/AsyncListUtil;->mTileSize:I

    invoke-direct {v5, v6, v7}, Landroidx/recyclerview/widget/TileList$Tile;-><init>(Ljava/lang/Class;I)V
...
.method private addTile(Landroidx/recyclerview/widget/TileList$Tile;)V
    ...
    iget v6, p1, Landroidx/recyclerview/widget/TileList$Tile;->mStartPosition:I
    ...
    iget-object v5, v5, Landroidx/recyclerview/widget/AsyncListUtil;->mMainThreadProxy:Landroidx/recyclerview/widget/ThreadUtil$MainThreadCallback;

    iget v6, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->mGeneration:I
    ...
    invoke-interface {v5, v6, p1}, Landroidx/recyclerview/widget/ThreadUtil$MainThreadCallback;->addTile(ILandroidx/recyclerview/widget/TileList$Tile;)V
...
.method private flushTileCache(I)V
    ...
    const-string v1, "flushTileCache"
    ...
    iget-object v7, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->mLoadedTiles:Landroid/util/SparseBooleanArray;
    ...
    iget v8, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->mFirstRequiredTileStart:I

    sub-int/2addr v8, v6

    iget v10, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->mLastRequiredTileStart:I
    ...
    :cond_2
    invoke-direct {p0, v7}, Landroidx/recyclerview/widget/AsyncListUtil$2;->removeTile(I)V
...
.method private removeTile(I)V
    ...
    invoke-interface {v5, v6, p1}, Landroidx/recyclerview/widget/ThreadUtil$MainThreadCallback;->removeTile(II)V
...
.method private requestTiles(IIIZ)V
    ...
    invoke-interface {v7, v6, p3}, Landroidx/recyclerview/widget/ThreadUtil$BackgroundCallback;->loadTile(II)V
    ...
    iget v6, v6, Landroidx/recyclerview/widget/AsyncListUtil;->mTileSize:I
...
.method public loadTile(II)V
    ...
    iput p1, v5, Landroidx/recyclerview/widget/TileList$Tile;->mStartPosition:I
    ...
    iget v6, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->mItemCount:I

    iget v7, v5, Landroidx/recyclerview/widget/TileList$Tile;->mStartPosition:I
    ...
    iput p1, v5, Landroidx/recyclerview/widget/TileList$Tile;->mItemCount:I
    ...
    iget-object v6, v5, Landroidx/recyclerview/widget/TileList$Tile;->mItems:[Ljava/lang/Object;

    iget v7, v5, Landroidx/recyclerview/widget/TileList$Tile;->mStartPosition:I

    iget v8, v5, Landroidx/recyclerview/widget/TileList$Tile;->mItemCount:I
    ...
    invoke-virtual {p1, v6, v7, v8}, Landroidx/recyclerview/widget/AsyncListUtil$DataCallback;->fillData([Ljava/lang/Object;II)V
...
.method public recycleTile(Landroidx/recyclerview/widget/TileList$Tile;)V
    ...
    iget-object v6, p1, Landroidx/recyclerview/widget/TileList$Tile;->mItems:[Ljava/lang/Object;

    iget v7, p1, Landroidx/recyclerview/widget/TileList$Tile;->mItemCount:I

    invoke-virtual {v5, v6, v7}, Landroidx/recyclerview/widget/AsyncListUtil$DataCallback;->recycleData([Ljava/lang/Object;I)V

    iget-object v5, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->mRecycledRoot:Landroidx/recyclerview/widget/TileList$Tile;

    iput-object v5, p1, Landroidx/recyclerview/widget/TileList$Tile;->mNext:Landroidx/recyclerview/widget/TileList$Tile;
...
.method public refresh(I)V
    ...
    iget v5, p0, Landroidx/recyclerview/widget/AsyncListUtil$2;->mGeneration:I
    ...
    invoke-interface {p1, v5, v6}, Landroidx/recyclerview/widget/ThreadUtil$MainThreadCallback;->updateItemCount(II)V

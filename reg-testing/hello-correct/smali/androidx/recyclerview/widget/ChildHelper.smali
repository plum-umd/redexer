...
.method private getOffset(I)I
    ...
    const-string v0, "Landroidx/recyclerview/widget/ChildHelper;"

    const-string v1, "getOffset"
    ...
    :cond_0
    iget-object v6, p0, Landroidx/recyclerview/widget/ChildHelper;->mCallback:Landroidx/recyclerview/widget/ChildHelper$Callback;
    ...
    iget-object v8, p0, Landroidx/recyclerview/widget/ChildHelper;->mBucket:Landroidx/recyclerview/widget/ChildHelper$Bucket;

    invoke-virtual {v8, v7}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->countOnesBefore(I)I
    ...
    invoke-virtual {p1, v7}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->get(I)Z
...
.method private hideViewInternal(Landroid/view/View;)V
    ...
    const-string v1, "hideViewInternal"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/recyclerview/widget/ChildHelper;->mHiddenViews:Ljava/util/List;
    ...
    iget-object v5, p0, Landroidx/recyclerview/widget/ChildHelper;->mCallback:Landroidx/recyclerview/widget/ChildHelper$Callback;
    ...
    invoke-interface {v5, p1}, Landroidx/recyclerview/widget/ChildHelper$Callback;->onEnteredHiddenState(Landroid/view/View;)V
...
.method private unhideViewInternal(Landroid/view/View;)Z
    ...
    const-string v1, "unhideViewInternal"
    ...
    invoke-interface {v5, p1}, Landroidx/recyclerview/widget/ChildHelper$Callback;->onLeftHiddenState(Landroid/view/View;)V
...
.method addView(Landroid/view/View;IZ)V
    ...
    :goto_0
    iget-object v5, p0, Landroidx/recyclerview/widget/ChildHelper;->mBucket:Landroidx/recyclerview/widget/ChildHelper$Bucket;

    invoke-virtual {v5, p2, p3}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->insert(IZ)V
...
.method addView(Landroid/view/View;Z)V
    ...
    invoke-virtual {p0, p1, v5, p2}, Landroidx/recyclerview/widget/ChildHelper;->addView(Landroid/view/View;IZ)V
...
.method attachViewToParent(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    ...
    const-string v1, "attachViewToParent"
    ...
    invoke-virtual {v5, p2, p4}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->insert(IZ)V
...
.method detachViewFromParent(I)V
    ...
    const-string v1, "detachViewFromParent"
    ...
    invoke-virtual {v5, p1}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->remove(I)Z
    ...
    invoke-interface {v5, p1}, Landroidx/recyclerview/widget/ChildHelper$Callback;->detachViewFromParent(I)V
...
.method findHiddenNonRemovedView(I)Landroid/view/View;
    ...
    const-string v1, "findHiddenNonRemovedView"
    ...
    iget-object v7, p0, Landroidx/recyclerview/widget/ChildHelper;->mHiddenViews:Ljava/util/List;
    ...
    iget-object v8, p0, Landroidx/recyclerview/widget/ChildHelper;->mCallback:Landroidx/recyclerview/widget/ChildHelper$Callback;
    ...
    const-string v1, "getChildViewHolder"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-interface {v8, v7}, Landroidx/recyclerview/widget/ChildHelper$Callback;->getChildViewHolder(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
...
.method getChildAt(I)Landroid/view/View;
    ...
    invoke-interface {v5, p1}, Landroidx/recyclerview/widget/ChildHelper$Callback;->getChildAt(I)Landroid/view/View;
...
.method getChildCount()I
    ...
    iget-object v6, p0, Landroidx/recyclerview/widget/ChildHelper;->mHiddenViews:Ljava/util/List;
...
.method getUnfilteredChildAt(I)Landroid/view/View;
    ...
    const-string v1, "getUnfilteredChildAt"
...
.method getUnfilteredChildCount()I
    ...
    const-string v1, "getUnfilteredChildCount"
...
.method hide(Landroid/view/View;)V
    ...
    invoke-interface {v5, p1}, Landroidx/recyclerview/widget/ChildHelper$Callback;->indexOfChild(Landroid/view/View;)I
    ...
    iget-object v6, p0, Landroidx/recyclerview/widget/ChildHelper;->mBucket:Landroidx/recyclerview/widget/ChildHelper$Bucket;

    invoke-virtual {v6, v5}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->set(I)V
...
.method removeAllViewsUnfiltered()V
    ...
    const-string v1, "removeAllViewsUnfiltered"
    ...
    invoke-interface {v6, v7}, Landroidx/recyclerview/widget/ChildHelper$Callback;->onLeftHiddenState(Landroid/view/View;)V
    ...
    invoke-interface {v5}, Landroidx/recyclerview/widget/ChildHelper$Callback;->removeAllViews()V
...
.method removeView(Landroid/view/View;)V
    ...
    invoke-interface {p1, v5}, Landroidx/recyclerview/widget/ChildHelper$Callback;->removeViewAt(I)V
...
.method removeViewAt(I)V
    ...
    invoke-virtual {v6, p1}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->remove(I)Z

    move-result v6

    if-eqz v6, :cond_1

    invoke-direct {p0, v5}, Landroidx/recyclerview/widget/ChildHelper;->unhideViewInternal(Landroid/view/View;)Z
    ...
    invoke-interface {v5, p1}, Landroidx/recyclerview/widget/ChildHelper$Callback;->removeViewAt(I)V
...
.method removeViewIfHidden(Landroid/view/View;)Z
    ...
    const-string v1, "removeViewIfHidden"
    ...
    :cond_0
    iget-object v7, p0, Landroidx/recyclerview/widget/ChildHelper;->mBucket:Landroidx/recyclerview/widget/ChildHelper$Bucket;

    invoke-virtual {v7, v5}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->get(I)Z
    ...
    invoke-virtual {v7, v5}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->remove(I)Z
...
.method unhide(Landroid/view/View;)V
    ...
    invoke-virtual {v6, v5}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->clear(I)V
    ...
    const-string v7, "trying to unhide a view that was not hidden"

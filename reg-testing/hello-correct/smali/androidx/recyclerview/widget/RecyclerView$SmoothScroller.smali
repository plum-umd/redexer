...
.method public computeScrollVectorForPosition(I)Landroid/graphics/PointF;
    ...
    instance-of v6, v5, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$ScrollVectorProvider;
    ...
    invoke-interface {v5, p1}, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$ScrollVectorProvider;->computeScrollVectorForPosition(I)Landroid/graphics/PointF;
...
.method public findViewByPosition(I)Landroid/view/View;
    ...
    invoke-virtual {v5, p1}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->findViewByPosition(I)Landroid/view/View;
...
.method public getTargetPosition()I
    ...
    const-string v1, "getTargetPosition"
...
.method public instantScrollToPosition(I)V
    ...
    const-string v1, "instantScrollToPosition"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mRecyclerView:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v5, p1}, Landroidx/recyclerview/widget/RecyclerView;->scrollToPosition(I)V
...
.method public isPendingInitialRun()Z
    ...
    const-string v1, "isPendingInitialRun"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v5, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mPendingInitialRun:Z
...
.method public isRunning()Z
    ...
    iget-boolean v5, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mRunning:Z
...
.method onAnimation(II)V
    ...
    iget-boolean v6, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mRunning:Z
    ...
    :cond_1
    iget-boolean v6, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mPendingInitialRun:Z

    const/4 v7, 0x0

    if-eqz v6, :cond_3

    iget-object v6, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mTargetView:Landroid/view/View;

    if-nez v6, :cond_3

    iget-object v6, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mLayoutManager:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;

    if-eqz v6, :cond_3

    iget v6, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mTargetPosition:I

    invoke-virtual {p0, v6}, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->computeScrollVectorForPosition(I)Landroid/graphics/PointF;
    ...
    invoke-virtual {v5, v8, v6, v7}, Landroidx/recyclerview/widget/RecyclerView;->scrollStep(II[I)V
    ...
    invoke-virtual {p0, v6}, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->getChildPosition(Landroid/view/View;)I

    move-result v6

    iget v8, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mTargetPosition:I
    ...
    iget-object v8, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mRecyclingAction:Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;
    ...
    const-string v1, "onTargetFound"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0, v6, v7, v8}, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->onTargetFound(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$State;Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;)V
    ...
    invoke-virtual {v6, v5}, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;->runIfNecessary(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object v7, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mTargetView:Landroid/view/View;
    ...
    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView;->mState:Landroidx/recyclerview/widget/RecyclerView$State;

    iget-object v7, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mRecyclingAction:Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;
    ...
    const-string v1, "onSeekTargetStep"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0, p1, p2, v6, v7}, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->onSeekTargetStep(IILandroidx/recyclerview/widget/RecyclerView$State;Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;)V
    ...
    invoke-virtual {p2, v5}, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller$Action;->runIfNecessary(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iget-object p1, v5, Landroidx/recyclerview/widget/RecyclerView;->mViewFlinger:Landroidx/recyclerview/widget/RecyclerView$ViewFlinger;
...
.method protected onChildAttachedToWindow(Landroid/view/View;)V
    ...
    const-string v1, "onChildAttachedToWindow"
...
.method start(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)V
    ...
    iget-boolean v5, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mStarted:Z
    ...
    const-string v6, "An instance of "
    ...
    const-string v6, "more than once. Each instance of"
    ...
    const-string v6, "is intended to only be used once. You should create a new instance for "
...
.method protected final stop()V
    ...
    iput-boolean v5, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mRunning:Z
    ...
    iput v7, v6, Landroidx/recyclerview/widget/RecyclerView$State;->mTargetPosition:I

    const/4 v6, 0x0

    iput-object v6, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mTargetView:Landroid/view/View;

    iput v7, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mTargetPosition:I

    iput-boolean v5, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mPendingInitialRun:Z

    iget-object v5, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mLayoutManager:Landroidx/recyclerview/widget/RecyclerView$LayoutManager;

    invoke-virtual {v5, p0}, Landroidx/recyclerview/widget/RecyclerView$LayoutManager;->onSmoothScrollerStopped(Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;)V
    ...
    iput-object v6, p0, Landroidx/recyclerview/widget/RecyclerView$SmoothScroller;->mRecyclerView:Landroidx/recyclerview/widget/RecyclerView;

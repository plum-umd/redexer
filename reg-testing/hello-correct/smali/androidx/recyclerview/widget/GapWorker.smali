...
.method private buildTaskList()V
    ...
    const-string v0, "Landroidx/recyclerview/widget/GapWorker;"

    const-string v1, "buildTaskList"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    move-object/from16 v0, p0

    iget-object v5, v0, Landroidx/recyclerview/widget/GapWorker;->mRecyclerViews:Ljava/util/ArrayList;
    ...
    iget-object v9, v0, Landroidx/recyclerview/widget/GapWorker;->mRecyclerViews:Ljava/util/ArrayList;
    ...
    iget-object v10, v9, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/recyclerview/widget/GapWorker$LayoutPrefetchRegistryImpl;

    invoke-virtual {v10, v9, v6}, Landroidx/recyclerview/widget/GapWorker$LayoutPrefetchRegistryImpl;->collectPrefetchPositionsFromView(Landroidx/recyclerview/widget/RecyclerView;Z)V
    ...
    iget-object v7, v0, Landroidx/recyclerview/widget/GapWorker;->mTasks:Ljava/util/ArrayList;
    ...
    iget v11, v10, Landroidx/recyclerview/widget/GapWorker$LayoutPrefetchRegistryImpl;->mPrefetchDx:I
    ...
    iget v12, v10, Landroidx/recyclerview/widget/GapWorker$LayoutPrefetchRegistryImpl;->mPrefetchDy:I
    ...
    :goto_2
    iget v13, v10, Landroidx/recyclerview/widget/GapWorker$LayoutPrefetchRegistryImpl;->mCount:I
    ...
    iget-object v13, v0, Landroidx/recyclerview/widget/GapWorker;->mTasks:Ljava/util/ArrayList;
    ...
    invoke-direct {v13}, Landroidx/recyclerview/widget/GapWorker$Task;-><init>()V

    move-object/from16 v0, p0

    iget-object v14, v0, Landroidx/recyclerview/widget/GapWorker;->mTasks:Ljava/util/ArrayList;
    ...
    :goto_3
    iget-object v14, v10, Landroidx/recyclerview/widget/GapWorker$LayoutPrefetchRegistryImpl;->mPrefetchArray:[I
    ...
    :goto_4
    iput-boolean v15, v13, Landroidx/recyclerview/widget/GapWorker$Task;->immediate:Z

    iput v11, v13, Landroidx/recyclerview/widget/GapWorker$Task;->viewVelocity:I

    iput v14, v13, Landroidx/recyclerview/widget/GapWorker$Task;->distanceToItem:I
    ...
    iput v14, v13, Landroidx/recyclerview/widget/GapWorker$Task;->position:I
    ...
    iget-object v5, v0, Landroidx/recyclerview/widget/GapWorker;->mTasks:Ljava/util/ArrayList;

    sget-object v6, Landroidx/recyclerview/widget/GapWorker;->sTaskComparator:Ljava/util/Comparator;
...
.method private flushTaskWithDeadline(Landroidx/recyclerview/widget/GapWorker$Task;J)V
    ...
    const-string v1, "flushTaskWithDeadline"
    ...
    :goto_0
    iget-object v7, p1, Landroidx/recyclerview/widget/GapWorker$Task;->view:Landroidx/recyclerview/widget/RecyclerView;

    iget p1, p1, Landroidx/recyclerview/widget/GapWorker$Task;->position:I

    invoke-direct {p0, v7, p1, v5, v6}, Landroidx/recyclerview/widget/GapWorker;->prefetchPositionWithDeadline(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;

    move-result-object p1

    if-eqz p1, :cond_1

    iget-object v5, p1, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
...
.method private flushTasksWithDeadline(J)V
    ...
    const-string v1, "flushTasksWithDeadline"
    ...
    :goto_0
    iget-object v6, p0, Landroidx/recyclerview/widget/GapWorker;->mTasks:Ljava/util/ArrayList;
    ...
    iget-object v7, v6, Landroidx/recyclerview/widget/GapWorker$Task;->view:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_0
    invoke-direct {p0, v6, p1, p2}, Landroidx/recyclerview/widget/GapWorker;->flushTaskWithDeadline(Landroidx/recyclerview/widget/GapWorker$Task;J)V
...
.method static isPrefetchPositionAttached(Landroidx/recyclerview/widget/RecyclerView;I)Z
    ...
    const-string v1, "isPrefetchPositionAttached"
...
.method private prefetchInnerRecyclerViewWithDeadline(Landroidx/recyclerview/widget/RecyclerView;J)V
    ...
    const-string v1, "prefetchInnerRecyclerViewWithDeadline"
    ...
    :cond_0
    iget-boolean v5, p1, Landroidx/recyclerview/widget/RecyclerView;->mDataSetHasChangedAfterLayout:Z
    ...
    :cond_1
    iget-object v5, p1, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/recyclerview/widget/GapWorker$LayoutPrefetchRegistryImpl;

    const/4 v6, 0x1

    invoke-virtual {v5, p1, v6}, Landroidx/recyclerview/widget/GapWorker$LayoutPrefetchRegistryImpl;->collectPrefetchPositionsFromView(Landroidx/recyclerview/widget/RecyclerView;Z)V
    ...
    iget-object v6, p1, Landroidx/recyclerview/widget/RecyclerView;->mState:Landroidx/recyclerview/widget/RecyclerView$State;

    iget-object v7, p1, Landroidx/recyclerview/widget/RecyclerView;->mAdapter:Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    invoke-direct {p0, p1, v7, p2, p3}, Landroidx/recyclerview/widget/GapWorker;->prefetchPositionWithDeadline(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    :try_end_0
...
.method private prefetchPositionWithDeadline(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    const-string v1, "prefetchPositionWithDeadline"
    ...
    :cond_0
    iget-object v5, p1, Landroidx/recyclerview/widget/RecyclerView;->mRecycler:Landroidx/recyclerview/widget/RecyclerView$Recycler;
    ...
    invoke-virtual {v5, p2, v6, p3, p4}, Landroidx/recyclerview/widget/RecyclerView$Recycler;->tryGetViewHolderForPositionByDeadline(IZJ)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    invoke-virtual {v5, p3}, Landroidx/recyclerview/widget/RecyclerView$Recycler;->recycleView(Landroid/view/View;)V

    goto :goto_0

    :cond_1
    invoke-virtual {v5, p2, v6}, Landroidx/recyclerview/widget/RecyclerView$Recycler;->addViewHolderToRecycledViewPool(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_2
    :goto_0
    invoke-virtual {p1, v6}, Landroidx/recyclerview/widget/RecyclerView;->onExitLayoutOrScroll(Z)V
...
.method postFromTraversal(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-wide v5, p0, Landroidx/recyclerview/widget/GapWorker;->mPostTimeNs:J
...
.method public run()V
    ...
    iget-object v11, p0, Landroidx/recyclerview/widget/GapWorker;->mRecyclerViews:Ljava/util/ArrayList;
    :try_end_4
    ...
    const-string v1, "getDrawingTime"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    :try_start_9
    invoke-virtual {v11}, Landroidx/recyclerview/widget/RecyclerView;->getDrawingTime()J
    ...
    :try_start_d
    iget-wide v9, p0, Landroidx/recyclerview/widget/GapWorker;->mFrameIntervalNs:J

    add-long/2addr v7, v9

    invoke-virtual {p0, v7, v8}, Landroidx/recyclerview/widget/GapWorker;->prefetch(J)V
    :try_end_d

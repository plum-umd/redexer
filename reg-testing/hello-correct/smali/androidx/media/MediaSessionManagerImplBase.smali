...
.method private isPermissionGranted(Landroidx/media/MediaSessionManager$RemoteUserInfoImpl;Ljava/lang/String;)Z
    ...
    const-string v0, "Landroidx/media/MediaSessionManagerImplBase;"
    ...
    iget-object v5, p0, Landroidx/media/MediaSessionManagerImplBase;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v5, p2, p1}, Landroid/content/pm/PackageManager;->checkPermission(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v5, p2, v8, p1}, Landroid/content/Context;->checkPermission(Ljava/lang/String;II)I
...
.method isEnabledNotificationListener(Landroidx/media/MediaSessionManager$RemoteUserInfoImpl;)Z
    ...
    const-string v1, "isEnabledNotificationListener"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/media/MediaSessionManagerImplBase;->mContentResolver:Landroid/content/ContentResolver;
    ...
    const-string v0, "Landroid/provider/Settings$Secure;"
    ...
    const-string v1, "unflattenFromString"
...
.method public isTrustedForMediaControl(Landroidx/media/MediaSessionManager$RemoteUserInfoImpl;)Z
    ...
    const-string v1, "isTrustedForMediaControl"
    ...
    :try_start_0
    iget-object v7, p0, Landroidx/media/MediaSessionManagerImplBase;->mContext:Landroid/content/Context;
    :try_end_0
    ...
    sget-boolean v7, Landroidx/media/MediaSessionManagerImplBase;->DEBUG:Z
    ...
    invoke-direct {p0, p1, v5}, Landroidx/media/MediaSessionManagerImplBase;->isPermissionGranted(Landroidx/media/MediaSessionManager$RemoteUserInfoImpl;Ljava/lang/String;)Z

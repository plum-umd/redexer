...
.method private generateMediaActionButton(Landroidx/core/app/NotificationCompat$Action;)Landroid/widget/RemoteViews;
    ...
    const-string v1, "generateMediaActionButton"
    ...
    iget-object v7, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mBuilder:Landroidx/core/app/NotificationCompat$Builder;

    iget-object v7, v7, Landroidx/core/app/NotificationCompat$Builder;->mContext:Landroid/content/Context;
    ...
    sget v8, Landroidx/media/R$layout;->notification_media_action:I

    invoke-direct {v6, v7, v8}, Landroid/widget/RemoteViews;-><init>(Ljava/lang/String;I)V

    sget v7, Landroidx/media/R$id;->action0:I
    ...
    sget v5, Landroidx/media/R$id;->action0:I
    ...
    invoke-virtual {v6, v5, p1}, Landroid/widget/RemoteViews;->setContentDescription(ILjava/lang/CharSequence;)V
...
.method public static getMediaSession(Landroid/app/Notification;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    const-string v1, "getMediaSession"
    ...
    :cond_0
    invoke-static {p0, v7}, Landroidx/core/app/BundleCompat;->getBinder(Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    const-string v1, "setDataPosition"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v5, p0}, Landroid/os/Parcel;->setDataPosition(I)V
    ...
    const-string v0, "Landroid/os/Parcelable$Creator;"
...
.method public apply(Landroidx/core/app/NotificationBuilderWithBuilderAccessor;)V
    ...
    invoke-virtual {p0, v5}, Landroidx/media/app/NotificationCompat$MediaStyle;->fillInMediaStyle(Landroid/app/Notification$MediaStyle;)Landroid/app/Notification$MediaStyle;
    ...
    :cond_0
    iget-boolean v5, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mShowCancelButton:Z
...
.method fillInMediaStyle(Landroid/app/Notification$MediaStyle;)Landroid/app/Notification$MediaStyle;
    ...
    iget-object v5, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mActionsToShowInCompact:[I
    ...
    const-string v0, "Landroid/app/Notification$MediaStyle;"

    const-string v1, "setShowActionsInCompactView"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p1, v5}, Landroid/app/Notification$MediaStyle;->setShowActionsInCompactView([I)Landroid/app/Notification$MediaStyle;
    ...
    :cond_0
    iget-object v5, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mToken:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-virtual {p1, v5}, Landroid/app/Notification$MediaStyle;->setMediaSession(Landroid/media/session/MediaSession$Token;)Landroid/app/Notification$MediaStyle;
...
.method generateBigContentView()Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p0, v7, v6, v7}, Landroidx/media/app/NotificationCompat$MediaStyle;->applyStandardTemplate(ZIZ)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v6, v8}, Landroid/widget/RemoteViews;->removeAllViews(I)V
    ...
    iget-object v9, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mBuilder:Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-direct {p0, v9}, Landroidx/media/app/NotificationCompat$MediaStyle;->generateMediaActionButton(Landroidx/core/app/NotificationCompat$Action;)Landroid/widget/RemoteViews;

    move-result-object v9

    sget v10, Landroidx/media/R$id;->media_actions:I
    ...
    invoke-virtual {v6, v10, v9}, Landroid/widget/RemoteViews;->addView(ILandroid/widget/RemoteViews;)V
    ...
    sget v5, Landroidx/media/R$id;->cancel_action:I
    ...
    sget v8, Landroidx/media/R$integer;->cancel_button_image_alpha:I
    ...
    invoke-virtual {v6, v5, v8, v7}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V
    ...
    iget-object v7, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mCancelButtonIntent:Landroid/app/PendingIntent;
...
.method generateContentView()Landroid/widget/RemoteViews;
    ...
    invoke-virtual {p0, v7, v5, v6}, Landroidx/media/app/NotificationCompat$MediaStyle;->applyStandardTemplate(ZIZ)Landroid/widget/RemoteViews;
    ...
    iget-object v8, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mBuilder:Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v5, v10}, Landroid/widget/RemoteViews;->removeAllViews(I)V
    ...
    iget-object v11, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mBuilder:Landroidx/core/app/NotificationCompat$Builder;

    iget-object v11, v11, Landroidx/core/app/NotificationCompat$Builder;->mActions:Ljava/util/ArrayList;

    iget-object v12, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mActionsToShowInCompact:[I
    ...
    invoke-direct {p0, v11}, Landroidx/media/app/NotificationCompat$MediaStyle;->generateMediaActionButton(Landroidx/core/app/NotificationCompat$Action;)Landroid/widget/RemoteViews;

    move-result-object v11

    sget v12, Landroidx/media/R$id;->media_actions:I
    ...
    invoke-virtual {v5, v12, v11}, Landroid/widget/RemoteViews;->addView(ILandroid/widget/RemoteViews;)V
    ...
    :cond_2
    iget-boolean v6, p0, Landroidx/media/app/NotificationCompat$MediaStyle;->mShowCancelButton:Z

    const/16 v8, 0x8

    if-eqz v6, :cond_3

    sget v6, Landroidx/media/R$id;->end_padder:I
    ...
    invoke-virtual {v5, v6, v8, v7}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V
...
.method getContentViewLayoutResource()I
    ...
    sget v5, Landroidx/media/R$layout;->notification_template_media:I
...
.method public setCancelButtonIntent(Landroid/app/PendingIntent;)Landroidx/media/app/NotificationCompat$MediaStyle;
    ...
    const-string v1, "setCancelButtonIntent"
...
.method public setShowCancelButton(Z)Landroidx/media/app/NotificationCompat$MediaStyle;
    ...
    const-string v1, "setShowCancelButton"

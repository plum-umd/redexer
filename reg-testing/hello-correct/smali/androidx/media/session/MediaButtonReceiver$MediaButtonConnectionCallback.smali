...
.method private finish()V
    ...
    const-string v0, "Landroidx/media/session/MediaButtonReceiver$MediaButtonConnectionCallback;"

    const-string v1, "finish"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/media/session/MediaButtonReceiver$MediaButtonConnectionCallback;->mMediaBrowser:Landroid/support/v4/media/MediaBrowserCompat;
    ...
    invoke-virtual {v5}, Landroid/support/v4/media/MediaBrowserCompat;->disconnect()V
    ...
    iget-object v5, p0, Landroidx/media/session/MediaButtonReceiver$MediaButtonConnectionCallback;->mPendingResult:Landroid/content/BroadcastReceiver$PendingResult;
    ...
    const-string v0, "Landroid/content/BroadcastReceiver$PendingResult;"
...
.method public onConnected()V
    ...
    iget-object v6, p0, Landroidx/media/session/MediaButtonReceiver$MediaButtonConnectionCallback;->mContext:Landroid/content/Context;

    iget-object v7, p0, Landroidx/media/session/MediaButtonReceiver$MediaButtonConnectionCallback;->mMediaBrowser:Landroid/support/v4/media/MediaBrowserCompat;
    :try_end_0
    ...
    :try_start_1
    invoke-virtual {v7}, Landroid/support/v4/media/MediaBrowserCompat;->getSessionToken()Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    iget-object v6, p0, Landroidx/media/session/MediaButtonReceiver$MediaButtonConnectionCallback;->mIntent:Landroid/content/Intent;
    ...
    :try_start_5
    invoke-virtual {v5, v6}, Landroid/support/v4/media/session/MediaControllerCompat;->dispatchMediaButtonEvent(Landroid/view/KeyEvent;)Z
    :try_end_5
    ...
    const-string v7, "Failed to create a media controller"
...
.method setMediaBrowser(Landroid/support/v4/media/MediaBrowserCompat;)V
    ...
    const-string v1, "setMediaBrowser"

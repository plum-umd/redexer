...
.method destroy(Z)Landroidx/loader/content/Loader;
    ...
    const-string v0, "Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;"
    ...
    :cond_0
    iget-object v5, p0, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroidx/loader/content/Loader;
    ...
    iget-object v5, p0, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->mObserver:Landroidx/loader/app/LoaderManagerImpl$LoaderObserver;

    if-eqz v5, :cond_1

    invoke-virtual {p0, v5}, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->removeObserver(Landroidx/lifecycle/Observer;)V

    if-eqz p1, :cond_1

    invoke-virtual {v5}, Landroidx/loader/app/LoaderManagerImpl$LoaderObserver;->reset()V

    :cond_1
    iget-object v6, p0, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroidx/loader/content/Loader;

    invoke-virtual {v6, p0}, Landroidx/loader/content/Loader;->unregisterListener(Landroidx/loader/content/Loader$OnLoadCompleteListener;)V

    if-eqz v5, :cond_2

    invoke-virtual {v5}, Landroidx/loader/app/LoaderManagerImpl$LoaderObserver;->hasDeliveredData()Z
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget v5, p0, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->mId:I
    ...
    iget-object v5, p0, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->mArgs:Landroid/os/Bundle;
    ...
    const-string v0, "Landroidx/lifecycle/MutableLiveData;"
...
.method isCallbackWaitingForData()Z
    ...
    const-string v1, "isCallbackWaitingForData"
...
.method markForRedelivery()V
    ...
    iget-object v5, p0, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->mLifecycleOwner:Landroidx/lifecycle/LifecycleOwner;

    iget-object v6, p0, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->mObserver:Landroidx/loader/app/LoaderManagerImpl$LoaderObserver;
    ...
    invoke-super {p0, v6}, Landroidx/lifecycle/MutableLiveData;->removeObserver(Landroidx/lifecycle/Observer;)V
    ...
    invoke-virtual {p0, v5, v6}, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->observe(Landroidx/lifecycle/LifecycleOwner;Landroidx/lifecycle/Observer;)V
...
.method protected onActive()V
    ...
    invoke-virtual {v5}, Landroidx/loader/content/Loader;->startLoading()V
...
.method protected onInactive()V
    ...
    invoke-virtual {v5}, Landroidx/loader/content/Loader;->stopLoading()V
...
.method public onLoadComplete(Landroidx/loader/content/Loader;Ljava/lang/Object;)V
    ...
    const-string v6, "onLoadComplete: "
...
.method setCallback(Landroidx/lifecycle/LifecycleOwner;Landroidx/loader/app/LoaderManager$LoaderCallbacks;)Landroidx/loader/content/Loader;
    ...
    new-instance v5, Landroidx/loader/app/LoaderManagerImpl$LoaderObserver;

    iget-object v6, p0, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->mLoader:Landroidx/loader/content/Loader;

    invoke-direct {v5, v6, p2}, Landroidx/loader/app/LoaderManagerImpl$LoaderObserver;-><init>(Landroidx/loader/content/Loader;Landroidx/loader/app/LoaderManager$LoaderCallbacks;)V
    ...
    invoke-virtual {p0, p1, v5}, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->observe(Landroidx/lifecycle/LifecycleOwner;Landroidx/lifecycle/Observer;)V
    ...
    iput-object v5, p0, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->mObserver:Landroidx/loader/app/LoaderManagerImpl$LoaderObserver;
...
.method public toString()Ljava/lang/String;
    ...
    iget v6, p0, Landroidx/loader/app/LoaderManagerImpl$LoaderInfo;->mId:I

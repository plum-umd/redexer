...
.method private animateOffsetToCorrectPosition(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    const-string v0, "Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;"

    const-string v1, "animateOffsetToCorrectPosition"
    ...
    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;
...
.method private animateOffsetToStartPosition(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    const-string v1, "animateOffsetToStartPosition"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mScale:Z
...
.method private createProgressView()V
    ...
    const-string v1, "createProgressView"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Landroidx/swiperefreshlayout/widget/CircleImageView;
    ...
    invoke-direct {v5, v6, v7}, Landroidx/swiperefreshlayout/widget/CircleImageView;-><init>(Landroid/content/Context;I)V

    iput-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCircleView:Landroidx/swiperefreshlayout/widget/CircleImageView;

    new-instance v5, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;
    ...
    invoke-direct {v5, v6}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mProgress:Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;
    ...
    invoke-virtual {v5, v6}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->setStyle(I)V
    ...
    iget-object v6, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mProgress:Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;
    ...
    invoke-virtual {v5, v6}, Landroidx/swiperefreshlayout/widget/CircleImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v5, v6}, Landroidx/swiperefreshlayout/widget/CircleImageView;->setVisibility(I)V
    ...
    invoke-virtual {p0, v5}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->addView(Landroid/view/View;)V
...
.method private ensureTarget()V
    ...
    const-string v1, "ensureTarget"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mTarget:Landroid/view/View;
    ...
    invoke-virtual {p0, v5}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->getChildAt(I)Landroid/view/View;
    ...
    iput-object v6, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mTarget:Landroid/view/View;
...
.method private finishSpinner(F)V
    ...
    invoke-virtual {v5, v6, v6}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->setStartEndTrim(FF)V
    ...
    new-instance v5, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$5;

    invoke-direct {v5, p0}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$5;-><init>(Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;)V

    :cond_1
    iget v6, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCurrentTargetOffsetTop:I

    invoke-direct {p0, v6, v5}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->animateOffsetToStartPosition(ILandroid/view/animation/Animation$AnimationListener;)V

    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mProgress:Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;

    invoke-virtual {v5, p1}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->setArrowEnabled(Z)V
...
.method private moveSpinner(F)V
    ...
    iget-object v5, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mProgress:Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;

    const/4 v6, 0x1

    invoke-virtual {v5, v6}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->setArrowEnabled(Z)V

    move-object/from16 v0, p0

    iget v5, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mTotalDragDistance:F
    ...
    iget v9, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mTotalDragDistance:F

    sub-float/2addr v8, v9

    move-object/from16 v0, p0

    iget v9, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCustomSlingshotDistance:I
    ...
    iget-boolean v9, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mUsingCustomStart:Z

    if-eqz v9, :cond_1

    move-object/from16 v0, p0

    iget v9, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mSpinnerOffsetEnd:I

    move-object/from16 v0, p0

    iget v10, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mOriginalOffsetTop:I
    ...
    invoke-static/range {v14 .. v15}, Ljava/lang/Double;->valueOf(D)Ljava/lang/Double;
    ...
    iget-object v5, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCircleView:Landroidx/swiperefreshlayout/widget/CircleImageView;
    ...
    invoke-virtual {v5}, Landroidx/swiperefreshlayout/widget/CircleImageView;->getVisibility()I
    ...
    invoke-virtual {v5, v9}, Landroidx/swiperefreshlayout/widget/CircleImageView;->setVisibility(I)V
    ...
    iget-boolean v5, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mScale:Z
    ...
    invoke-virtual {v5, v6}, Landroidx/swiperefreshlayout/widget/CircleImageView;->setScaleX(F)V
    ...
    invoke-virtual {v5, v6}, Landroidx/swiperefreshlayout/widget/CircleImageView;->setScaleY(F)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->setAnimationProgress(F)V
    ...
    iget-object v2, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mProgress:Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;

    move-object/from16 p1, v2

    move-object/from16 v0, p1

    invoke-virtual/range {v0 .. v0}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->getAlpha()I
    ...
    iget-object v2, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mAlphaStartAnimation:Landroid/view/animation/Animation;
    ...
    invoke-direct/range {v0 .. v1}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->isAnimationRunning(Landroid/view/animation/Animation;)Z
    ...
    invoke-direct/range {v0 .. v0}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->startProgressAlphaStartAnimation()V
    ...
    iget-object v2, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mAlphaMaxAnimation:Landroid/view/animation/Animation;
    ...
    invoke-direct/range {v0 .. v0}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->startProgressAlphaMaxAnimation()V
    ...
    invoke-virtual/range {v0 .. v2}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->setStartEndTrim(FF)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->setArrowScale(F)V
    ...
    invoke-virtual/range {v0 .. v1}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->setProgressRotation(F)V

    move-object/from16 v0, p0

    iget v2, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCurrentTargetOffsetTop:I
    ...
    invoke-virtual/range {v0 .. v1}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->setTargetOffsetTopAndBottom(I)V
...
.method private onSecondaryPointerUp(Landroid/view/MotionEvent;)V
    ...
    iget v7, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mActivePointerId:I
...
.method private setColorViewAlpha(I)V
    ...
    const-string v1, "setColorViewAlpha"
    ...
    invoke-virtual {v5}, Landroidx/swiperefreshlayout/widget/CircleImageView;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, p1}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->setAlpha(I)V
...
.method private startAlphaAnimation(II)Landroid/view/animation/Animation;
    ...
    invoke-direct {v5, p0, p1, p2}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$4;-><init>(Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;II)V
    ...
    invoke-virtual {v5, p1, p2}, Landroid/view/animation/Animation;->setDuration(J)V
    ...
    invoke-virtual {p1, v5}, Landroidx/swiperefreshlayout/widget/CircleImageView;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private startDragging(F)V
    ...
    const-string v1, "startDragging"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mInitialDownY:F

    sub-float/2addr p1, v5

    iget v6, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mTouchSlop:I
    ...
    iput v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mInitialMotionY:F
    ...
    invoke-virtual {p1, v5}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->setAlpha(I)V
...
.method private startProgressAlphaMaxAnimation()V
    ...
    const-string v1, "startProgressAlphaMaxAnimation"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mProgress:Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;

    invoke-virtual {v5}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->getAlpha()I

    move-result v5

    const/16 v6, 0xff

    invoke-direct {p0, v5, v6}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->startAlphaAnimation(II)Landroid/view/animation/Animation;

    move-result-object v5

    iput-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mAlphaMaxAnimation:Landroid/view/animation/Animation;
...
.method private startProgressAlphaStartAnimation()V
    ...
    const-string v1, "startProgressAlphaStartAnimation"
    ...
    iput-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mAlphaStartAnimation:Landroid/view/animation/Animation;
...
.method private startScaleDownReturnToStartAnimation(ILandroid/view/animation/Animation$AnimationListener;)V
    ...
    const-string v1, "startScaleDownReturnToStartAnimation"
...
.method private startScaleUpAnimation(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    const-string v1, "startScaleUpAnimation"
    ...
    invoke-direct {v5, p0}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$2;-><init>(Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;)V

    iput-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mScaleAnimation:Landroid/view/animation/Animation;

    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mScaleAnimation:Landroid/view/animation/Animation;

    iget v6, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mMediumAnimationDuration:I
    ...
    invoke-virtual {v5, p1}, Landroidx/swiperefreshlayout/widget/CircleImageView;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V
...
.method public canChildScrollUp()Z
    ...
    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mChildScrollUpCallback:Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$OnChildScrollUpCallback;

    if-eqz v5, :cond_0

    iget-object v6, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mTarget:Landroid/view/View;
    ...
    invoke-interface {v5, p0, v6}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$OnChildScrollUpCallback;->canChildScrollUp(Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;Landroid/view/View;)Z
    ...
    invoke-static {v5, v7}, Landroidx/core/widget/ListViewCompat;->canScrollList(Landroid/widget/ListView;I)Z
    ...
    invoke-virtual {v5, v7}, Landroid/view/View;->canScrollVertically(I)Z
...
.method public dispatchNestedFling(FFZ)Z
    ...
    const-string v1, "dispatchNestedFling"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mNestedScrollingChildHelper:Landroidx/core/view/NestedScrollingChildHelper;

    invoke-virtual {v5, p1, p2, p3}, Landroidx/core/view/NestedScrollingChildHelper;->dispatchNestedFling(FFZ)Z
...
.method public dispatchNestedPreFling(FF)Z
    ...
    const-string v1, "dispatchNestedPreFling"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mNestedScrollingChildHelper:Landroidx/core/view/NestedScrollingChildHelper;

    invoke-virtual {v5, p1, p2}, Landroidx/core/view/NestedScrollingChildHelper;->dispatchNestedPreFling(FF)Z
...
.method public dispatchNestedPreScroll(II[I[I)Z
    ...
    const-string v1, "dispatchNestedPreScroll"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mNestedScrollingChildHelper:Landroidx/core/view/NestedScrollingChildHelper;

    invoke-virtual {v5, p1, p2, p3, p4}, Landroidx/core/view/NestedScrollingChildHelper;->dispatchNestedPreScroll(II[I[I)Z
...
.method public dispatchNestedScroll(IIII[I)Z
    ...
    const-string v1, "dispatchNestedScroll"
    ...
    invoke-virtual/range {v5 .. v10}, Landroidx/core/view/NestedScrollingChildHelper;->dispatchNestedScroll(IIII[I)Z
...
.method protected getChildDrawingOrder(II)I
    ...
    iget v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCircleViewIndex:I
...
.method public getNestedScrollAxes()I
    ...
    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mNestedScrollingParentHelper:Landroidx/core/view/NestedScrollingParentHelper;
...
.method public getProgressCircleDiameter()I
    ...
    const-string v1, "getProgressCircleDiameter"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCircleDiameter:I
...
.method public getProgressViewEndOffset()I
    ...
    const-string v1, "getProgressViewEndOffset"
...
.method public getProgressViewStartOffset()I
    ...
    const-string v1, "getProgressViewStartOffset"
...
.method public hasNestedScrollingParent()Z
    ...
    const-string v1, "hasNestedScrollingParent"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mNestedScrollingChildHelper:Landroidx/core/view/NestedScrollingChildHelper;

    invoke-virtual {v5}, Landroidx/core/view/NestedScrollingChildHelper;->hasNestedScrollingParent()Z
...
.method moveToStart(F)V
    ...
    const-string v1, "moveToStart"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mFrom:I
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v6, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mReturningToStart:Z
    ...
    iput-boolean v7, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mReturningToStart:Z
    ...
    iget-boolean v6, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mRefreshing:Z

    if-nez v6, :cond_9

    iget-boolean v6, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mNestedScrollInProgress:Z
    ...
    :cond_6
    iput-boolean v7, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mIsBeingDragged:Z

    iput v8, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mActivePointerId:I
    ...
    invoke-virtual {v6}, Landroidx/swiperefreshlayout/widget/CircleImageView;->getTop()I
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {p3, p4, p5, v5, p2}, Landroid/view/View;->layout(IIII)V
    ...
    iget v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCurrentTargetOffsetTop:I
    ...
    invoke-virtual {p4, p5, v5, p1, p3}, Landroidx/swiperefreshlayout/widget/CircleImageView;->layout(IIII)V
...
.method public onMeasure(II)V
    ...
    invoke-virtual {p1, p2, v6}, Landroid/view/View;->measure(II)V
    ...
    iget v6, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCircleDiameter:I
    ...
    invoke-virtual {p1, p2, v5}, Landroidx/swiperefreshlayout/widget/CircleImageView;->measure(II)V
...
.method public onNestedPreScroll(Landroid/view/View;II[I)V
    ...
    invoke-virtual {p1, v6}, Landroidx/swiperefreshlayout/widget/CircleImageView;->setVisibility(I)V
    ...
    invoke-virtual {p0, p2, p3, p1, v7}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->dispatchNestedPreScroll(II[I[I)Z
...
.method public onNestedScroll(Landroid/view/View;IIII)V
    ...
    iget-object v10, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mParentOffsetInWindow:[I
    ...
    invoke-virtual/range {v5 .. v10}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->dispatchNestedScroll(IIII[I)Z
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v5, p1, p2, p3}, Landroidx/core/view/NestedScrollingParentHelper;->onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-virtual {v5, p1}, Landroidx/core/view/NestedScrollingParentHelper;->onStopNestedScroll(Landroid/view/View;)V
    ...
    iput v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mTotalUnconsumed:F
...
.method public requestDisallowInterceptTouchEvent(Z)V
    ...
    instance-of v5, v5, Landroid/widget/AbsListView;
    ...
    invoke-static {v5}, Landroidx/core/view/ViewCompat;->isNestedScrollingEnabled(Landroid/view/View;)Z
...
.method reset()V
    ...
    invoke-virtual {v5}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->stop()V
    ...
    invoke-direct {p0, v5}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->setColorViewAlpha(I)V
    ...
    invoke-virtual {p0, v5}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->setAnimationProgress(F)V
    ...
    iput v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCurrentTargetOffsetTop:I
...
.method setAnimationProgress(F)V
    ...
    const-string v1, "setAnimationProgress"
    ...
    invoke-virtual {v5, p1}, Landroidx/swiperefreshlayout/widget/CircleImageView;->setScaleX(F)V
    ...
    invoke-virtual {v5, p1}, Landroidx/swiperefreshlayout/widget/CircleImageView;->setScaleY(F)V
...
.method public varargs setColorSchemeColors([I)V
    ...
    invoke-virtual {v5, p1}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->setColorSchemeColors([I)V
...
.method public varargs setColorSchemeResources([I)V
    ...
    const-string v1, "setColorSchemeResources"
    ...
    :cond_0
    invoke-virtual {p0, v6}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->setColorSchemeColors([I)V
...
.method public setNestedScrollingEnabled(Z)V
    ...
    invoke-virtual {v5, p1}, Landroidx/core/view/NestedScrollingChildHelper;->setNestedScrollingEnabled(Z)V
...
.method public setOnChildScrollUpCallback(Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$OnChildScrollUpCallback;)V
    ...
    const-string v1, "setOnChildScrollUpCallback"
...
.method public setOnRefreshListener(Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$OnRefreshListener;)V
    ...
    const-string v1, "setOnRefreshListener"
...
.method public setProgressBackgroundColor(I)V
    ...
    const-string v1, "setProgressBackgroundColor"
...
.method public setProgressBackgroundColorSchemeColor(I)V
    ...
    const-string v1, "setProgressBackgroundColorSchemeColor"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCircleView:Landroidx/swiperefreshlayout/widget/CircleImageView;

    invoke-virtual {v5, p1}, Landroidx/swiperefreshlayout/widget/CircleImageView;->setBackgroundColor(I)V
...
.method public setProgressBackgroundColorSchemeResource(I)V
    ...
    const-string v1, "setProgressBackgroundColorSchemeResource"
...
.method public setProgressViewOffset(ZII)V
    ...
    const-string v1, "setProgressViewOffset"
...
.method public setRefreshing(Z)V
    ...
    iput-boolean v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mNotify:Z
    ...
    :cond_1
    invoke-direct {p0, p1, v5}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->setRefreshing(ZZ)V
...
.method public setSize(I)V
    ...
    iput v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCircleDiameter:I
    ...
    invoke-virtual {v5, p1}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->setStyle(I)V
    ...
    invoke-virtual {p1, v5}, Landroidx/swiperefreshlayout/widget/CircleImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method setTargetOffsetTopAndBottom(I)V
    ...
    const-string v1, "setTargetOffsetTopAndBottom"
    ...
    invoke-virtual {v5}, Landroidx/swiperefreshlayout/widget/CircleImageView;->bringToFront()V
    ...
    invoke-static {v5, p1}, Landroidx/core/view/ViewCompat;->offsetTopAndBottom(Landroid/view/View;I)V
...
.method public startNestedScroll(I)Z
    ...
    const-string v1, "startNestedScroll"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mNestedScrollingChildHelper:Landroidx/core/view/NestedScrollingChildHelper;

    invoke-virtual {v5, p1}, Landroidx/core/view/NestedScrollingChildHelper;->startNestedScroll(I)Z
...
.method startScaleDownAnimation(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    const-string v1, "startScaleDownAnimation"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$3;

    invoke-direct {v5, p0}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$3;-><init>(Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;)V

    iput-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mScaleDownAnimation:Landroid/view/animation/Animation;

    iget-object v5, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mScaleDownAnimation:Landroid/view/animation/Animation;
...
.method public stopNestedScroll()V
    ...
    invoke-virtual {v5}, Landroidx/core/view/NestedScrollingChildHelper;->stopNestedScroll()V

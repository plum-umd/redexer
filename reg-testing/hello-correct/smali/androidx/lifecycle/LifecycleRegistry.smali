...
.method private backwardPass(Landroidx/lifecycle/LifecycleOwner;)V
    ...
    const-string v0, "Landroidx/lifecycle/LifecycleRegistry;"

    const-string v1, "backwardPass"
    ...
    const-string v0, "Landroidx/arch/core/internal/SafeIterableMap;"

    const-string v1, "descendingIterator"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v5}, Landroidx/arch/core/internal/FastSafeIterableMap;->descendingIterator()Ljava/util/Iterator;
    ...
    invoke-static {v8}, Landroidx/lifecycle/LifecycleRegistry;->downEvent(Landroidx/lifecycle/Lifecycle$State;)Landroidx/lifecycle/Lifecycle$Event;

    move-result-object v8

    invoke-static {v8}, Landroidx/lifecycle/LifecycleRegistry;->getStateAfter(Landroidx/lifecycle/Lifecycle$Event;)Landroidx/lifecycle/Lifecycle$State;

    move-result-object v9

    invoke-direct {p0, v9}, Landroidx/lifecycle/LifecycleRegistry;->pushParentState(Landroidx/lifecycle/Lifecycle$State;)V

    invoke-virtual {v7, p1, v8}, Landroidx/lifecycle/LifecycleRegistry$ObserverWithState;->dispatchEvent(Landroidx/lifecycle/LifecycleOwner;Landroidx/lifecycle/Lifecycle$Event;)V
...
.method private calculateTargetState(Landroidx/lifecycle/LifecycleObserver;)Landroidx/lifecycle/Lifecycle$State;
    ...
    const-string v1, "calculateTargetState"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/lifecycle/LifecycleRegistry;->mObserverMap:Landroidx/arch/core/internal/FastSafeIterableMap;

    invoke-virtual {v5, p1}, Landroidx/arch/core/internal/FastSafeIterableMap;->ceil(Ljava/lang/Object;)Ljava/util/Map$Entry;
    ...
    invoke-static {v6, p1}, Landroidx/lifecycle/LifecycleRegistry;->min(Landroidx/lifecycle/Lifecycle$State;Landroidx/lifecycle/Lifecycle$State;)Landroidx/lifecycle/Lifecycle$State;

    move-result-object p1

    invoke-static {p1, v5}, Landroidx/lifecycle/LifecycleRegistry;->min(Landroidx/lifecycle/Lifecycle$State;Landroidx/lifecycle/Lifecycle$State;)Landroidx/lifecycle/Lifecycle$State;
...
.method private static downEvent(Landroidx/lifecycle/Lifecycle$State;)Landroidx/lifecycle/Lifecycle$Event;
    ...
    const-string v7, "Unexpected state value "
...
.method private forwardPass(Landroidx/lifecycle/LifecycleOwner;)V
    ...
    invoke-direct {p0, v8}, Landroidx/lifecycle/LifecycleRegistry;->pushParentState(Landroidx/lifecycle/Lifecycle$State;)V

    iget-object v8, v7, Landroidx/lifecycle/LifecycleRegistry$ObserverWithState;->mState:Landroidx/lifecycle/Lifecycle$State;

    invoke-static {v8}, Landroidx/lifecycle/LifecycleRegistry;->upEvent(Landroidx/lifecycle/Lifecycle$State;)Landroidx/lifecycle/Lifecycle$Event;
...
.method static getStateAfter(Landroidx/lifecycle/Lifecycle$Event;)Landroidx/lifecycle/Lifecycle$State;
    ...
    const-string v7, "Unexpected event value "
...
.method private isSynced()Z
    ...
    invoke-virtual {v5}, Landroidx/arch/core/internal/FastSafeIterableMap;->size()I
    ...
    invoke-virtual {v5}, Landroidx/arch/core/internal/FastSafeIterableMap;->eldest()Ljava/util/Map$Entry;
    ...
    invoke-virtual {v7}, Landroidx/arch/core/internal/FastSafeIterableMap;->newest()Ljava/util/Map$Entry;
...
.method private moveToState(Landroidx/lifecycle/Lifecycle$State;)V
    ...
    :cond_1
    iput-boolean v5, p0, Landroidx/lifecycle/LifecycleRegistry;->mHandlingEvent:Z
    ...
    :cond_2
    :goto_0
    iput-boolean v5, p0, Landroidx/lifecycle/LifecycleRegistry;->mNewEventOccurred:Z
...
.method private popParentState()V
    ...
    const-string v1, "popParentState"
...
.method private pushParentState(Landroidx/lifecycle/Lifecycle$State;)V
    ...
    const-string v1, "pushParentState"
...
.method private sync()V
    ...
    iget-object v5, p0, Landroidx/lifecycle/LifecycleRegistry;->mLifecycleOwner:Ljava/lang/ref/WeakReference;
    ...
    const-string v5, "LifecycleRegistry"

    const-string v6, "LifecycleOwner is garbage collected, you shouldn\'t try dispatch new events from it."
    ...
    iput-boolean v7, p0, Landroidx/lifecycle/LifecycleRegistry;->mNewEventOccurred:Z
    ...
    invoke-virtual {v7}, Landroidx/arch/core/internal/FastSafeIterableMap;->eldest()Ljava/util/Map$Entry;
    ...
    invoke-direct {p0, v5}, Landroidx/lifecycle/LifecycleRegistry;->backwardPass(Landroidx/lifecycle/LifecycleOwner;)V
    ...
    invoke-virtual {v6}, Landroidx/arch/core/internal/FastSafeIterableMap;->newest()Ljava/util/Map$Entry;
    ...
    invoke-direct {p0, v5}, Landroidx/lifecycle/LifecycleRegistry;->forwardPass(Landroidx/lifecycle/LifecycleOwner;)V
...
.method public addObserver(Landroidx/lifecycle/LifecycleObserver;)V
    ...
    :goto_0
    new-instance v6, Landroidx/lifecycle/LifecycleRegistry$ObserverWithState;

    invoke-direct {v6, p1, v5}, Landroidx/lifecycle/LifecycleRegistry$ObserverWithState;-><init>(Landroidx/lifecycle/LifecycleObserver;Landroidx/lifecycle/Lifecycle$State;)V

    iget-object v5, p0, Landroidx/lifecycle/LifecycleRegistry;->mObserverMap:Landroidx/arch/core/internal/FastSafeIterableMap;

    invoke-virtual {v5, p1, v6}, Landroidx/arch/core/internal/FastSafeIterableMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-boolean v7, p0, Landroidx/lifecycle/LifecycleRegistry;->mHandlingEvent:Z
    ...
    iget v10, p0, Landroidx/lifecycle/LifecycleRegistry;->mAddingObserverCounter:I

    add-int/2addr v10, v8

    iput v10, p0, Landroidx/lifecycle/LifecycleRegistry;->mAddingObserverCounter:I

    :goto_3
    iget-object v10, v6, Landroidx/lifecycle/LifecycleRegistry$ObserverWithState;->mState:Landroidx/lifecycle/Lifecycle$State;
    ...
    invoke-virtual {v10, v9}, Landroidx/lifecycle/Lifecycle$State;->compareTo(Ljava/lang/Enum;)I
    ...
    invoke-virtual {v9, p1}, Landroidx/arch/core/internal/FastSafeIterableMap;->contains(Ljava/lang/Object;)Z

    move-result v9

    if-eqz v9, :cond_5

    iget-object v9, v6, Landroidx/lifecycle/LifecycleRegistry$ObserverWithState;->mState:Landroidx/lifecycle/Lifecycle$State;

    invoke-direct {p0, v9}, Landroidx/lifecycle/LifecycleRegistry;->pushParentState(Landroidx/lifecycle/Lifecycle$State;)V

    iget-object v9, v6, Landroidx/lifecycle/LifecycleRegistry$ObserverWithState;->mState:Landroidx/lifecycle/Lifecycle$State;

    invoke-static {v9}, Landroidx/lifecycle/LifecycleRegistry;->upEvent(Landroidx/lifecycle/Lifecycle$State;)Landroidx/lifecycle/Lifecycle$Event;

    move-result-object v9

    invoke-virtual {v6, v5, v9}, Landroidx/lifecycle/LifecycleRegistry$ObserverWithState;->dispatchEvent(Landroidx/lifecycle/LifecycleOwner;Landroidx/lifecycle/Lifecycle$Event;)V
...
.method public getObserverCount()I
    ...
    const-string v1, "getObserverCount"
...
.method public removeObserver(Landroidx/lifecycle/LifecycleObserver;)V
    ...
    invoke-virtual {v5, p1}, Landroidx/arch/core/internal/FastSafeIterableMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

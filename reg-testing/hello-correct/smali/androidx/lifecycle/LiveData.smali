...
.method private static assertMainThread(Ljava/lang/String;)V
    ...
    const-string v0, "Landroidx/lifecycle/LiveData;"

    const-string v1, "assertMainThread"
    ...
    invoke-virtual {v5}, Landroidx/arch/core/executor/ArchTaskExecutor;->isMainThread()Z
...
.method private considerNotify(Landroidx/lifecycle/LiveData$ObserverWrapper;)V
    ...
    const-string v1, "considerNotify"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v5, p1, Landroidx/lifecycle/LiveData$ObserverWrapper;->mActive:Z
    ...
    const-string v1, "shouldBeActive"
    ...
    invoke-virtual {p1, v5}, Landroidx/lifecycle/LiveData$ObserverWrapper;->activeStateChanged(Z)V
    ...
    :cond_1
    iget v5, p1, Landroidx/lifecycle/LiveData$ObserverWrapper;->mLastVersion:I

    iget v6, p0, Landroidx/lifecycle/LiveData;->mVersion:I
    ...
    :cond_2
    iput v6, p1, Landroidx/lifecycle/LiveData$ObserverWrapper;->mLastVersion:I

    iget-object p1, p1, Landroidx/lifecycle/LiveData$ObserverWrapper;->mObserver:Landroidx/lifecycle/Observer;

    iget-object v5, p0, Landroidx/lifecycle/LiveData;->mData:Ljava/lang/Object;
    ...
    invoke-interface {p1, v5}, Landroidx/lifecycle/Observer;->onChanged(Ljava/lang/Object;)V
...
.method dispatchingValue(Landroidx/lifecycle/LiveData$ObserverWrapper;)V
    ...
    const-string v1, "dispatchingValue"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v5, p0, Landroidx/lifecycle/LiveData;->mDispatchingValue:Z

    const/4 v6, 0x1

    if-eqz v5, :cond_0

    iput-boolean v6, p0, Landroidx/lifecycle/LiveData;->mDispatchInvalidated:Z
    ...
    :cond_0
    iput-boolean v6, p0, Landroidx/lifecycle/LiveData;->mDispatchingValue:Z

    :cond_1
    const/4 v5, 0x0

    iput-boolean v5, p0, Landroidx/lifecycle/LiveData;->mDispatchInvalidated:Z
    ...
    :cond_2
    iget-object v6, p0, Landroidx/lifecycle/LiveData;->mObservers:Landroidx/arch/core/internal/SafeIterableMap;

    invoke-virtual {v6}, Landroidx/arch/core/internal/SafeIterableMap;->iteratorWithAdditions()Landroidx/arch/core/internal/SafeIterableMap$IteratorWithAdditions;
    ...
    check-cast v7, Landroidx/lifecycle/LiveData$ObserverWrapper;

    invoke-direct {p0, v7}, Landroidx/lifecycle/LiveData;->considerNotify(Landroidx/lifecycle/LiveData$ObserverWrapper;)V

    iget-boolean v7, p0, Landroidx/lifecycle/LiveData;->mDispatchInvalidated:Z

    if-eqz v7, :cond_3

    :cond_4
    :goto_0
    iget-boolean v6, p0, Landroidx/lifecycle/LiveData;->mDispatchInvalidated:Z

    if-nez v6, :cond_1

    iput-boolean v5, p0, Landroidx/lifecycle/LiveData;->mDispatchingValue:Z
...
.method getVersion()I
    ...
    iget v5, p0, Landroidx/lifecycle/LiveData;->mVersion:I
...
.method public hasObservers()Z
    ...
    iget-object v5, p0, Landroidx/lifecycle/LiveData;->mObservers:Landroidx/arch/core/internal/SafeIterableMap;

    invoke-virtual {v5}, Landroidx/arch/core/internal/SafeIterableMap;->size()I
...
.method public observe(Landroidx/lifecycle/LifecycleOwner;Landroidx/lifecycle/Observer;)V
    ...
    invoke-direct {v5, p0, p1, p2}, Landroidx/lifecycle/LiveData$LifecycleBoundObserver;-><init>(Landroidx/lifecycle/LiveData;Landroidx/lifecycle/LifecycleOwner;Landroidx/lifecycle/Observer;)V

    iget-object v6, p0, Landroidx/lifecycle/LiveData;->mObservers:Landroidx/arch/core/internal/SafeIterableMap;

    invoke-virtual {v6, p2, v5}, Landroidx/arch/core/internal/SafeIterableMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v5}, Landroidx/lifecycle/Lifecycle;->addObserver(Landroidx/lifecycle/LifecycleObserver;)V
...
.method public observeForever(Landroidx/lifecycle/Observer;)V
    ...
    new-instance v5, Landroidx/lifecycle/LiveData$AlwaysActiveObserver;

    invoke-direct {v5, p0, p1}, Landroidx/lifecycle/LiveData$AlwaysActiveObserver;-><init>(Landroidx/lifecycle/LiveData;Landroidx/lifecycle/Observer;)V

    iget-object v6, p0, Landroidx/lifecycle/LiveData;->mObservers:Landroidx/arch/core/internal/SafeIterableMap;

    invoke-virtual {v6, p1, v5}, Landroidx/arch/core/internal/SafeIterableMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    instance-of v6, p1, Landroidx/lifecycle/LiveData$LifecycleBoundObserver;
    ...
    invoke-virtual {v5, p1}, Landroidx/lifecycle/LiveData$AlwaysActiveObserver;->activeStateChanged(Z)V
...
.method public removeObserver(Landroidx/lifecycle/Observer;)V
    ...
    const-string v5, "removeObserver"

    invoke-static {v5}, Landroidx/lifecycle/LiveData;->assertMainThread(Ljava/lang/String;)V

    iget-object v5, p0, Landroidx/lifecycle/LiveData;->mObservers:Landroidx/arch/core/internal/SafeIterableMap;

    invoke-virtual {v5, p1}, Landroidx/arch/core/internal/SafeIterableMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public removeObservers(Landroidx/lifecycle/LifecycleOwner;)V
    ...
    const-string v5, "removeObservers"
    ...
    invoke-virtual {v7, p1}, Landroidx/lifecycle/LiveData$ObserverWrapper;->isAttachedTo(Landroidx/lifecycle/LifecycleOwner;)Z
    ...
    invoke-virtual {p0, v6}, Landroidx/lifecycle/LiveData;->removeObserver(Landroidx/lifecycle/Observer;)V
...
.method protected setValue(Ljava/lang/Object;)V
    ...
    iput v5, p0, Landroidx/lifecycle/LiveData;->mVersion:I

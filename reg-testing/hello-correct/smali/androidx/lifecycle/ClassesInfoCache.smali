...
.method private createInfo(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    ...
    const-string v0, "Landroidx/lifecycle/ClassesInfoCache;"
    ...
    invoke-virtual/range {v0 .. v1}, Landroidx/lifecycle/ClassesInfoCache;->getInfo(Ljava/lang/Class;)Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    ...
    invoke-virtual/range {v0 .. v0}, Ljava/lang/Class;->getInterfaces()[Ljava/lang/Class;
    ...
    iget-object v10, v10, Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;->mHandlerToEvent:Ljava/util/Map;
    ...
    check-cast v12, Landroidx/lifecycle/ClassesInfoCache$MethodReference;
    ...
    invoke-direct/range {v0 .. v4}, Landroidx/lifecycle/ClassesInfoCache;->verifyAndPutHandler(Ljava/util/Map;Landroidx/lifecycle/ClassesInfoCache$MethodReference;Landroidx/lifecycle/Lifecycle$Event;Ljava/lang/Class;)V
    ...
    invoke-direct/range {v0 .. v1}, Landroidx/lifecycle/ClassesInfoCache;->getDeclaredMethods(Ljava/lang/Class;)[Ljava/lang/reflect/Method;
    ...
    const-class v14, Landroidx/lifecycle/Lifecycle$Event;
    ...
    sget-object v13, Landroidx/lifecycle/Lifecycle$Event;->ON_ANY:Landroidx/lifecycle/Lifecycle$Event;
    ...
    invoke-direct {v9, v13, v10}, Landroidx/lifecycle/ClassesInfoCache$MethodReference;-><init>(ILjava/lang/reflect/Method;)V
    ...
    invoke-direct/range {v0 .. v1}, Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;-><init>(Ljava/util/Map;)V

    move-object/from16 v0, p0

    iget-object v5, v0, Landroidx/lifecycle/ClassesInfoCache;->mCallbackMap:Ljava/util/Map;
    ...
    iget-object v5, v0, Landroidx/lifecycle/ClassesInfoCache;->mHasLifecycleMethods:Ljava/util/Map;
...
.method private getDeclaredMethods(Ljava/lang/Class;)[Ljava/lang/reflect/Method;
    ...
    const-string v6, "The observer class has some methods that use newer APIs which are not available in the current OS version. Lifecycles cannot access even other methods so you should make sure that your observer classes only access framework classes that are available in your min API level OR use lifecycle:compiler annotation processor."

    invoke-direct {v5, v6, p1}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private verifyAndPutHandler(Ljava/util/Map;Landroidx/lifecycle/ClassesInfoCache$MethodReference;Landroidx/lifecycle/Lifecycle$Event;Ljava/lang/Class;)V
    ...
    const-string v1, "verifyAndPutHandler"
...
.method getInfo(Ljava/lang/Class;)Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
    ...
    iget-object v5, p0, Landroidx/lifecycle/ClassesInfoCache;->mCallbackMap:Ljava/util/Map;
    ...
    check-cast v5, Landroidx/lifecycle/ClassesInfoCache$CallbackInfo;
...
.method hasLifecycleMethods(Ljava/lang/Class;)Z
    ...
    const-string v1, "hasLifecycleMethods"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Landroidx/lifecycle/ClassesInfoCache;->mHasLifecycleMethods:Ljava/util/Map;

...
.method private static createGeneratedAdapter(Ljava/lang/reflect/Constructor;Ljava/lang/Object;)Landroidx/lifecycle/GeneratedAdapter;
    ...
    const-string v0, "Landroidx/lifecycle/Lifecycling;"

    const-string v1, "createGeneratedAdapter"
...
.method private static generatedConstructor(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    const-string v1, "generatedConstructor"
    ...
    move-result v5
    :try_end_13
    .catch Ljava/lang/ClassNotFoundException; {:try_start_13 .. :try_end_13} :catch_1
    ...
    :try_start_15
    invoke-virtual {p0, v8}, Ljava/lang/reflect/Constructor;->setAccessible(Z)V
    :try_end_15
    .catch Ljava/lang/ClassNotFoundException; {:try_start_15 .. :try_end_15} :catch_1
...
.method public static getAdapterName(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "getAdapterName"
...
.method static getCallback(Ljava/lang/Object;)Landroidx/lifecycle/GenericLifecycleObserver;
    ...
    instance-of v5, p0, Landroidx/lifecycle/FullLifecycleObserver;

    if-eqz v5, :cond_0

    new-instance v5, Landroidx/lifecycle/FullLifecycleObserverAdapter;

    check-cast p0, Landroidx/lifecycle/FullLifecycleObserver;

    invoke-direct {v5, p0}, Landroidx/lifecycle/FullLifecycleObserverAdapter;-><init>(Landroidx/lifecycle/FullLifecycleObserver;)V
    ...
    :cond_0
    instance-of v5, p0, Landroidx/lifecycle/GenericLifecycleObserver;
    ...
    invoke-static {v5}, Landroidx/lifecycle/Lifecycling;->getObserverConstructorType(Ljava/lang/Class;)I
    ...
    invoke-direct {v5, p0}, Landroidx/lifecycle/SingleGeneratedAdapterObserver;-><init>(Landroidx/lifecycle/GeneratedAdapter;)V
    ...
    invoke-static {v8, p0}, Landroidx/lifecycle/Lifecycling;->createGeneratedAdapter(Ljava/lang/reflect/Constructor;Ljava/lang/Object;)Landroidx/lifecycle/GeneratedAdapter;
    ...
    invoke-direct {p0, v6}, Landroidx/lifecycle/CompositeGeneratedAdaptersObserver;-><init>([Landroidx/lifecycle/GeneratedAdapter;)V
    ...
    invoke-direct {v5, p0}, Landroidx/lifecycle/ReflectiveGenericLifecycleObserver;-><init>(Ljava/lang/Object;)V
...
.method private static getObserverConstructorType(Ljava/lang/Class;)I
    ...
    const-string v1, "getObserverConstructorType"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-object v5, Landroidx/lifecycle/Lifecycling;->sCallbackCache:Ljava/util/Map;
    ...
    sget-object v6, Landroidx/lifecycle/Lifecycling;->sCallbackCache:Ljava/util/Map;
...
.method private static isLifecycleParent(Ljava/lang/Class;)Z
    ...
    const-string v1, "isLifecycleParent"
...
.method private static resolveObserverCallbackType(Ljava/lang/Class;)I
    ...
    const-string v1, "resolveObserverCallbackType"
    ...
    invoke-static {v5}, Landroidx/lifecycle/Lifecycling;->isLifecycleParent(Ljava/lang/Class;)Z
    ...
    invoke-static {v11}, Landroidx/lifecycle/Lifecycling;->isLifecycleParent(Ljava/lang/Class;)Z
    ...
    :cond_5
    invoke-static {v11}, Landroidx/lifecycle/Lifecycling;->getObserverConstructorType(Ljava/lang/Class;)I
    ...
    :cond_7
    sget-object v12, Landroidx/lifecycle/Lifecycling;->sClassToAdapters:Ljava/util/Map;

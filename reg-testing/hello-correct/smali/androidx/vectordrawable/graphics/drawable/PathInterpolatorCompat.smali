...
.method private initCubic(FFFF)V
    ...
    const-string v0, "Landroidx/vectordrawable/graphics/drawable/PathInterpolatorCompat;"

    const-string v1, "initCubic"
    ...
    invoke-virtual {v12, v5, v5}, Landroid/graphics/Path;->moveTo(FF)V
    ...
    invoke-direct {p0, v12}, Landroidx/vectordrawable/graphics/drawable/PathInterpolatorCompat;->initPath(Landroid/graphics/Path;)V
...
.method private initPath(Landroid/graphics/Path;)V
    ...
    invoke-direct/range {v0 .. v2}, Landroid/graphics/PathMeasure;-><init>(Landroid/graphics/Path;Z)V
    ...
    iput-object v9, p0, Landroidx/vectordrawable/graphics/drawable/PathInterpolatorCompat;->mX:[F

    new-array v9, v7, [F

    iput-object v9, p0, Landroidx/vectordrawable/graphics/drawable/PathInterpolatorCompat;->mY:[F
    ...
    invoke-virtual {v5, v11, v9, v12}, Landroid/graphics/PathMeasure;->getPosTan(F[F[F)Z
    ...
    iget-object v11, p0, Landroidx/vectordrawable/graphics/drawable/PathInterpolatorCompat;->mX:[F

    aget v12, v9, v6

    aput v12, v11, v10

    iget-object v11, p0, Landroidx/vectordrawable/graphics/drawable/PathInterpolatorCompat;->mY:[F
    ...
    const-string v7, "The Path cannot loop back on itself, x :"
    ...
    invoke-virtual/range {v0 .. v1}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;
    ...
    const-string v5, "The Path should be continuous, can\'t have 2+ contours"
    ...
    const-string v9, "The Path must start at (0,0) and end at (1,1) start: "
    ...
    const-string v7, "The Path has a invalid length "
...
.method private initQuad(FF)V
    ...
    invoke-virtual {v5, p1, p2, v6, v6}, Landroid/graphics/Path;->quadTo(FFFF)V
    ...
    invoke-direct {p0, v5}, Landroidx/vectordrawable/graphics/drawable/PathInterpolatorCompat;->initPath(Landroid/graphics/Path;)V
...
.method private parseInterpolatorFromTypeArray(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    const-string v1, "parseInterpolatorFromTypeArray"
    ...
    invoke-static {p1, p2, v5, v6}, Landroidx/core/content/res/TypedArrayUtils;->getNamedString(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)Ljava/lang/String;
    ...
    const-string v6, "The path is null, which is created from "
    ...
    invoke-static {p2, v6}, Landroidx/core/content/res/TypedArrayUtils;->hasAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2, v5, v7, v8}, Landroidx/core/content/res/TypedArrayUtils;->getNamedFloat(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    const-string v7, "controlX2"

    invoke-static {p2, v7}, Landroidx/core/content/res/TypedArrayUtils;->hasAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z

    move-result v9

    const-string v10, "controlY2"

    invoke-static {p2, v10}, Landroidx/core/content/res/TypedArrayUtils;->hasAttribute(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v5, v6}, Landroidx/vectordrawable/graphics/drawable/PathInterpolatorCompat;->initQuad(FF)V
    ...
    invoke-static {p1, p2, v7, v9, v8}, Landroidx/core/content/res/TypedArrayUtils;->getNamedFloat(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result v7

    const/4 v9, 0x3

    invoke-static {p1, p2, v10, v9, v8}, Landroidx/core/content/res/TypedArrayUtils;->getNamedFloat(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F

    move-result p1

    invoke-direct {p0, v5, v6, v7, p1}, Landroidx/vectordrawable/graphics/drawable/PathInterpolatorCompat;->initCubic(FFFF)V

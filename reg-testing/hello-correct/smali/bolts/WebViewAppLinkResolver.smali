...
.method static synthetic access$000(Lorg/json/JSONArray;)Ljava/util/Map;
    ...
    const-string v0, "Lbolts/WebViewAppLinkResolver;"
...
.method private static makeAppLinkFromAlData(Ljava/util/Map;Landroid/net/Uri;)Lbolts/AppLink;
    ...
    const-string v1, "makeAppLinkFromAlData"
    ...
    invoke-static {v8, v9}, Lbolts/WebViewAppLinkResolver;->getAlList(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;

    move-result-object v9

    const-string v13, "package"

    invoke-static {v8, v13}, Lbolts/WebViewAppLinkResolver;->getAlList(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;

    move-result-object v13

    const-string v14, "class"

    invoke-static {v8, v14}, Lbolts/WebViewAppLinkResolver;->getAlList(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;

    move-result-object v14

    const-string v15, "app_name"

    invoke-static {v8, v15}, Lbolts/WebViewAppLinkResolver;->getAlList(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static/range {v0 .. v0}, Lbolts/WebViewAppLinkResolver;->tryCreateUrl(Ljava/lang/String;)Landroid/net/Uri;
    ...
    new-instance v20, Lbolts/AppLink$Target;
    ...
    invoke-direct/range {v0 .. v4}, Lbolts/AppLink$Target;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    const-string v8, "should_fallback"
    ...
    invoke-static {v5}, Lbolts/WebViewAppLinkResolver;->tryCreateUrl(Ljava/lang/String;)Landroid/net/Uri;
    ...
    :goto_6
    new-instance v7, Lbolts/AppLink;

    move-object/from16 v8, p1

    invoke-direct {v7, v8, v6, v5}, Lbolts/AppLink;-><init>(Landroid/net/Uri;Ljava/util/List;Landroid/net/Uri;)V
...
.method private static readFromConnection(Ljava/net/URLConnection;)Ljava/lang/String;
    ...
    const-string v1, "readFromConnection"
    ...
    :try_start_12
    invoke-direct {p0, v6, v7}, Ljava/lang/String;-><init>([BLjava/lang/String;)V
    :try_end_12
...
.method public getAppLinkFromUrlInBackground(Landroid/net/Uri;)Lbolts/Task;
    ...
    new-instance v7, Lbolts/WebViewAppLinkResolver$3;

    invoke-direct {v7, p0, p1, v5, v6}, Lbolts/WebViewAppLinkResolver$3;-><init>(Lbolts/WebViewAppLinkResolver;Landroid/net/Uri;Lbolts/Capture;Lbolts/Capture;)V

    invoke-static {v7}, Lbolts/Task;->callInBackground(Ljava/util/concurrent/Callable;)Lbolts/Task;

    move-result-object v7

    new-instance v8, Lbolts/WebViewAppLinkResolver$2;

    invoke-direct {v8, p0, v6, p1, v5}, Lbolts/WebViewAppLinkResolver$2;-><init>(Lbolts/WebViewAppLinkResolver;Lbolts/Capture;Landroid/net/Uri;Lbolts/Capture;)V

    sget-object v5, Lbolts/Task;->UI_THREAD_EXECUTOR:Ljava/util/concurrent/Executor;

    invoke-virtual {v7, v8, v5}, Lbolts/Task;->onSuccessTask(Lbolts/Continuation;Ljava/util/concurrent/Executor;)Lbolts/Task;

    move-result-object v5

    new-instance v6, Lbolts/WebViewAppLinkResolver$1;

    invoke-direct {v6, p0, p1}, Lbolts/WebViewAppLinkResolver$1;-><init>(Lbolts/WebViewAppLinkResolver;Landroid/net/Uri;)V

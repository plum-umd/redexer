...
.method private runJavaScript(Landroid/webkit/WebView;)V
    ...
    const-string v0, "Lbolts/WebViewAppLinkResolver$2$1;"

    const-string v1, "runJavaScript"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v5, p0, Lbolts/WebViewAppLinkResolver$2$1;->loaded:Z

    if-nez v5, :cond_0

    const/4 v5, 0x1

    iput-boolean v5, p0, Lbolts/WebViewAppLinkResolver$2$1;->loaded:Z

    const-string v5, "javascript:boltsWebViewAppLinkResolverResult.setValue((function() {  var metaTags = document.getElementsByTagName(\'meta\');  var results = [];  for (var i = 0; i < metaTags.length; i++) {    var property = metaTags[i].getAttribute(\'property\');    if (property && property.substring(0, \'al:\'.length) === \'al:\') {      var tag = { \"property\": metaTags[i].getAttribute(\'property\') };      if (metaTags[i].hasAttribute(\'content\')) {        tag[\'content\'] = metaTags[i].getAttribute(\'content\');      }      results.push(tag);    }  }  return JSON.stringify(results);})())"

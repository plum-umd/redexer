...
.method private static getApplinkLogData(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Landroid/content/Intent;)Landroid/os/Bundle;
    ...
    const-string v0, "Lbolts/MeasurementEvent;"

    const-string v1, "getApplinkLogData"
    ...
    const-string v1, "getShortClassName"
    ...
    instance-of v6, p3, Landroid/os/Bundle;
    ...
    const-string v10, "referer_app_link"
    ...
    const-string v8, "refererAppName"
    ...
    const-string v8, "sourceApplication"
...
.method private static objectToJSONString(Ljava/lang/Object;)Ljava/lang/String;
    ...
    const-string v1, "objectToJSONString"
    ...
    invoke-direct {v6, p0}, Lorg/json/JSONArray;-><init>(Ljava/util/Collection;)V
    :try_end_0
...
.method private sendBroadcast()V
    ...
    const-string v6, "Event name is required"
    ...
    :cond_0
    :try_start_0
    const-string v5, "androidx.localbroadcastmanager.content.LocalBroadcastManager"
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v11, p0, Lbolts/MeasurementEvent;->appContext:Landroid/content/Context;
    ...
    const-string v9, "com.parse.bolts.measurement_event"

    invoke-direct {v8, v9}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string v9, "event_name"

    iget-object v11, p0, Lbolts/MeasurementEvent;->name:Ljava/lang/String;
    :try_end_8
    ...
    const-string v9, "event_args"

    :try_start_a
    iget-object v11, p0, Lbolts/MeasurementEvent;->args:Landroid/os/Bundle;
    :try_end_a
    ...
    :try_start_b
    invoke-virtual {v8, v9, v11}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Bundle;)Landroid/content/Intent;
    :try_end_b
    ...
    const-string v6, "LocalBroadcastManager in android support library is required to raise bolts event."
...
.method static sendBroadcastEvent(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Ljava/util/Map;)V
    ...
    const-string v1, "sendBroadcastEvent"
    ...
    invoke-static {p0, p1, v6, p2}, Lbolts/MeasurementEvent;->getApplinkLogData(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Landroid/content/Intent;)Landroid/os/Bundle;
    ...
    invoke-direct {p2, p0, p1, v5}, Lbolts/MeasurementEvent;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)V

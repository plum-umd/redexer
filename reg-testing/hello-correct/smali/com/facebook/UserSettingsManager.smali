...
.method static synthetic access$000()Lcom/facebook/UserSettingsManager$UserSetting;
    ...
    const-string v0, "Lcom/facebook/UserSettingsManager;"
...
.method static synthetic access$100()Lcom/facebook/UserSettingsManager$UserSetting;
    ...
    sget-object v5, Lcom/facebook/UserSettingsManager;->codelessSetupEnabled:Lcom/facebook/UserSettingsManager$UserSetting;
...
.method static synthetic access$300()Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v5, Lcom/facebook/UserSettingsManager;->isFetchingCodelessStatus:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static getAdvertiserIDCollectionEnabled()Z
    ...
    const-string v1, "getAdvertiserIDCollectionEnabled"
...
.method public static getAutoInitEnabled()Z
    ...
    const-string v1, "getAutoInitEnabled"
...
.method public static getAutoLogAppEventsEnabled()Z
    ...
    const-string v1, "getAutoLogAppEventsEnabled"
...
.method public static getCodelessSetupEnabled()Z
    ...
    const-string v1, "getCodelessSetupEnabled"
...
.method private static initializeCodelessSetupEnabledAsync()V
    ...
    const-string v1, "initializeCodelessSetupEnabledAsync"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-object v5, Lcom/facebook/UserSettingsManager;->codelessSetupEnabled:Lcom/facebook/UserSettingsManager$UserSetting;

    invoke-static {v5}, Lcom/facebook/UserSettingsManager;->readSettingFromCache(Lcom/facebook/UserSettingsManager$UserSetting;)V
    ...
    sget-object v7, Lcom/facebook/UserSettingsManager;->codelessSetupEnabled:Lcom/facebook/UserSettingsManager$UserSetting;

    iget-object v7, v7, Lcom/facebook/UserSettingsManager$UserSetting;->value:Ljava/lang/Boolean;

    if-eqz v7, :cond_0

    sget-object v7, Lcom/facebook/UserSettingsManager;->codelessSetupEnabled:Lcom/facebook/UserSettingsManager$UserSetting;

    iget-wide v7, v7, Lcom/facebook/UserSettingsManager$UserSetting;->lastTS:J
    ...
    sget-object v7, Lcom/facebook/UserSettingsManager;->isFetchingCodelessStatus:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    new-instance v8, Lcom/facebook/UserSettingsManager$1;

    invoke-direct {v8, v5, v6}, Lcom/facebook/UserSettingsManager$1;-><init>(J)V
...
.method public static initializeIfNotInitialized()V
    ...
    :cond_0
    sget-object v5, Lcom/facebook/UserSettingsManager;->isInitialized:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-string v8, "com.facebook.sdk.USER_SETTINGS"
    ...
    sput-object v5, Lcom/facebook/UserSettingsManager;->userSettingPref:Landroid/content/SharedPreferences;

    const/4 v5, 0x3

    new-array v5, v5, [Lcom/facebook/UserSettingsManager$UserSetting;

    sget-object v8, Lcom/facebook/UserSettingsManager;->autoLogAppEventsEnabled:Lcom/facebook/UserSettingsManager$UserSetting;
    ...
    sget-object v7, Lcom/facebook/UserSettingsManager;->autoInitEnabled:Lcom/facebook/UserSettingsManager$UserSetting;

    aput-object v7, v5, v6

    invoke-static {v5}, Lcom/facebook/UserSettingsManager;->initializeUserSetting([Lcom/facebook/UserSettingsManager$UserSetting;)V
...
.method private static varargs initializeUserSetting([Lcom/facebook/UserSettingsManager$UserSetting;)V
    ...
    const-string v1, "initializeUserSetting"
    ...
    :cond_0
    iget-object v7, v6, Lcom/facebook/UserSettingsManager$UserSetting;->value:Ljava/lang/Boolean;

    if-nez v7, :cond_1

    invoke-static {v6}, Lcom/facebook/UserSettingsManager;->readSettingFromCache(Lcom/facebook/UserSettingsManager$UserSetting;)V

    iget-object v7, v6, Lcom/facebook/UserSettingsManager$UserSetting;->value:Ljava/lang/Boolean;

    if-nez v7, :cond_2

    invoke-static {v6}, Lcom/facebook/UserSettingsManager;->loadSettingFromManifest(Lcom/facebook/UserSettingsManager$UserSetting;)V

    goto :goto_1

    :cond_1
    invoke-static {v6}, Lcom/facebook/UserSettingsManager;->writeSettingToCache(Lcom/facebook/UserSettingsManager$UserSetting;)V
...
.method private static loadSettingFromManifest(Lcom/facebook/UserSettingsManager$UserSetting;)V
    ...
    const-string v1, "loadSettingFromManifest"
    ...
    iget-object v7, p0, Lcom/facebook/UserSettingsManager$UserSetting;->key:Ljava/lang/String;
    :try_end_5
    ...
    iget-object v6, p0, Lcom/facebook/UserSettingsManager$UserSetting;->key:Ljava/lang/String;

    iget-boolean v7, p0, Lcom/facebook/UserSettingsManager$UserSetting;->defaultVal:Z
    :try_end_7
    ...
    iput-object v5, p0, Lcom/facebook/UserSettingsManager$UserSetting;->value:Ljava/lang/Boolean;
    :try_end_9
    ...
    invoke-static {v5, p0}, Lcom/facebook/internal/Utility;->logd(Ljava/lang/String;Ljava/lang/Exception;)V
...
.method static logIfAutoAppLinkEnabled()V
    ...
    const-string v1, "logIfAutoAppLinkEnabled"
    ...
    const-string v8, "com.facebook.sdk.AutoAppLinkEnabled"
    ...
    new-instance v7, Lcom/facebook/appevents/InternalAppEventsLogger;

    invoke-direct {v7, v6}, Lcom/facebook/appevents/InternalAppEventsLogger;-><init>(Landroid/content/Context;)V
    ...
    sget-object v8, Lcom/facebook/UserSettingsManager;->TAG:Ljava/lang/String;
    ...
    :try_start_a
    invoke-virtual {v7, v5, v6}, Lcom/facebook/appevents/InternalAppEventsLogger;->logEvent(Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_a
...
.method private static logIfSDKSettingsChanged()V
    ...
    const-string v1, "logIfSDKSettingsChanged"
    ...
    sget-object v6, Lcom/facebook/UserSettingsManager;->autoInitEnabled:Lcom/facebook/UserSettingsManager$UserSetting;
    ...
    invoke-virtual {v8}, Lcom/facebook/UserSettingsManager$UserSetting;->getValue()Z
    ...
    sget-object v8, Lcom/facebook/UserSettingsManager;->advertiserIDCollectionEnabled:Lcom/facebook/UserSettingsManager$UserSetting;
    ...
    const-string v11, "com.facebook.sdk.USER_SETTINGS_BITMASK"
    ...
    sget-object v12, Lcom/facebook/UserSettingsManager;->userSettingPref:Landroid/content/SharedPreferences;
    ...
    invoke-interface {v12, v11, v6}, Landroid/content/SharedPreferences$Editor;->putInt(Ljava/lang/String;I)Landroid/content/SharedPreferences$Editor;
    ...
    const-string v14, "com.facebook.sdk.AutoInitEnabled"

    aput-object v14, v13, v7

    const-string v14, "com.facebook.sdk.AutoLogAppEventsEnabled"

    aput-object v14, v13, v9

    const-string v14, "com.facebook.sdk.AdvertiserIDCollectionEnabled"

    aput-object v14, v13, v10

    new-array v12, v12, [Z

    aput-boolean v9, v12, v7
    ...
    invoke-virtual/range {v0 .. v2}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z
    ...
    :goto_2
    new-instance v9, Lcom/facebook/appevents/InternalAppEventsLogger;

    invoke-direct {v9, v5}, Lcom/facebook/appevents/InternalAppEventsLogger;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v5, v7, v15}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V
    ...
    const-string v6, "fb_sdk_settings_changed"

    invoke-virtual {v9, v6, v5}, Lcom/facebook/appevents/InternalAppEventsLogger;->logEventImplicitly(Ljava/lang/String;Landroid/os/Bundle;)V
...
.method private static logWarnings()V
    ...
    const-string v7, "Please set a value for AutoLogAppEventsEnabled. Set the flag to TRUE if you want to collect app install, app launch and in-app purchase events automatically. To request user consent before collecting data, set the flag value to FALSE, then change to TRUE once user consent is received. Learn more: https://developers.facebook.com/docs/app-events/getting-started-app-events-android#disable-auto-events."
    :try_end_7
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_7 .. :try_end_7} :catch_0
    ...
    const-string v6, "You haven\'t set a value for AdvertiserIDCollectionEnabled. Set the flag to TRUE if you want to collect Advertiser ID for better advertising and analytics results. To request user consent before collecting data, set the flag value to FALSE, then change to TRUE once user consent is received. Learn more: https://developers.facebook.com/docs/app-events/getting-started-app-events-android#disable-auto-events."
    :try_end_b
    ...
    const-string v6, "The value for AdvertiserIDCollectionEnabled is currently set to FALSE so you\'re sending app events without collecting Advertiser ID. This can affect the quality of your advertising and analytics results."
    :try_end_d
...
.method private static readSettingFromCache(Lcom/facebook/UserSettingsManager$UserSetting;)V
    ...
    const-string v1, "readSettingFromCache"
    ...
    :try_start_7
    iput-wide v5, p0, Lcom/facebook/UserSettingsManager$UserSetting;->lastTS:J
    :try_end_7
...
.method public static setAdvertiserIDCollectionEnabled(Z)V
    ...
    iput-object p0, v5, Lcom/facebook/UserSettingsManager$UserSetting;->value:Ljava/lang/Boolean;
...
.method private static validateInitialized()V
    ...
    const-string v1, "validateInitialized"
    ...
    :cond_0
    new-instance v5, Lcom/facebook/FacebookSdkNotInitializedException;

    const-string v6, "The UserSettingManager has not been initialized successfully"

    invoke-direct {v5, v6}, Lcom/facebook/FacebookSdkNotInitializedException;-><init>(Ljava/lang/String;)V
...
.method private static writeSettingToCache(Lcom/facebook/UserSettingsManager$UserSetting;)V
    ...
    const-string v1, "writeSettingToCache"
    ...
    iget-object v7, p0, Lcom/facebook/UserSettingsManager$UserSetting;->value:Ljava/lang/Boolean;
    :try_end_0
    ...
    :try_start_2
    iget-wide v7, p0, Lcom/facebook/UserSettingsManager$UserSetting;->lastTS:J
    :try_end_2
    ...
    :try_start_7
    invoke-interface {v6, p0, v5}, Landroid/content/SharedPreferences$Editor;->putString(Ljava/lang/String;Ljava/lang/String;)Landroid/content/SharedPreferences$Editor;

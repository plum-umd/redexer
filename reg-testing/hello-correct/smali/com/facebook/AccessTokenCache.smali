...
.method private getCachedAccessToken()Lcom/facebook/AccessToken;
    ...
    const-string v0, "Lcom/facebook/AccessTokenCache;"

    const-string v1, "getCachedAccessToken"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Lcom/facebook/AccessTokenCache;->sharedPreferences:Landroid/content/SharedPreferences;

    const/4 v6, 0x0

    const-string v7, "com.facebook.AccessTokenManager.CachedAccessToken"
    ...
    invoke-static {v7}, Lcom/facebook/AccessToken;->createFromJSONObject(Lorg/json/JSONObject;)Lcom/facebook/AccessToken;
...
.method private getLegacyAccessToken()Lcom/facebook/AccessToken;
    ...
    const-string v1, "getLegacyAccessToken"
    ...
    invoke-virtual {v5}, Lcom/facebook/LegacyTokenHelper;->load()Landroid/os/Bundle;

    move-result-object v5

    if-eqz v5, :cond_0

    invoke-static {v5}, Lcom/facebook/LegacyTokenHelper;->hasTokenInformation(Landroid/os/Bundle;)Z

    move-result v6

    if-eqz v6, :cond_0

    invoke-static {v5}, Lcom/facebook/AccessToken;->createFromLegacyCache(Landroid/os/Bundle;)Lcom/facebook/AccessToken;
...
.method private hasCachedAccessToken()Z
    ...
    const-string v1, "hasCachedAccessToken"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Lcom/facebook/AccessTokenCache;->sharedPreferences:Landroid/content/SharedPreferences;

    const-string v6, "com.facebook.AccessTokenManager.CachedAccessToken"
...
.method private shouldCheckLegacyToken()Z
    ...
    const-string v1, "shouldCheckLegacyToken"
...
.method public clear()V
    ...
    invoke-virtual {v5}, Lcom/facebook/LegacyTokenHelper;->clear()V
...
.method public load()Lcom/facebook/AccessToken;
    ...
    invoke-virtual {p0, v5}, Lcom/facebook/AccessTokenCache;->save(Lcom/facebook/AccessToken;)V

    invoke-direct {p0}, Lcom/facebook/AccessTokenCache;->getTokenCachingStrategy()Lcom/facebook/LegacyTokenHelper;

    move-result-object v6

    invoke-virtual {v6}, Lcom/facebook/LegacyTokenHelper;->clear()V

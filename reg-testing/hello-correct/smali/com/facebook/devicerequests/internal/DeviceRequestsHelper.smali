...
.method public static cleanUpAdvertisementService(Ljava/lang/String;)V
    ...
    const-string v0, "Lcom/facebook/devicerequests/internal/DeviceRequestsHelper;"

    const-string v1, "cleanUpAdvertisementService"
...
.method private static cleanUpAdvertisementServiceImpl(Ljava/lang/String;)V
    ...
    const-string v1, "cleanUpAdvertisementServiceImpl"
    ...
    const-string v0, "Landroid/net/nsd/NsdManager;"
    ...
    :try_start_0
    invoke-virtual {v6, v5}, Landroid/net/nsd/NsdManager;->unregisterService(Landroid/net/nsd/NsdManager$RegistrationListener;)V
    :try_end_0
    ...
    sget-object v6, Lcom/facebook/devicerequests/internal/DeviceRequestsHelper;->TAG:Ljava/lang/String;
...
.method public static generateQRCode(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v10, v5}, Ljava/util/EnumMap;-><init>(Ljava/lang/Class;)V
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/common/BitMatrix;->getHeight()I

    move-result v19

    move-object/from16 v0, p0

    invoke-virtual/range {v0 .. v0}, Lcom/google/zxing/common/BitMatrix;->getWidth()I
    ...
    invoke-virtual/range {v0 .. v2}, Lcom/google/zxing/common/BitMatrix;->get(II)Z
...
.method public static isAvailable()Z
    ...
    invoke-virtual {v5}, Lcom/facebook/internal/FetchedAppSettings;->getSmartLoginOptions()Ljava/util/EnumSet;

    move-result-object v5

    sget-object v6, Lcom/facebook/internal/SmartLoginOption;->Enabled:Lcom/facebook/internal/SmartLoginOption;
...
.method public static startAdvertisementService(Ljava/lang/String;)Z
    ...
    const-string v1, "startAdvertisementService"
...
.method private static startAdvertisementServiceImpl(Ljava/lang/String;)Z
    ...
    const-string v1, "startAdvertisementServiceImpl"
    ...
    invoke-virtual {v7, v8}, Landroid/net/nsd/NsdServiceInfo;->setServiceType(Ljava/lang/String;)V
    ...
    const-string v1, "setServiceName"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v7, v5}, Landroid/net/nsd/NsdServiceInfo;->setServiceName(Ljava/lang/String;)V
    ...
    const-string v1, "setPort"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v7, v8}, Landroid/net/nsd/NsdServiceInfo;->setPort(I)V
    ...
    const-string v9, "servicediscovery"
    ...
    new-instance v9, Lcom/facebook/devicerequests/internal/DeviceRequestsHelper$1;

    invoke-direct {v9, v5, p0}, Lcom/facebook/devicerequests/internal/DeviceRequestsHelper$1;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v5, p0, v9}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v8, v7, v6, v9}, Landroid/net/nsd/NsdManager;->registerService(Landroid/net/nsd/NsdServiceInfo;ILandroid/net/nsd/NsdManager$RegistrationListener;)V

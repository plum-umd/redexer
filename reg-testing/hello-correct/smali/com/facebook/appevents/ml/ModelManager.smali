...
.field public static final MODEL_ADDRESS_DETECTION:Ljava/lang/String; = "DATA_DETECTION_ADDRESS"
...
.method static synthetic access$000()Lorg/json/JSONObject;
    ...
    const-string v0, "Lcom/facebook/appevents/ml/ModelManager;"
...
.method static synthetic access$100()Landroid/content/SharedPreferences;
    ...
    sget-object v5, Lcom/facebook/appevents/ml/ModelManager;->shardPreferences:Landroid/content/SharedPreferences;
...
.method static synthetic access$400()Ljava/util/concurrent/ConcurrentMap;
    ...
    sget-object v5, Lcom/facebook/appevents/ml/ModelManager;->models:Ljava/util/concurrent/ConcurrentMap;
...
.method private static addModelsFromModelJson(Lorg/json/JSONObject;)V
    ...
    const-string v1, "addModelsFromModelJson"
    ...
    :try_start_5
    invoke-static {v7}, Lcom/facebook/appevents/ml/ModelManager;->jsonObjectToModel(Lorg/json/JSONObject;)Lcom/facebook/appevents/ml/Model;
    ...
    :cond_0
    sget-object v8, Lcom/facebook/appevents/ml/ModelManager;->models:Ljava/util/concurrent/ConcurrentMap;
    :try_end_5
    ...
    :try_start_6
    invoke-interface {v8, v6, v7}, Ljava/util/concurrent/ConcurrentMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_6
...
.method public static enablePIIFiltering()V
    .locals 7
    ...
    const-string v1, "enablePIIFiltering"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-object v5, Lcom/facebook/appevents/ml/ModelManager;->models:Ljava/util/concurrent/ConcurrentMap;

    const-string v6, "DATA_DETECTION_ADDRESS"
    ...
    :cond_0
    sget-object v5, Lcom/facebook/internal/FeatureManager$Feature;->PIIFiltering:Lcom/facebook/internal/FeatureManager$Feature;
...
.method private static enableSuggestedEvents()V
    ...
    const-string v1, "enableSuggestedEvents"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-object v5, Lcom/facebook/appevents/ml/ModelManager;->models:Ljava/util/concurrent/ConcurrentMap;

    const-string v6, "SUGGEST_EVENT"
...
.method private static fetchFromServer()Lorg/json/JSONObject;
    ...
    const-string v1, "fetchFromServer"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Ljava/util/ArrayList;

    sget-object v6, Lcom/facebook/appevents/ml/ModelManager;->APP_SETTING_FIELDS:[Ljava/lang/String;
    ...
    invoke-static {v8, v7, v8}, Lcom/facebook/GraphRequest;->newGraphPathRequest(Lcom/facebook/AccessToken;Ljava/lang/String;Lcom/facebook/GraphRequest$Callback;)Lcom/facebook/GraphRequest;

    move-result-object v7

    invoke-virtual {v7, v5}, Lcom/facebook/GraphRequest;->setSkipClientToken(Z)V

    invoke-virtual {v7, v6}, Lcom/facebook/GraphRequest;->setParameters(Landroid/os/Bundle;)V
    ...
    :cond_0
    invoke-static {v5}, Lcom/facebook/appevents/ml/ModelManager;->parseRawJsonObject(Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method public static getRuleFile(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-interface {v5, p0}, Ljava/util/concurrent/ConcurrentMap;->containsKey(Ljava/lang/Object;)Z
...
.method public static initialize()V
    ...
    sput-object v5, Lcom/facebook/appevents/ml/ModelManager;->shardPreferences:Landroid/content/SharedPreferences;
...
.method private static initializeModels()V
    ...
    const-string v1, "initializeModels"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Lcom/facebook/appevents/ml/ModelManager$1;

    invoke-direct {v5}, Lcom/facebook/appevents/ml/ModelManager$1;-><init>()V
...
.method private static jsonObjectToModel(Lorg/json/JSONObject;)Lcom/facebook/appevents/ml/Model;
    ...
    const-string v1, "jsonObjectToModel"
    ...
    invoke-static {v6}, Lcom/facebook/appevents/ml/ModelManager;->parseJsonArray(Lorg/json/JSONArray;)[F

    move-result-object v12

    move-object v7, p0

    invoke-direct/range {v7 .. v12}, Lcom/facebook/appevents/ml/Model;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;[F)V
    :try_end_b
...
.method private static parseRawJsonObject(Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    const-string v1, "parseRawJsonObject"

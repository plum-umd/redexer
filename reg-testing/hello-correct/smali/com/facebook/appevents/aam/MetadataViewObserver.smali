...
.method static synthetic access$000(Lcom/facebook/appevents/aam/MetadataViewObserver;Landroid/view/View;)V
    ...
    const-string v0, "Lcom/facebook/appevents/aam/MetadataViewObserver;"
...
.method private getRootView()Landroid/view/View;
    ...
    iget-object v5, p0, Lcom/facebook/appevents/aam/MetadataViewObserver;->activityWeakReference:Ljava/lang/ref/WeakReference;
...
.method private process(Landroid/view/View;)V
    ...
    new-instance v5, Lcom/facebook/appevents/aam/MetadataViewObserver$1;

    invoke-direct {v5, p0, p1}, Lcom/facebook/appevents/aam/MetadataViewObserver$1;-><init>(Lcom/facebook/appevents/aam/MetadataViewObserver;Landroid/view/View;)V

    invoke-direct {p0, v5}, Lcom/facebook/appevents/aam/MetadataViewObserver;->runOnUIThread(Ljava/lang/Runnable;)V
...
.method private processEditText(Landroid/view/View;)V
    ...
    const-string v1, "processEditText"
    ...
    iget-object v6, p0, Lcom/facebook/appevents/aam/MetadataViewObserver;->processedText:Ljava/util/Set;
    ...
    check-cast v10, Lcom/facebook/appevents/aam/MetadataRule;

    invoke-virtual {v10}, Lcom/facebook/appevents/aam/MetadataRule;->getValRule()Ljava/lang/String;

    move-result-object v11

    invoke-static {v5, v11}, Lcom/facebook/appevents/aam/MetadataMatcher;->matchValue(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-virtual {v10}, Lcom/facebook/appevents/aam/MetadataRule;->getKeyRules()Ljava/util/List;

    move-result-object v11

    invoke-static {v8, v11}, Lcom/facebook/appevents/aam/MetadataMatcher;->matchIndicator(Ljava/util/List;Ljava/util/List;)Z

    move-result v11

    if-eqz v11, :cond_3

    invoke-virtual {v10}, Lcom/facebook/appevents/aam/MetadataRule;->getName()Ljava/lang/String;
    ...
    :cond_4
    invoke-static {v11}, Lcom/facebook/appevents/codeless/internal/ViewHierarchy;->getChildrenOfView(Landroid/view/View;)Ljava/util/List;
    ...
    invoke-static {v12}, Lcom/facebook/appevents/aam/MetadataMatcher;->getTextIndicators(Landroid/view/View;)Ljava/util/List;
    ...
    invoke-static {v9, v11}, Lcom/facebook/appevents/aam/MetadataMatcher;->matchIndicator(Ljava/util/List;Ljava/util/List;)Z
    ...
    :cond_7
    invoke-static {v6}, Lcom/facebook/appevents/InternalAppEventsLogger;->setInternalUserData(Ljava/util/Map;)V
...
.method private runOnUIThread(Ljava/lang/Runnable;)V
    ...
    :cond_0
    iget-object v5, p0, Lcom/facebook/appevents/aam/MetadataViewObserver;->uiThreadHandler:Landroid/os/Handler;
...
.method private startTracking()V
    ...
    iget-object v5, p0, Lcom/facebook/appevents/aam/MetadataViewObserver;->isTracking:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-string v1, "addOnGlobalFocusChangeListener"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v5, p0}, Landroid/view/ViewTreeObserver;->addOnGlobalFocusChangeListener(Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;)V
...
.method static startTrackingActivity(Landroid/app/Activity;)V
    ...
    const-string v1, "startTrackingActivity"
    ...
    sget-object v6, Lcom/facebook/appevents/aam/MetadataViewObserver;->observers:Ljava/util/Map;
    ...
    new-instance v5, Lcom/facebook/appevents/aam/MetadataViewObserver;

    invoke-direct {v5, p0}, Lcom/facebook/appevents/aam/MetadataViewObserver;-><init>(Landroid/app/Activity;)V
    ...
    check-cast v5, Lcom/facebook/appevents/aam/MetadataViewObserver;

    :goto_0
    invoke-direct {v5}, Lcom/facebook/appevents/aam/MetadataViewObserver;->startTracking()V
...
.method private stopTracking()V
    ...
    const-string v1, "removeOnGlobalFocusChangeListener"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v5, p0}, Landroid/view/ViewTreeObserver;->removeOnGlobalFocusChangeListener(Landroid/view/ViewTreeObserver$OnGlobalFocusChangeListener;)V
...
.method static stopTrackingActivity(Landroid/app/Activity;)V
    ...
    const-string v1, "stopTrackingActivity"

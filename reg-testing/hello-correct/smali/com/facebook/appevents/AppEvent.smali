...
.method private calculateChecksum()Ljava/lang/String;
    ...
    const-string v0, "Lcom/facebook/appevents/AppEvent;"

    const-string v1, "calculateChecksum"
    ...
    invoke-static {v5}, Lcom/facebook/appevents/AppEvent;->md5Checksum(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v8, p0, Lcom/facebook/appevents/AppEvent;->jsonObject:Lorg/json/JSONObject;
...
.method private getJSONObjectForAppEvent(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Double;Landroid/os/Bundle;Ljava/util/UUID;)Lorg/json/JSONObject;
    ...
    const-string v1, "getJSONObjectForAppEvent"
    ...
    const-string v6, "_eventName_md5"
    ...
    invoke-virtual {v5, p3, p1, p2}, Lorg/json/JSONObject;->put(Ljava/lang/String;D)Lorg/json/JSONObject;
...
.method private static md5Checksum(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v5, "Failed to generate checksum: "
    ...
    :try_start_5
    invoke-virtual {v6, p0, v7, v8}, Ljava/security/MessageDigest;->update([BII)V
    :try_end_5
...
.method private validateParameters(Landroid/os/Bundle;)Ljava/util/Map;
    ...
    const-string v1, "validateParameters"
    ...
    invoke-static {v7}, Lcom/facebook/appevents/AppEvent;->validateIdentifier(Ljava/lang/String;)V
    ...
    :cond_2
    invoke-static {v5}, Lcom/facebook/appevents/restrictivedatafilter/AddressFilterManager;->processParameters(Ljava/util/Map;)V

    iget-object p1, p0, Lcom/facebook/appevents/AppEvent;->name:Ljava/lang/String;

    invoke-static {v5, p1}, Lcom/facebook/appevents/restrictivedatafilter/RestrictiveDataManager;->processParameters(Ljava/util/Map;Ljava/lang/String;)V

    iget-object p1, p0, Lcom/facebook/appevents/AppEvent;->name:Ljava/lang/String;

    invoke-static {v5, p1}, Lcom/facebook/appevents/eventdeactivation/EventDeactivationManager;->processDeprecatedParameters(Ljava/util/Map;Ljava/lang/String;)V
...
.method private writeReplace()Ljava/lang/Object;
    ...
    new-instance v11, Lcom/facebook/appevents/AppEvent$SerializationProxyV2;
    ...
    iget-boolean v7, p0, Lcom/facebook/appevents/AppEvent;->isImplicit:Z

    iget-boolean v8, p0, Lcom/facebook/appevents/AppEvent;->inBackground:Z

    iget-object v9, p0, Lcom/facebook/appevents/AppEvent;->checksum:Ljava/lang/String;

    const/4 v10, 0x0

    move-object v5, v11

    invoke-direct/range {v5 .. v10}, Lcom/facebook/appevents/AppEvent$SerializationProxyV2;-><init>(Ljava/lang/String;ZZLjava/lang/String;Lcom/facebook/appevents/AppEvent$1;)V
...
.method public getIsImplicit()Z
    ...
    const-string v1, "getIsImplicit"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-boolean v5, p0, Lcom/facebook/appevents/AppEvent;->isImplicit:Z
...
.method public getName()Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/facebook/appevents/AppEvent;->name:Ljava/lang/String;
...
.method public isChecksumValid()Z
    ...
    const-string v1, "isChecksumValid"
    ...
    iget-object v6, p0, Lcom/facebook/appevents/AppEvent;->checksum:Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v6, "\"%s\", implicit: %b, json: %s"

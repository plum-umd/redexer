...
.method private static getPurchaseLoggingParameters(Ljava/lang/String;Ljava/lang/String;)Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger$PurchaseLoggingParameters;
    ...
    const-string v0, "Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger;"

    const-string v1, "getPurchaseLoggingParameters"
    ...
    invoke-static {p0, p1, v5}, Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger;->getPurchaseLoggingParameters(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger$PurchaseLoggingParameters;
...
.method private static getPurchaseLoggingParameters(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger$PurchaseLoggingParameters;
    ...
    invoke-direct {p1, v6}, Landroid/os/Bundle;-><init>(I)V
    ...
    :try_start_2
    invoke-virtual {p1, v6, v7}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V
    :try_end_2
    ...
    :try_start_14
    invoke-virtual {p1, v7, v6}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V
    :try_end_14
    ...
    const-string v5, "introductoryPriceCycles"
    ...
    :try_start_34
    invoke-direct {p2, v5, p0, p1}, Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger$PurchaseLoggingParameters;-><init>(Ljava/math/BigDecimal;Ljava/util/Currency;Landroid/os/Bundle;)V
    :try_end_34
...
.method public static isImplicitPurchaseLoggingEnabled()Z
    ...
    const-string v1, "isImplicitPurchaseLoggingEnabled"
    ...
    invoke-virtual {v5}, Lcom/facebook/internal/FetchedAppSettings;->getIAPAutomaticLoggingEnabled()Z
...
.method public static logActivateAppEvent()V
    ...
    const-string v1, "logActivateAppEvent"
    ...
    invoke-static {v5, v8}, Lcom/facebook/internal/Validate;->notNull(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6}, Lcom/facebook/appevents/AppEventsLogger;->activateApp(Landroid/app/Application;Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    sget-object v5, Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger;->TAG:Ljava/lang/String;

    const-string v6, "Automatic logging of basic events will not happen, because FacebookSdk.getApplicationContext() returns object that is not instance of android.app.Application. Make sure you call FacebookSdk.sdkInitialize() from Application class and pass application context."
...
.method public static logActivityTimeSpentEvent(Ljava/lang/String;J)V
    ...
    const-string v1, "logActivityTimeSpentEvent"
    ...
    invoke-static {v5, v7}, Lcom/facebook/internal/Validate;->notNull(Ljava/lang/Object;Ljava/lang/String;)V

    const/4 v7, 0x0

    invoke-static {v6, v7}, Lcom/facebook/internal/FetchedAppSettingsManager;->queryAppSettings(Ljava/lang/String;Z)Lcom/facebook/internal/FetchedAppSettings;

    move-result-object v6

    if-eqz v6, :cond_0

    invoke-virtual {v6}, Lcom/facebook/internal/FetchedAppSettings;->getAutomaticLoggingEnabled()Z
    ...
    const-string v7, "fb_aa_time_spent_view_name"
    ...
    invoke-virtual {v5, v7, p0}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v6, p2, p0, p1, v5}, Lcom/facebook/appevents/InternalAppEventsLogger;->logEvent(Ljava/lang/String;DLandroid/os/Bundle;)V
...
.method static logPurchase(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-static {v6, p2, v5}, Lcom/facebook/internal/FetchedAppGateKeepersManager;->getGateKeeperForKey(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    iget-object v5, p0, Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger$PurchaseLoggingParameters;->purchaseAmount:Ljava/math/BigDecimal;

    iget-object v6, p0, Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger$PurchaseLoggingParameters;->currency:Ljava/util/Currency;
    ...
    invoke-virtual {p2, p1, v5, v6, p0}, Lcom/facebook/appevents/InternalAppEventsLogger;->logEventImplicitly(Ljava/lang/String;Ljava/math/BigDecimal;Ljava/util/Currency;Landroid/os/Bundle;)V
    ...
    iget-object v5, p0, Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger$PurchaseLoggingParameters;->currency:Ljava/util/Currency;

    iget-object p0, p0, Lcom/facebook/appevents/internal/AutomaticAnalyticsLogger$PurchaseLoggingParameters;->param:Landroid/os/Bundle;

    invoke-virtual {p1, p2, v5, p0}, Lcom/facebook/appevents/InternalAppEventsLogger;->logPurchaseImplicitly(Ljava/math/BigDecimal;Ljava/util/Currency;Landroid/os/Bundle;)V

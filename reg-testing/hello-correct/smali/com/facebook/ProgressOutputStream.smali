...
.method static synthetic access$000(Lcom/facebook/ProgressOutputStream;)Lcom/facebook/GraphRequestBatch;
    ...
    const-string v0, "Lcom/facebook/ProgressOutputStream;"
...
.method private addProgress(J)V
    ...
    iget-object v5, p0, Lcom/facebook/ProgressOutputStream;->currentRequestProgress:Lcom/facebook/RequestProgress;

    if-eqz v5, :cond_0

    invoke-virtual {v5, p1, p2}, Lcom/facebook/RequestProgress;->addProgress(J)V
    ...
    iput-wide v5, p0, Lcom/facebook/ProgressOutputStream;->batchProgress:J

    iget-wide p1, p0, Lcom/facebook/ProgressOutputStream;->batchProgress:J

    iget-wide v5, p0, Lcom/facebook/ProgressOutputStream;->lastReportedProgress:J

    iget-wide v7, p0, Lcom/facebook/ProgressOutputStream;->threshold:J
...
.method private reportBatchProgress()V
    ...
    const-string v1, "reportBatchProgress"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-wide v5, p0, Lcom/facebook/ProgressOutputStream;->batchProgress:J

    iget-wide v7, p0, Lcom/facebook/ProgressOutputStream;->lastReportedProgress:J
    ...
    invoke-virtual {v5}, Lcom/facebook/GraphRequestBatch;->getCallbacks()Ljava/util/List;
    ...
    instance-of v7, v6, Lcom/facebook/GraphRequestBatch$OnProgressCallback;

    if-eqz v7, :cond_0

    iget-object v7, p0, Lcom/facebook/ProgressOutputStream;->requests:Lcom/facebook/GraphRequestBatch;
    ...
    check-cast v8, Lcom/facebook/GraphRequestBatch$OnProgressCallback;

    if-nez v7, :cond_1

    iget-object v9, p0, Lcom/facebook/ProgressOutputStream;->requests:Lcom/facebook/GraphRequestBatch;

    iget-wide v10, p0, Lcom/facebook/ProgressOutputStream;->batchProgress:J

    iget-wide v12, p0, Lcom/facebook/ProgressOutputStream;->maxProgress:J
    ...
    invoke-interface/range {v8 .. v13}, Lcom/facebook/GraphRequestBatch$OnProgressCallback;->onBatchProgress(Lcom/facebook/GraphRequestBatch;JJ)V
    ...
    :cond_1
    new-instance v6, Lcom/facebook/ProgressOutputStream$1;

    invoke-direct {v6, p0, v8}, Lcom/facebook/ProgressOutputStream$1;-><init>(Lcom/facebook/ProgressOutputStream;Lcom/facebook/GraphRequestBatch$OnProgressCallback;)V
    ...
    iput-wide v5, p0, Lcom/facebook/ProgressOutputStream;->lastReportedProgress:J
...
.method public close()V
    ...
    const-string v0, "Ljava/io/FilterOutputStream;"
    ...
    iget-object v5, p0, Lcom/facebook/ProgressOutputStream;->progressMap:Ljava/util/Map;
    ...
    check-cast v6, Lcom/facebook/RequestProgress;

    invoke-virtual {v6}, Lcom/facebook/RequestProgress;->reportProgress()V
...
.method getBatchProgress()J
    ...
    const-string v1, "getBatchProgress"
...
.method public write(I)V
    ...
    iget-object v5, p0, Lcom/facebook/ProgressOutputStream;->out:Ljava/io/OutputStream;
    ...
    invoke-direct {p0, v5, v6}, Lcom/facebook/ProgressOutputStream;->addProgress(J)V

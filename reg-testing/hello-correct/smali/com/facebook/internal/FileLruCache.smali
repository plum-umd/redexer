...
.method static synthetic access$000(Lcom/facebook/internal/FileLruCache;)Ljava/util/concurrent/atomic/AtomicLong;
    ...
    const-string v0, "Lcom/facebook/internal/FileLruCache;"
...
.method static synthetic access$300()Ljava/util/concurrent/atomic/AtomicLong;
    ...
    sget-object v5, Lcom/facebook/internal/FileLruCache;->bufferIndex:Ljava/util/concurrent/atomic/AtomicLong;
...
.method private renameToTargetAndTrim(Ljava/lang/String;Ljava/io/File;)V
    ...
    const-string v1, "renameToTargetAndTrim"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Ljava/io/File;

    iget-object v6, p0, Lcom/facebook/internal/FileLruCache;->directory:Ljava/io/File;
...
.method public clearCache()V
    ...
    iget-object v6, p0, Lcom/facebook/internal/FileLruCache;->lastClearCacheTime:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    new-instance v7, Lcom/facebook/internal/FileLruCache$2;

    invoke-direct {v7, p0, v5}, Lcom/facebook/internal/FileLruCache$2;-><init>(Lcom/facebook/internal/FileLruCache;[Ljava/io/File;)V
...
.method public get(Ljava/lang/String;)Ljava/io/InputStream;
    ...
    invoke-virtual {p0, p1, v5}, Lcom/facebook/internal/FileLruCache;->get(Ljava/lang/String;Ljava/lang/String;)Ljava/io/InputStream;
...
.method public get(Ljava/lang/String;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    :try_start_1
    invoke-static {v8}, Lcom/facebook/internal/FileLruCache$StreamHeader;->readHeader(Ljava/io/InputStream;)Lorg/json/JSONObject;
    ...
    :try_start_7
    invoke-virtual {v7, p1, v6}, Lorg/json/JSONObject;->optString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v10, "Setting lastModified to "
    :try_end_c
    ...
    :try_start_14
    invoke-static {v6, v7, v9}, Lcom/facebook/internal/Logger;->log(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_14
    ...
    :try_start_15
    invoke-virtual {v5, p1, p2}, Ljava/io/File;->setLastModified(J)Z
    :try_end_15
...
.method public interceptAndPut(Ljava/lang/String;Ljava/io/InputStream;)Ljava/io/InputStream;
    ...
    const-string v1, "interceptAndPut"
    ...
    new-instance v5, Lcom/facebook/internal/FileLruCache$CopyingInputStream;

    invoke-direct {v5, p2, p1}, Lcom/facebook/internal/FileLruCache$CopyingInputStream;-><init>(Ljava/io/InputStream;Ljava/io/OutputStream;)V
...
.method public openPutStream(Ljava/lang/String;)Ljava/io/OutputStream;
    ...
    const-string v1, "openPutStream"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    const/4 v5, 0x0

    invoke-virtual {p0, p1, v5}, Lcom/facebook/internal/FileLruCache;->openPutStream(Ljava/lang/String;Ljava/lang/String;)Ljava/io/OutputStream;
...
.method public openPutStream(Ljava/lang/String;Ljava/lang/String;)Ljava/io/OutputStream;
    ...
    invoke-static {v5}, Lcom/facebook/internal/FileLruCache$BufferFile;->newFile(Ljava/io/File;)Ljava/io/File;
    ...
    new-instance v13, Lcom/facebook/internal/FileLruCache$1;
    ...
    invoke-direct/range {v6 .. v11}, Lcom/facebook/internal/FileLruCache$1;-><init>(Lcom/facebook/internal/FileLruCache;JLjava/io/File;Ljava/lang/String;)V

    new-instance v6, Lcom/facebook/internal/FileLruCache$CloseCallbackOutputStream;

    invoke-direct {v6, v12, v13}, Lcom/facebook/internal/FileLruCache$CloseCallbackOutputStream;-><init>(Ljava/io/OutputStream;Lcom/facebook/internal/FileLruCache$StreamCloseCallback;)V
    ...
    invoke-static/range {v0 .. v0}, Lcom/facebook/internal/Utility;->isNullOrEmpty(Ljava/lang/String;)Z
    ...
    :cond_0
    invoke-static {v7, v6}, Lcom/facebook/internal/FileLruCache$StreamHeader;->writeHeader(Ljava/io/OutputStream;Lorg/json/JSONObject;)V
    ...
    invoke-static/range {v0 .. v3}, Lcom/facebook/internal/Logger;->log(Lcom/facebook/LoggingBehavior;ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v1}, Ljava/io/IOException;-><init>(Ljava/lang/String;)V
    :try_end_a
    .catchall {:try_start_a .. :try_end_a} :catchall_0
    ...
    const-string v0, "Ljava/io/BufferedOutputStream;"
    ...
    const-string v8, "Error creating buffer output stream: "
    ...
    const-string v5, "Could not create file at "
...
.method public toString()Ljava/lang/String;
    ...
    const-string v6, "{FileLruCache: tag:"
    ...
    iget-object v6, p0, Lcom/facebook/internal/FileLruCache;->tag:Ljava/lang/String;

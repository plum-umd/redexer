...
.method public static addAttachments(Ljava/util/Collection;)V
    ...
    const-string v0, "Lcom/facebook/internal/NativeAppCallAttachmentStore;"
    ...
    :try_start_4
    check-cast v6, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;

    invoke-static {v6}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->access$100(Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;)Z
    ...
    :cond_3
    invoke-static {v6}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->access$200(Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;)Ljava/util/UUID;

    move-result-object v7

    invoke-static {v6}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->access$300(Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;)Ljava/lang/String;

    move-result-object v8

    const/4 v9, 0x1

    invoke-static {v7, v8, v9}, Lcom/facebook/internal/NativeAppCallAttachmentStore;->getAttachmentFile(Ljava/util/UUID;Ljava/lang/String;Z)Ljava/io/File;
    ...
    invoke-static {v6}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->access$400(Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v7}, Lcom/facebook/internal/NativeAppCallAttachmentStore;->processAttachmentBitmap(Landroid/graphics/Bitmap;Ljava/io/File;)V

    goto/16 :goto_0

    :cond_4
    invoke-static {v6}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->access$500(Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;)Landroid/net/Uri;
    ...
    invoke-static {v6}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;->access$600(Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;)Z

    move-result v6

    invoke-static {v8, v6, v7}, Lcom/facebook/internal/NativeAppCallAttachmentStore;->processAttachmentFile(Landroid/net/Uri;ZLjava/io/File;)V
    :try_end_6
    ...
    sget-object v6, Lcom/facebook/internal/NativeAppCallAttachmentStore;->TAG:Ljava/lang/String;
    ...
    invoke-direct {v5, p0}, Lcom/facebook/FacebookException;-><init>(Ljava/lang/Throwable;)V
...
.method public static cleanupAllAttachments()V
    ...
    const-string v1, "cleanupAllAttachments"
    ...
    invoke-static {v5}, Lcom/facebook/internal/Utility;->deleteDirectory(Ljava/io/File;)V
...
.method public static cleanupAttachmentsForCall(Ljava/util/UUID;)V
    ...
    const-string v1, "cleanupAttachmentsForCall"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    const/4 v5, 0x0

    invoke-static {p0, v5}, Lcom/facebook/internal/NativeAppCallAttachmentStore;->getAttachmentsDirectoryForCall(Ljava/util/UUID;Z)Ljava/io/File;
...
.method public static createAttachment(Ljava/util/UUID;Landroid/graphics/Bitmap;)Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;
    ...
    const-string v1, "createAttachment"
    ...
    const-string v5, "attachmentBitmap"

    invoke-static {p1, v5}, Lcom/facebook/internal/Validate;->notNull(Ljava/lang/Object;Ljava/lang/String;)V

    new-instance v5, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;

    const/4 v6, 0x0

    invoke-direct {v5, p0, p1, v6, v6}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;-><init>(Ljava/util/UUID;Landroid/graphics/Bitmap;Landroid/net/Uri;Lcom/facebook/internal/NativeAppCallAttachmentStore$1;)V
...
.method public static createAttachment(Ljava/util/UUID;Landroid/net/Uri;)Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;
    ...
    invoke-direct {v5, p0, v6, p1, v6}, Lcom/facebook/internal/NativeAppCallAttachmentStore$Attachment;-><init>(Ljava/util/UUID;Landroid/graphics/Bitmap;Landroid/net/Uri;Lcom/facebook/internal/NativeAppCallAttachmentStore$1;)V
...
.method static ensureAttachmentsDirectoryExists()Ljava/io/File;
    ...
    const-string v1, "ensureAttachmentsDirectoryExists"
...
.method static getAttachmentFile(Ljava/util/UUID;Ljava/lang/String;Z)Ljava/io/File;
    ...
    const-string v1, "getAttachmentFile"
...
.method static getAttachmentsDirectoryForCall(Ljava/util/UUID;Z)Ljava/io/File;
    ...
    const-string v1, "getAttachmentsDirectoryForCall"
...
.method public static openAttachment(Ljava/util/UUID;Ljava/lang/String;)Ljava/io/File;
    ...
    const-string v1, "openAttachment"
    ...
    :try_start_0
    invoke-static {p0, p1, v5}, Lcom/facebook/internal/NativeAppCallAttachmentStore;->getAttachmentFile(Ljava/util/UUID;Ljava/lang/String;Z)Ljava/io/File;
...
.method private static processAttachmentBitmap(Landroid/graphics/Bitmap;Ljava/io/File;)V
    ...
    const-string v1, "processAttachmentBitmap"
    ...
    :try_start_1
    invoke-virtual {p0, p1, v6, v5}, Landroid/graphics/Bitmap;->compress(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    :try_end_1
...
.method private static processAttachmentFile(Landroid/net/Uri;ZLjava/io/File;)V
    ...
    const-string v1, "processAttachmentFile"
    ...
    :goto_0
    :try_start_5
    invoke-static {p1, v5}, Lcom/facebook/internal/Utility;->copyAndCloseInputStream(Ljava/io/InputStream;Ljava/io/OutputStream;)I
    :try_end_5

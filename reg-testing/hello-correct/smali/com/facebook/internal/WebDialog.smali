...
.method private createCrossImage()V
    ...
    const-string v1, "createCrossImage"
    ...
    iput-object v5, p0, Lcom/facebook/internal/WebDialog;->crossImageView:Landroid/widget/ImageView;

    iget-object v5, p0, Lcom/facebook/internal/WebDialog;->crossImageView:Landroid/widget/ImageView;

    new-instance v6, Lcom/facebook/internal/WebDialog$2;

    invoke-direct {v6, p0}, Lcom/facebook/internal/WebDialog$2;-><init>(Lcom/facebook/internal/WebDialog;)V
    ...
    sget v6, Lcom/facebook/common/R$drawable;->com_facebook_close:I
    ...
    iget-object v6, p0, Lcom/facebook/internal/WebDialog;->crossImageView:Landroid/widget/ImageView;
...
.method public static getWebDialogTheme()I
    ...
    const-string v1, "getWebDialogTheme"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-static {}, Lcom/facebook/internal/Validate;->sdkInitialized()V

    sget v5, Lcom/facebook/internal/WebDialog;->webDialogTheme:I
...
.method protected static initDefaultTheme(Landroid/content/Context;)V
    ...
    const-string v1, "initDefaultTheme"
...
.method public static newInstance(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;ILcom/facebook/internal/WebDialog$OnCompleteListener;)Lcom/facebook/internal/WebDialog;
    ...
    new-instance v11, Lcom/facebook/internal/WebDialog;
    ...
    invoke-direct/range {v5 .. v10}, Lcom/facebook/internal/WebDialog;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;ILcom/facebook/internal/WebDialog$OnCompleteListener;)V
...
.method private setUpWebView(I)V
    ...
    new-instance v6, Lcom/facebook/internal/WebDialog$3;
    ...
    invoke-direct {v6, p0, v7}, Lcom/facebook/internal/WebDialog$3;-><init>(Lcom/facebook/internal/WebDialog;Landroid/content/Context;)V

    iput-object v6, p0, Lcom/facebook/internal/WebDialog;->webView:Landroid/webkit/WebView;

    iget-object v6, p0, Lcom/facebook/internal/WebDialog;->webView:Landroid/webkit/WebView;
    ...
    const-string v1, "setVerticalScrollBarEnabled"
    ...
    const-string v1, "setHorizontalScrollBarEnabled"
    ...
    new-instance v8, Lcom/facebook/internal/WebDialog$DialogWebViewClient;

    const/4 v9, 0x0

    invoke-direct {v8, p0, v9}, Lcom/facebook/internal/WebDialog$DialogWebViewClient;-><init>(Lcom/facebook/internal/WebDialog;Lcom/facebook/internal/WebDialog$1;)V
    ...
    iget-object v9, p0, Lcom/facebook/internal/WebDialog;->url:Ljava/lang/String;
    ...
    invoke-virtual {v6, v9}, Landroid/webkit/WebView;->loadUrl(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v7}, Landroid/webkit/WebSettings;->setSavePassword(Z)V
    ...
    invoke-virtual {v6, v8}, Landroid/webkit/WebView;->setFocusableInTouchMode(Z)V
    ...
    new-instance v7, Lcom/facebook/internal/WebDialog$4;

    invoke-direct {v7, p0}, Lcom/facebook/internal/WebDialog$4;-><init>(Lcom/facebook/internal/WebDialog;)V
    ...
    invoke-virtual {v5, p1, p1, p1, p1}, Landroid/widget/LinearLayout;->setPadding(IIII)V
...
.method public static setWebDialogTheme(I)V
    ...
    const-string v1, "setWebDialogTheme"
...
.method public cancel()V
    ...
    iget-object v5, p0, Lcom/facebook/internal/WebDialog;->onCompleteListener:Lcom/facebook/internal/WebDialog$OnCompleteListener;

    if-eqz v5, :cond_0

    iget-boolean v5, p0, Lcom/facebook/internal/WebDialog;->listenerCalled:Z
    ...
    invoke-virtual {p0, v5}, Lcom/facebook/internal/WebDialog;->sendErrorToListener(Ljava/lang/Throwable;)V
...
.method public dismiss()V
    ...
    iget-object v5, p0, Lcom/facebook/internal/WebDialog;->webView:Landroid/webkit/WebView;
    ...
    :cond_0
    iget-boolean v5, p0, Lcom/facebook/internal/WebDialog;->isDetached:Z

    if-nez v5, :cond_1

    iget-object v5, p0, Lcom/facebook/internal/WebDialog;->spinner:Landroid/app/ProgressDialog;
    ...
    const-string v0, "Landroid/app/ProgressDialog;"
...
.method public getOnCompleteListener()Lcom/facebook/internal/WebDialog$OnCompleteListener;
    ...
    const-string v1, "getOnCompleteListener"
...
.method protected isPageFinished()Z
    ...
    iget-boolean v5, p0, Lcom/facebook/internal/WebDialog;->isPageFinished:Z
...
.method public onAttachedToWindow()V
    ...
    invoke-static {v5}, Lcom/facebook/internal/Utility;->mustFixWindowParamsForAutofill(Landroid/content/Context;)Z

    move-result v5

    if-eqz v5, :cond_0

    iget-object v5, p0, Lcom/facebook/internal/WebDialog;->windowParams:Landroid/view/WindowManager$LayoutParams;
    ...
    const-string v1, "getOwnerActivity"
    ...
    const-string v6, "Set token on onAttachedToWindow(): "
    ...
    iget-object v6, p0, Lcom/facebook/internal/WebDialog;->windowParams:Landroid/view/WindowManager$LayoutParams;
    ...
    const-string v6, "FacebookSDK.WebDialog"

    invoke-static {v6, v5}, Lcom/facebook/internal/Utility;->logd(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p1, v5}, Landroid/app/ProgressDialog;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p1, v5}, Landroid/app/ProgressDialog;->requestWindowFeature(I)Z
    ...
    sget v7, Lcom/facebook/common/R$string;->com_facebook_loading:I
    ...
    invoke-virtual {p1, v6}, Landroid/app/ProgressDialog;->setMessage(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v6}, Landroid/app/ProgressDialog;->setCanceledOnTouchOutside(Z)V
    ...
    new-instance v6, Lcom/facebook/internal/WebDialog$1;

    invoke-direct {v6, p0}, Lcom/facebook/internal/WebDialog$1;-><init>(Lcom/facebook/internal/WebDialog;)V
    ...
    invoke-virtual {p1, v6}, Landroid/app/ProgressDialog;->setOnCancelListener(Landroid/content/DialogInterface$OnCancelListener;)V
...
.method protected onStart()V
    ...
    iget-object v5, p0, Lcom/facebook/internal/WebDialog;->uploadTask:Lcom/facebook/internal/WebDialog$UploadStagingResourcesTask;
    ...
    invoke-virtual {v5}, Lcom/facebook/internal/WebDialog$UploadStagingResourcesTask;->getStatus()Landroid/os/AsyncTask$Status;
    ...
    invoke-virtual {v5, v6}, Lcom/facebook/internal/WebDialog$UploadStagingResourcesTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method protected onStop()V
    ...
    invoke-virtual {v5, v6}, Lcom/facebook/internal/WebDialog$UploadStagingResourcesTask;->cancel(Z)Z
...
.method protected parseResponseUri(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-static {v5}, Lcom/facebook/internal/Utility;->parseUrlQueryString(Ljava/lang/String;)Landroid/os/Bundle;
...
.method public resize()V
    ...
    invoke-direct {p0, v5, v8, v9, v10}, Lcom/facebook/internal/WebDialog;->getScaledSize(IFII)I
    ...
    invoke-direct {p0, v7, v8, v10, v9}, Lcom/facebook/internal/WebDialog;->getScaledSize(IFII)I
...
.method protected sendErrorToListener(Ljava/lang/Throwable;)V
    ...
    const-string v1, "sendErrorToListener"
    ...
    invoke-direct {v5, p1}, Lcom/facebook/FacebookException;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v5, v6, p1}, Lcom/facebook/internal/WebDialog$OnCompleteListener;->onComplete(Landroid/os/Bundle;Lcom/facebook/FacebookException;)V
...
.method protected sendSuccessToListener(Landroid/os/Bundle;)V
    ...
    const-string v1, "sendSuccessToListener"
    ...
    iget-boolean v6, p0, Lcom/facebook/internal/WebDialog;->listenerCalled:Z
    ...
    invoke-interface {v5, p1, v6}, Lcom/facebook/internal/WebDialog$OnCompleteListener;->onComplete(Landroid/os/Bundle;Lcom/facebook/FacebookException;)V
...
.method protected setExpectedRedirectUrl(Ljava/lang/String;)V
    ...
    const-string v1, "setExpectedRedirectUrl"

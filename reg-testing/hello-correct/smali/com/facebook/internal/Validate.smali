...
.method public static containsNoNullOrEmpty(Ljava/util/Collection;Ljava/lang/String;)V
    ...
    const-string v0, "Lcom/facebook/internal/Validate;"

    const-string v1, "containsNoNullOrEmpty"
...
.method public static containsNoNulls(Ljava/util/Collection;Ljava/lang/String;)V
    ...
    const-string v1, "containsNoNulls"
...
.method public static hasAppID()Ljava/lang/String;
    ...
    const-string v6, "No App ID found, please set the App ID."
...
.method public static hasBluetoothPermission(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v5}, Lcom/facebook/internal/Validate;->hasPermission(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static hasChangeWifiStatePermission(Landroid/content/Context;)Z
    ...
    const-string v1, "hasChangeWifiStatePermission"
...
.method public static hasClientToken()Ljava/lang/String;
    ...
    const-string v1, "hasClientToken"
    ...
    const-string v6, "No Client Token found, please set the Client Token."
...
.method public static hasContentProvider(Landroid/content/Context;)V
    ...
    const-string v1, "hasContentProvider"
    ...
    const-string v7, "com.facebook.app.FacebookContentProvider"
...
.method public static hasCustomTabRedirectActivity(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string v1, "hasCustomTabRedirectActivity"
    ...
    invoke-virtual {v5, v6, p1}, Landroid/content/pm/PackageManager;->queryIntentActivities(Landroid/content/Intent;I)Ljava/util/List;
...
.method public static hasFacebookActivity(Landroid/content/Context;)V
    ...
    const-string v1, "hasFacebookActivity"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    const/4 v5, 0x1

    invoke-static {p0, v5}, Lcom/facebook/internal/Validate;->hasFacebookActivity(Landroid/content/Context;Z)V
...
.method public static hasFacebookActivity(Landroid/content/Context;Z)V
    ...
    :try_start_0
    invoke-virtual {v5, v6, p0}, Landroid/content/pm/PackageManager;->getActivityInfo(Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo;
...
.method public static hasInternetPermissions(Landroid/content/Context;)V
    ...
    const-string v1, "hasInternetPermissions"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    const/4 v5, 0x1

    invoke-static {p0, v5}, Lcom/facebook/internal/Validate;->hasInternetPermissions(Landroid/content/Context;Z)V
...
.method public static hasWiFiPermission(Landroid/content/Context;)Z
    ...
    const-string v1, "hasWiFiPermission"
...
.method public static notEmptyAndContainsNoNulls(Ljava/util/Collection;Ljava/lang/String;)V
    ...
    const-string v1, "notEmptyAndContainsNoNulls"
...
.method public static notNullOrEmpty(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "notNullOrEmpty"
...
.method public static runningOnUiThread()V
    ...
    const-string v1, "runningOnUiThread"
    ...
    const-string v6, "This method should be called from the UI thread"
...
.method public static sdkInitialized()V
    ...
    const-string v6, "The SDK has not been initialized, make sure to call FacebookSdk.sdkInitialize() first."

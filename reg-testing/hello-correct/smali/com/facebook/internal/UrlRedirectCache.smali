...
.method static cacheUriRedirect(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    const-string v0, "Lcom/facebook/internal/UrlRedirectCache;"

    const-string v1, "cacheUriRedirect"
    ...
    :try_start_2
    sget-object v7, Lcom/facebook/internal/UrlRedirectCache;->REDIRECT_CONTENT_TAG:Ljava/lang/String;

    invoke-virtual {v6, p0, v7}, Lcom/facebook/internal/FileLruCache;->openPutStream(Ljava/lang/String;Ljava/lang/String;)Ljava/io/OutputStream;
...
.method static clearCache()V
    ...
    invoke-virtual {v5}, Lcom/facebook/internal/FileLruCache;->clearCache()V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v10, "clearCache failed "
    ...
    invoke-static {v6, v7, v8, v5}, Lcom/facebook/internal/Logger;->log(Lcom/facebook/LoggingBehavior;ILjava/lang/String;Ljava/lang/String;)V
...
.method static getRedirectedUri(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    const-string v1, "getRedirectedUri"
    ...
    invoke-virtual {v6, p0, v10}, Lcom/facebook/internal/FileLruCache;->get(Ljava/lang/String;Ljava/lang/String;)Ljava/io/InputStream;
    ...
    invoke-direct {p0, v10}, Ljava/io/InputStreamReader;-><init>(Ljava/io/InputStream;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    :try_start_3
    invoke-virtual {p0, v9, v7, v11}, Ljava/io/InputStreamReader;->read([CII)I
    ...
    :try_start_5
    invoke-virtual {v10, v9, v7, v11}, Ljava/lang/StringBuilder;->append([CII)Ljava/lang/StringBuilder;
    :try_end_5

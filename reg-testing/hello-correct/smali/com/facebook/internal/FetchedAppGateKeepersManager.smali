...
.method static synthetic access$000(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    const-string v0, "Lcom/facebook/internal/FetchedAppGateKeepersManager;"
...
.method private static getAppGateKeepersQueryResponse(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    const-string v1, "getAppGateKeepersQueryResponse"
    ...
    invoke-static {v7, v6, v7}, Lcom/facebook/GraphRequest;->newGraphPathRequest(Lcom/facebook/AccessToken;Ljava/lang/String;Lcom/facebook/GraphRequest$Callback;)Lcom/facebook/GraphRequest;

    move-result-object v6

    invoke-virtual {v6, p0}, Lcom/facebook/GraphRequest;->setSkipClientToken(Z)V
...
.method public static getGateKeeperForKey(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    const-string v1, "getGateKeeperForKey"
    ...
    sget-object v5, Lcom/facebook/internal/FetchedAppGateKeepersManager;->fetchedAppGateKeepers:Ljava/util/Map;
...
.method private static isTimestampValid(Ljava/lang/Long;)Z
    ...
    const-string v1, "isTimestampValid"
...
.method static loadAppGateKeepersAsync()V
    ...
    const-string v1, "loadAppGateKeepersAsync"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    const/4 v5, 0x0

    invoke-static {v5}, Lcom/facebook/internal/FetchedAppGateKeepersManager;->loadAppGateKeepersAsync(Lcom/facebook/internal/FetchedAppGateKeepersManager$Callback;)V
...
.method private static pollCallbacks()V
    ...
    :cond_0
    :goto_0
    sget-object v6, Lcom/facebook/internal/FetchedAppGateKeepersManager;->callbacks:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    check-cast v6, Lcom/facebook/internal/FetchedAppGateKeepersManager$Callback;

    if-eqz v6, :cond_0

    new-instance v7, Lcom/facebook/internal/FetchedAppGateKeepersManager$2;

    invoke-direct {v7, v6}, Lcom/facebook/internal/FetchedAppGateKeepersManager$2;-><init>(Lcom/facebook/internal/FetchedAppGateKeepersManager$Callback;)V
...
.method static queryAppGateKeepers(Ljava/lang/String;Z)Lorg/json/JSONObject;
    ...
    const-string v1, "queryAppGateKeepers"
    ...
    const-string v8, "com.facebook.internal.preferences.APP_GATEKEEPERS"

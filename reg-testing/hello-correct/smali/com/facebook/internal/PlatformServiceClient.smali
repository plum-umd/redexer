...
.method private callback(Landroid/os/Bundle;)V
    ...
    iget-boolean v5, p0, Lcom/facebook/internal/PlatformServiceClient;->running:Z
    ...
    iget-object v5, p0, Lcom/facebook/internal/PlatformServiceClient;->listener:Lcom/facebook/internal/PlatformServiceClient$CompletedListener;
    ...
    invoke-interface {v5, p1}, Lcom/facebook/internal/PlatformServiceClient$CompletedListener;->completed(Landroid/os/Bundle;)V
...
.method private sendMessage()V
    ...
    iget-object v6, p0, Lcom/facebook/internal/PlatformServiceClient;->applicationId:Ljava/lang/String;
    ...
    invoke-virtual {p0, v5}, Lcom/facebook/internal/PlatformServiceClient;->populateRequestBundle(Landroid/os/Bundle;)V
    ...
    iget v6, p0, Lcom/facebook/internal/PlatformServiceClient;->requestMessage:I
    ...
    iget v8, p0, Lcom/facebook/internal/PlatformServiceClient;->protocolVersion:I
    ...
    iget-object v8, p0, Lcom/facebook/internal/PlatformServiceClient;->handler:Landroid/os/Handler;

    invoke-direct {v5, v8}, Landroid/os/Messenger;-><init>(Landroid/os/Handler;)V

    iput-object v5, v6, Landroid/os/Message;->replyTo:Landroid/os/Messenger;

    :try_start_0
    iget-object v5, p0, Lcom/facebook/internal/PlatformServiceClient;->sender:Landroid/os/Messenger;
    :try_end_0
    ...
    :catch_0
    invoke-direct {p0, v7}, Lcom/facebook/internal/PlatformServiceClient;->callback(Landroid/os/Bundle;)V
...
.method protected getContext()Landroid/content/Context;
    ...
    iget-object v5, p0, Lcom/facebook/internal/PlatformServiceClient;->context:Landroid/content/Context;
...
.method protected handleMessage(Landroid/os/Message;)V
    ...
    iget v6, p0, Lcom/facebook/internal/PlatformServiceClient;->replyMessage:I
...
.method public start()Z
    ...
    invoke-static {v5}, Lcom/facebook/internal/NativeProtocol;->getLatestAvailableProtocolVersionForService(I)I
    ...
    invoke-static {v5}, Lcom/facebook/internal/NativeProtocol;->createPlatformServiceIntent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    iput-boolean v6, p0, Lcom/facebook/internal/PlatformServiceClient;->running:Z

    iget-object v7, p0, Lcom/facebook/internal/PlatformServiceClient;->context:Landroid/content/Context;
    ...
    invoke-virtual {v7, v5, p0, v6}, Landroid/content/Context;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z

...
.method static synthetic access$000(Lcom/facebook/login/LoginFragment;Lcom/facebook/login/LoginClient$Result;)V
    ...
    const-string v0, "Lcom/facebook/login/LoginFragment;"
...
.method private initializeCallingPackage(Landroid/app/Activity;)V
    ...
    const-string v1, "initializeCallingPackage"
...
.method private onLoginClientCompleted(Lcom/facebook/login/LoginClient$Result;)V
    ...
    const-string v1, "onLoginClientCompleted"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    const/4 v5, 0x0

    iput-object v5, p0, Lcom/facebook/login/LoginFragment;->request:Lcom/facebook/login/LoginClient$Request;

    iget-object v5, p1, Lcom/facebook/login/LoginClient$Result;->code:Lcom/facebook/login/LoginClient$Result$Code;
    ...
    invoke-virtual {v6, v5, p1}, Landroidx/fragment/app/FragmentActivity;->setResult(ILandroid/content/Intent;)V
...
.method protected createLoginClient()Lcom/facebook/login/LoginClient;
    ...
    const-string v1, "createLoginClient"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Lcom/facebook/login/LoginClient;

    invoke-direct {v5, p0}, Lcom/facebook/login/LoginClient;-><init>(Landroidx/fragment/app/Fragment;)V
...
.method protected getLayoutResId()I
    ...
    sget v5, Lcom/facebook/common/R$layout;->com_facebook_login_fragment:I
...
.method getLoginClient()Lcom/facebook/login/LoginClient;
    ...
    const-string v1, "getLoginClient"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Lcom/facebook/login/LoginFragment;->loginClient:Lcom/facebook/login/LoginClient;
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-virtual {v5, p1, p2, p3}, Lcom/facebook/login/LoginClient;->onActivityResult(IILandroid/content/Intent;)Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    new-instance v5, Lcom/facebook/login/LoginFragment$1;

    invoke-direct {v5, p0}, Lcom/facebook/login/LoginFragment$1;-><init>(Lcom/facebook/login/LoginFragment;)V

    invoke-virtual {p1, v5}, Lcom/facebook/login/LoginClient;->setOnCompletedListener(Lcom/facebook/login/LoginClient$OnCompletedListener;)V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    new-instance v5, Lcom/facebook/login/LoginFragment$2;

    invoke-direct {v5, p0, p2}, Lcom/facebook/login/LoginFragment$2;-><init>(Lcom/facebook/login/LoginFragment;Landroid/view/View;)V

    invoke-virtual {p3, v5}, Lcom/facebook/login/LoginClient;->setBackgroundProcessingListener(Lcom/facebook/login/LoginClient$BackgroundProcessingListener;)V
...
.method public onDestroy()V
    ...
    invoke-virtual {v5}, Lcom/facebook/login/LoginClient;->cancelCurrentHandler()V
...
.method public onPause()V
    ...
    sget v6, Lcom/facebook/common/R$id;->com_facebook_login_fragment_progress_bar:I
...
.method public onResume()V
    ...
    iget-object v5, p0, Lcom/facebook/login/LoginFragment;->callingPackage:Ljava/lang/String;

    if-nez v5, :cond_0

    const-string v5, "LoginFragment"

    const-string v6, "Cannot call LoginFragment with a null calling package. This can occur if the launchMode of the caller is singleInstance."
    ...
    iget-object v6, p0, Lcom/facebook/login/LoginFragment;->request:Lcom/facebook/login/LoginClient$Request;

    invoke-virtual {v5, v6}, Lcom/facebook/login/LoginClient;->startOrContinueAuth(Lcom/facebook/login/LoginClient$Request;)V

...
.method static createAccessTokenFromNativeLogin(Landroid/os/Bundle;Lcom/facebook/AccessTokenSource;Ljava/lang/String;)Lcom/facebook/AccessToken;
    ...
    const-string v1, "createAccessTokenFromNativeLogin"
    ...
    const-string v9, "com.facebook.platform.extra.EXPIRES_SECONDS_SINCE_EPOCH"

    invoke-static {v5, v9, v6}, Lcom/facebook/internal/Utility;->getBundleLongAsDate(Landroid/os/Bundle;Ljava/lang/String;Ljava/util/Date;)Ljava/util/Date;
    ...
    const-string v7, "com.facebook.platform.extra.EXTRA_DATA_ACCESS_EXPIRATION_TIME"

    invoke-static {v5, v7, v6}, Lcom/facebook/internal/Utility;->getBundleLongAsDate(Landroid/os/Bundle;Ljava/lang/String;Ljava/util/Date;)Ljava/util/Date;
    ...
    :cond_0
    const-string v6, "com.facebook.platform.extra.USER_ID"
    ...
    invoke-direct/range {v10 .. v21}, Lcom/facebook/AccessToken;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Collection;Lcom/facebook/AccessTokenSource;Ljava/util/Date;Ljava/util/Date;Ljava/util/Date;Ljava/lang/String;)V
...
.method public static createAccessTokenFromWebBundle(Ljava/util/Collection;Landroid/os/Bundle;Lcom/facebook/AccessTokenSource;Ljava/lang/String;)Lcom/facebook/AccessToken;
    ...
    const-string v1, "createAccessTokenFromWebBundle"
    ...
    const-string v6, "granted_scopes"
    ...
    :goto_1
    const-string v6, "expired_scopes"
    ...
    const-string v6, "signed_request"
...
.method static getUserIDFromSignedRequest(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "getUserIDFromSignedRequest"
...
.method protected addLoggingExtra(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    iget-object v5, p0, Lcom/facebook/login/LoginMethodHandler;->methodLoggingExtras:Ljava/util/Map;
    ...
    iput-object v5, p0, Lcom/facebook/login/LoginMethodHandler;->methodLoggingExtras:Ljava/util/Map;
...
.method protected getClientState(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    const-string v6, "0_auth_logger_id"
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0, v5}, Lcom/facebook/login/LoginMethodHandler;->putChallengeParam(Lorg/json/JSONObject;)V
    ...
    const-string v7, "Error creating client state json: "
    ...
    const-string v6, "LoginMethodHandler"
...
.method protected logWebLoginCompleted(Ljava/lang/String;)V
    ...
    const-string v1, "logWebLoginCompleted"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v5, p0, Lcom/facebook/login/LoginMethodHandler;->loginClient:Lcom/facebook/login/LoginClient;

    invoke-virtual {v5}, Lcom/facebook/login/LoginClient;->getPendingRequest()Lcom/facebook/login/LoginClient$Request;

    move-result-object v5

    invoke-virtual {v5}, Lcom/facebook/login/LoginClient$Request;->getApplicationId()Ljava/lang/String;

    move-result-object v5

    new-instance v6, Lcom/facebook/appevents/InternalAppEventsLogger;

    iget-object v7, p0, Lcom/facebook/login/LoginMethodHandler;->loginClient:Lcom/facebook/login/LoginClient;

    invoke-virtual {v7}, Lcom/facebook/login/LoginClient;->getActivity()Landroidx/fragment/app/FragmentActivity;

    move-result-object v7

    invoke-direct {v6, v7, v5}, Lcom/facebook/appevents/InternalAppEventsLogger;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    new-instance v7, Landroid/os/Bundle;

    invoke-direct {v7}, Landroid/os/Bundle;-><init>()V

    const-string v8, "fb_web_login_e2e"
    ...
    invoke-virtual {v6, p1, v5, v7}, Lcom/facebook/appevents/InternalAppEventsLogger;->logEventImplicitly(Ljava/lang/String;Ljava/lang/Double;Landroid/os/Bundle;)V
...
.method setLoginClient(Lcom/facebook/login/LoginClient;)V
    ...
    const-string v1, "setLoginClient"
    ...
    const-string v5, "Can\'t set LoginClient if it is already set."

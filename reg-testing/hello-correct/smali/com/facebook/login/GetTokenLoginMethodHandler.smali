...
.method cancel()V
    ...
    const-string v0, "Lcom/facebook/login/GetTokenLoginMethodHandler;"
    ...
    invoke-virtual {v5}, Lcom/facebook/login/GetTokenClient;->cancel()V
...
.method complete(Lcom/facebook/login/LoginClient$Request;Landroid/os/Bundle;)V
    ...
    const-string v5, "com.facebook.platform.extra.USER_ID"
    ...
    invoke-virtual {v5}, Lcom/facebook/login/LoginClient;->notifyBackgroundProcessingStart()V
    ...
    new-instance v6, Lcom/facebook/login/GetTokenLoginMethodHandler$2;

    invoke-direct {v6, p0, p2, p1}, Lcom/facebook/login/GetTokenLoginMethodHandler$2;-><init>(Lcom/facebook/login/GetTokenLoginMethodHandler;Landroid/os/Bundle;Lcom/facebook/login/LoginClient$Request;)V
...
.method getTokenCompleted(Lcom/facebook/login/LoginClient$Request;Landroid/os/Bundle;)V
    ...
    const-string v1, "getTokenCompleted"
    ...
    invoke-virtual {v5, v6}, Ljava/util/ArrayList;->containsAll(Ljava/util/Collection;)Z
    ...
    invoke-virtual {p0, v6, v5}, Lcom/facebook/login/GetTokenLoginMethodHandler;->addLoggingExtra(Ljava/lang/String;Ljava/lang/Object;)V
...
.method onComplete(Lcom/facebook/login/LoginClient$Request;Landroid/os/Bundle;)V
    ...
    sget-object v5, Lcom/facebook/AccessTokenSource;->FACEBOOK_APPLICATION_SERVICE:Lcom/facebook/AccessTokenSource;
    ...
    invoke-static {p2, v5, p1}, Lcom/facebook/login/GetTokenLoginMethodHandler;->createAccessTokenFromNativeLogin(Landroid/os/Bundle;Lcom/facebook/AccessTokenSource;Ljava/lang/String;)Lcom/facebook/AccessToken;
...
.method tryAuthorize(Lcom/facebook/login/LoginClient$Request;)Z
    ...
    new-instance v5, Lcom/facebook/login/GetTokenClient;

    iget-object v6, p0, Lcom/facebook/login/GetTokenLoginMethodHandler;->loginClient:Lcom/facebook/login/LoginClient;
    ...
    invoke-direct {v5, v6, v7}, Lcom/facebook/login/GetTokenClient;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v5}, Lcom/facebook/login/GetTokenClient;->start()Z
    ...
    new-instance v5, Lcom/facebook/login/GetTokenLoginMethodHandler$1;

    invoke-direct {v5, p0, p1}, Lcom/facebook/login/GetTokenLoginMethodHandler$1;-><init>(Lcom/facebook/login/GetTokenLoginMethodHandler;Lcom/facebook/login/LoginClient$Request;)V
    ...
    invoke-virtual {p1, v5}, Lcom/facebook/login/GetTokenClient;->setCompletedListener(Lcom/facebook/internal/PlatformServiceClient$CompletedListener;)V

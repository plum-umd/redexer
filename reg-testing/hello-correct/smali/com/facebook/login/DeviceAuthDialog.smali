...
.method static synthetic access$000(Lcom/facebook/login/DeviceAuthDialog;)Z
    ...
    const-string v0, "Lcom/facebook/login/DeviceAuthDialog;"
...
.method private completeLogin(Ljava/lang/String;Lcom/facebook/internal/Utility$PermissionsLists;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
    ...
    const-string v1, "completeLogin"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    move-object/from16 v5, p0

    iget-object v6, v5, Lcom/facebook/login/DeviceAuthDialog;->deviceAuthMethodHandler:Lcom/facebook/login/DeviceAuthMethodHandler;
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/facebook/internal/Utility$PermissionsLists;->getGrantedPermissions()Ljava/util/List;

    move-result-object v10

    move-object/from16 v0, p2

    invoke-virtual/range {v0 .. v0}, Lcom/facebook/internal/Utility$PermissionsLists;->getDeclinedPermissions()Ljava/util/List;

    move-result-object v11

    move-object/from16 v0, p2

    invoke-virtual/range {v0 .. v0}, Lcom/facebook/internal/Utility$PermissionsLists;->getExpiredPermissions()Ljava/util/List;

    move-result-object v12

    sget-object v13, Lcom/facebook/AccessTokenSource;->DEVICE_AUTH:Lcom/facebook/AccessTokenSource;
    ...
    invoke-virtual/range {v6 .. v16}, Lcom/facebook/login/DeviceAuthMethodHandler;->onSuccess(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Collection;Lcom/facebook/AccessTokenSource;Ljava/util/Date;Ljava/util/Date;Ljava/util/Date;)V

    iget-object v6, v5, Lcom/facebook/login/DeviceAuthDialog;->dialog:Landroid/app/Dialog;
...
.method private getPollRequest()Lcom/facebook/GraphRequest;
    ...
    const-string v1, "getPollRequest"
    ...
    iget-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->currentRequestState:Lcom/facebook/login/DeviceAuthDialog$RequestState;

    invoke-virtual {v5}, Lcom/facebook/login/DeviceAuthDialog$RequestState;->getRequestCode()Ljava/lang/String;
    ...
    new-instance v10, Lcom/facebook/login/DeviceAuthDialog$4;

    invoke-direct {v10, p0}, Lcom/facebook/login/DeviceAuthDialog$4;-><init>(Lcom/facebook/login/DeviceAuthDialog;)V

    const/4 v6, 0x0

    const-string v7, "device/login_status"
...
.method private onSuccess(Ljava/lang/String;Ljava/lang/Long;Ljava/lang/Long;)V
    ...
    const-string v6, "id,permissions,name"
    ...
    invoke-direct/range {v15 .. v25}, Lcom/facebook/AccessToken;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Collection;Lcom/facebook/AccessTokenSource;Ljava/util/Date;Ljava/util/Date;Ljava/util/Date;)V

    new-instance v11, Lcom/facebook/GraphRequest;

    sget-object v9, Lcom/facebook/HttpMethod;->GET:Lcom/facebook/HttpMethod;

    new-instance v10, Lcom/facebook/login/DeviceAuthDialog$7;

    move-object/from16 v12, p0

    move-object/from16 v13, p1

    invoke-direct {v10, v12, v13, v5, v7}, Lcom/facebook/login/DeviceAuthDialog$7;-><init>(Lcom/facebook/login/DeviceAuthDialog;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
...
.method private poll()V
    ...
    invoke-virtual {v5, v6, v7}, Lcom/facebook/login/DeviceAuthDialog$RequestState;->setLastPoll(J)V
    ...
    iput-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->currentGraphRequestPoll:Lcom/facebook/GraphRequestAsyncTask;
...
.method private presentConfirmation(Ljava/lang/String;Lcom/facebook/internal/Utility$PermissionsLists;Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
    ...
    const-string v1, "presentConfirmation"
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/facebook/login/DeviceAuthDialog;->getResources()Landroid/content/res/Resources;
    ...
    sget v7, Lcom/facebook/common/R$string;->com_facebook_smart_login_confirmation_continue_as:I
    ...
    sget v8, Lcom/facebook/common/R$string;->com_facebook_smart_login_confirmation_cancel:I
    ...
    invoke-virtual/range {v0 .. v0}, Lcom/facebook/login/DeviceAuthDialog;->getContext()Landroid/content/Context;
    ...
    const-string v0, "Landroid/app/AlertDialog$Builder;"
    ...
    new-instance v8, Lcom/facebook/login/DeviceAuthDialog$6;
    ...
    invoke-direct/range {v10 .. v16}, Lcom/facebook/login/DeviceAuthDialog$6;-><init>(Lcom/facebook/login/DeviceAuthDialog;Ljava/lang/String;Lcom/facebook/internal/Utility$PermissionsLists;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;)V
    ...
    invoke-direct/range {v0 .. v1}, Lcom/facebook/login/DeviceAuthDialog$5;-><init>(Lcom/facebook/login/DeviceAuthDialog;)V
    ...
    const-string v0, "Landroid/app/AlertDialog;"
...
.method private schedulePoll()V
    ...
    new-instance v6, Lcom/facebook/login/DeviceAuthDialog$3;

    invoke-direct {v6, p0}, Lcom/facebook/login/DeviceAuthDialog$3;-><init>(Lcom/facebook/login/DeviceAuthDialog;)V

    iget-object v7, p0, Lcom/facebook/login/DeviceAuthDialog;->currentRequestState:Lcom/facebook/login/DeviceAuthDialog$RequestState;

    invoke-virtual {v7}, Lcom/facebook/login/DeviceAuthDialog$RequestState;->getInterval()J
    ...
    const-string v0, "Ljava/util/concurrent/ScheduledThreadPoolExecutor;"
    ...
    iput-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->scheduledPoll:Ljava/util/concurrent/ScheduledFuture;
...
.method private setCurrentRequestState(Lcom/facebook/login/DeviceAuthDialog$RequestState;)V
    ...
    const-string v1, "setCurrentRequestState"
    ...
    iget-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->confirmationCode:Landroid/widget/TextView;
    ...
    invoke-static {v5}, Lcom/facebook/devicerequests/internal/DeviceRequestsHelper;->generateQRCode(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->instructions:Landroid/widget/TextView;
    ...
    invoke-virtual {v5, v7, v6, v7, v7}, Landroid/widget/TextView;->setCompoundDrawablesWithIntrinsicBounds(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->progressBar:Landroid/view/View;
    ...
    iget-boolean v5, p0, Lcom/facebook/login/DeviceAuthDialog;->isRetry:Z
    ...
    invoke-static {v5}, Lcom/facebook/devicerequests/internal/DeviceRequestsHelper;->startAdvertisementService(Ljava/lang/String;)Z
    ...
    const-string v6, "fb_smart_login_service"

    invoke-virtual {v5, v6}, Lcom/facebook/appevents/InternalAppEventsLogger;->logEventImplicitly(Ljava/lang/String;)V
...
.method protected initializeContentView(Z)Landroid/view/View;
    ...
    const-string v1, "initializeContentView"
    ...
    sget v5, Lcom/facebook/common/R$id;->progress_bar:I
    ...
    iput-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->progressBar:Landroid/view/View;

    sget v5, Lcom/facebook/common/R$id;->confirmation_code:I
    ...
    iput-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->confirmationCode:Landroid/widget/TextView;

    sget v5, Lcom/facebook/common/R$id;->cancel_button:I
    ...
    sget v5, Lcom/facebook/common/R$id;->com_facebook_device_auth_instructions:I
    ...
    iput-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->instructions:Landroid/widget/TextView;

    iget-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->instructions:Landroid/widget/TextView;

    sget v6, Lcom/facebook/common/R$string;->com_facebook_device_auth_instructions:I
    ...
    invoke-virtual {p0, v6}, Lcom/facebook/login/DeviceAuthDialog;->getString(I)Ljava/lang/String;
    ...
    const-string v0, "Landroid/text/Html;"
...
.method protected onCancel()V
    ...
    iget-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->completed:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v5}, Lcom/facebook/login/DeviceAuthDialog$RequestState;->getUserCode()Ljava/lang/String;

    move-result-object v5

    invoke-static {v5}, Lcom/facebook/devicerequests/internal/DeviceRequestsHelper;->cleanUpAdvertisementService(Ljava/lang/String;)V

    :cond_1
    iget-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->deviceAuthMethodHandler:Lcom/facebook/login/DeviceAuthMethodHandler;

    if-eqz v5, :cond_2

    invoke-virtual {v5}, Lcom/facebook/login/DeviceAuthMethodHandler;->onCancel()V

    :cond_2
    iget-object v5, p0, Lcom/facebook/login/DeviceAuthDialog;->dialog:Landroid/app/Dialog;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    invoke-direct {p1, v5, v6}, Landroid/app/Dialog;-><init>(Landroid/content/Context;I)V
...
.method public onDestroy()V
    ...
    iput-boolean v5, p0, Lcom/facebook/login/DeviceAuthDialog;->isBeingDestroyed:Z

    iget-object v6, p0, Lcom/facebook/login/DeviceAuthDialog;->completed:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v6, p0, Lcom/facebook/login/DeviceAuthDialog;->currentGraphRequestPoll:Lcom/facebook/GraphRequestAsyncTask;
    ...
    invoke-virtual {v6, v5}, Lcom/facebook/GraphRequestAsyncTask;->cancel(Z)Z
    ...
    :cond_0
    iget-object v6, p0, Lcom/facebook/login/DeviceAuthDialog;->scheduledPoll:Ljava/util/concurrent/ScheduledFuture;
...
.method protected onError(Lcom/facebook/FacebookException;)V
    ...
    invoke-virtual {v5, p1}, Lcom/facebook/login/DeviceAuthMethodHandler;->onError(Ljava/lang/Exception;)V
...
.method public startLogin(Lcom/facebook/login/LoginClient$Request;)V
    ...
    new-instance v10, Lcom/facebook/login/DeviceAuthDialog$1;

    invoke-direct {v10, p0}, Lcom/facebook/login/DeviceAuthDialog$1;-><init>(Lcom/facebook/login/DeviceAuthDialog;)V

    const-string v7, "device/login"

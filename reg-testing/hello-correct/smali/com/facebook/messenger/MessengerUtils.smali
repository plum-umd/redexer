...
.method public static finishShareToMessenger(Landroid/app/Activity;Lcom/facebook/messenger/ShareToMessengerParams;)V
    ...
    const-string v0, "Lcom/facebook/messenger/MessengerUtils;"

    const-string v1, "finishShareToMessenger"
    ...
    invoke-static {v5}, Lbolts/AppLinks;->getAppLinkExtras(Landroid/content/Intent;)Landroid/os/Bundle;
    ...
    const-string v8, "com.facebook.orca.extra.PROTOCOL_VERSION"
    ...
    const-string v6, "com.facebook.orca.extra.THREAD_TOKEN"
    ...
    const-string v1, "setDataAndType"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logAPIEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v7, v5, v6}, Landroid/content/Intent;->setDataAndType(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Intent;
    ...
    const-string v6, "com.facebook.orca.extra.APPLICATION_ID"
    ...
    iget-object v5, p1, Lcom/facebook/messenger/ShareToMessengerParams;->metaData:Ljava/lang/String;

    const-string v6, "com.facebook.orca.extra.METADATA"
    ...
    invoke-virtual {p0, p1, v7}, Landroid/app/Activity;->setResult(ILandroid/content/Intent;)V
...
.method private static getAllAvailableProtocolVersions(Landroid/content/Context;)Ljava/util/Set;
    ...
    const-string v1, "getAllAvailableProtocolVersions"
    ...
    const-string v6, "content://com.facebook.orca.provider.MessengerPlatformProvider/versions"
...
.method public static getMessengerThreadParamsForIntent(Landroid/content/Intent;)Lcom/facebook/messenger/MessengerThreadParams;
    ...
    const-string v1, "getMessengerThreadParamsForIntent"
    ...
    :cond_0
    const-string v7, "com.facebook.orca.category.PLATFORM_THREAD_20150314"
    ...
    const-string v7, "com.facebook.orca.extra.PARTICIPANTS"
    ...
    const-string v9, "com.facebook.orca.extra.IS_COMPOSE"
    ...
    sget-object v9, Lcom/facebook/messenger/MessengerThreadParams$Origin;->UNKNOWN:Lcom/facebook/messenger/MessengerThreadParams$Origin;

    if-eqz v8, :cond_1

    sget-object v9, Lcom/facebook/messenger/MessengerThreadParams$Origin;->REPLY_FLOW:Lcom/facebook/messenger/MessengerThreadParams$Origin;
    ...
    sget-object v9, Lcom/facebook/messenger/MessengerThreadParams$Origin;->COMPOSE_FLOW:Lcom/facebook/messenger/MessengerThreadParams$Origin;

    :cond_2
    :goto_0
    new-instance p0, Lcom/facebook/messenger/MessengerThreadParams;

    invoke-static {v7}, Lcom/facebook/messenger/MessengerUtils;->parseParticipants(Ljava/lang/String;)Ljava/util/List;

    move-result-object v7

    invoke-direct {p0, v9, v5, v6, v7}, Lcom/facebook/messenger/MessengerThreadParams;-><init>(Lcom/facebook/messenger/MessengerThreadParams$Origin;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method public static hasMessengerInstalled(Landroid/content/Context;)Z
    ...
    const-string v1, "hasMessengerInstalled"
...
.method public static openMessengerInPlayStore(Landroid/content/Context;)V
    ...
    const-string v1, "openMessengerInPlayStore"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    :try_start_0
    const-string v5, "market://details?id=com.facebook.orca"

    invoke-static {p0, v5}, Lcom/facebook/messenger/MessengerUtils;->startViewUri(Landroid/content/Context;Ljava/lang/String;)V
    :try_end_0
    ...
    :catch_0
    const-string v5, "http://play.google.com/store/apps/details?id=com.facebook.orca"
...
.method private static parseParticipants(Ljava/lang/String;)Ljava/util/List;
    ...
    const-string v1, "parseParticipants"
...
.method public static shareToMessenger(Landroid/app/Activity;ILcom/facebook/messenger/ShareToMessengerParams;)V
    ...
    const-string v1, "shareToMessenger"
...
.method private static shareToMessenger20150314(Landroid/app/Activity;ILcom/facebook/messenger/ShareToMessengerParams;)V
    ...
    const-string v1, "shareToMessenger20150314"
    ...
    iget-object v8, p2, Lcom/facebook/messenger/ShareToMessengerParams;->uri:Landroid/net/Uri;
    :try_end_2
    ...
    iget-object v7, p2, Lcom/facebook/messenger/ShareToMessengerParams;->mimeType:Ljava/lang/String;
    ...
    const-string v8, "com.facebook.orca.extra.APPLICATION_ID"
    ...
    const-string v7, "com.facebook.orca.extra.METADATA"

    :try_start_8
    iget-object v8, p2, Lcom/facebook/messenger/ShareToMessengerParams;->metaData:Ljava/lang/String;
    :try_end_8
    ...
    const-string v7, "com.facebook.orca.extra.EXTERNAL_URI"
    ...
    :try_start_b
    invoke-virtual {v6, v7, p2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    :try_end_b
    ...
    const-string v1, "getLaunchIntentForPackage"

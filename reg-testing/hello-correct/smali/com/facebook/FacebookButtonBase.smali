...
.method private logButtonCreated(Landroid/content/Context;)V
    ...
    const-string v1, "logButtonCreated"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Lcom/facebook/appevents/InternalAppEventsLogger;

    invoke-direct {v5, p1}, Lcom/facebook/appevents/InternalAppEventsLogger;-><init>(Landroid/content/Context;)V

    iget-object p1, p0, Lcom/facebook/FacebookButtonBase;->analyticsButtonCreatedEventName:Ljava/lang/String;

    invoke-virtual {v5, p1}, Lcom/facebook/appevents/InternalAppEventsLogger;->logEventImplicitly(Ljava/lang/String;)V
...
.method private logButtonTapped(Landroid/content/Context;)V
    ...
    const-string v1, "logButtonTapped"
...
.method private parseBackgroundAttributes(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    const-string v1, "parseBackgroundAttributes"
...
.method private parseCompoundDrawableAttributes(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    const-string v1, "parseCompoundDrawableAttributes"
    ...
    :try_start_7
    invoke-virtual {p0, p3, p4, v5, v6}, Lcom/facebook/FacebookButtonBase;->setCompoundDrawablesWithIntrinsicBounds(IIII)V
    :try_end_7
    .catchall {:try_start_7 .. :try_end_7} :catchall_0
...
.method private parseContentAttributes(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    const-string v1, "parseContentAttributes"
    ...
    :try_start_7
    invoke-virtual {p0, p3, p4, v5, p2}, Lcom/facebook/FacebookButtonBase;->setPadding(IIII)V
    :try_end_7
    .catchall {:try_start_7 .. :try_end_7} :catchall_0
...
.method private parseTextAttributes(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    const-string v1, "parseTextAttributes"
    ...
    invoke-virtual {v8, p2, v6, p3, p4}, Landroid/content/res/Resources$Theme;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    :try_start_1
    invoke-virtual {p0, v8}, Lcom/facebook/FacebookButtonBase;->setTextColor(Landroid/content/res/ColorStateList;)V
    :try_end_1
    ...
    :try_start_3
    invoke-virtual {p0, v8}, Lcom/facebook/FacebookButtonBase;->setGravity(I)V
    :try_end_3
    ...
    invoke-virtual {p1, p2, v6, p3, p4}, Landroid/content/res/Resources$Theme;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    :try_start_6
    invoke-virtual {p0, v7, p2}, Lcom/facebook/FacebookButtonBase;->setTextSize(IF)V
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_0
    ...
    invoke-virtual {p1, v5, v5}, Landroid/content/res/TypedArray;->getInt(II)I
...
.method private setupOnClickListener()V
    ...
    const-string v1, "setupOnClickListener"

    invoke-static/range {v0 .. v2}, Lorg/umd/logging/Logger;->logMethodEntry(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    new-instance v5, Lcom/facebook/FacebookButtonBase$1;

    invoke-direct {v5, p0}, Lcom/facebook/FacebookButtonBase$1;-><init>(Lcom/facebook/FacebookButtonBase;)V
    ...
    invoke-super {p0, v5}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method protected callExternalOnClickListener(Landroid/view/View;)V
    ...
    iget-object v5, p0, Lcom/facebook/FacebookButtonBase;->externalOnClickListener:Landroid/view/View$OnClickListener;
...
.method public getCompoundPaddingLeft()I
    ...
    iget-boolean v5, p0, Lcom/facebook/FacebookButtonBase;->overrideCompoundPadding:Z

    if-eqz v5, :cond_0

    iget v5, p0, Lcom/facebook/FacebookButtonBase;->overrideCompoundPaddingLeft:I
...
.method public getCompoundPaddingRight()I
    ...
    iget v5, p0, Lcom/facebook/FacebookButtonBase;->overrideCompoundPaddingRight:I
...
.method public getFragment()Landroidx/fragment/app/Fragment;
    ...
    iget-object v5, p0, Lcom/facebook/FacebookButtonBase;->parentFragment:Lcom/facebook/internal/FragmentWrapper;

    if-eqz v5, :cond_0

    invoke-virtual {v5}, Lcom/facebook/internal/FragmentWrapper;->getSupportFragment()Landroidx/fragment/app/Fragment;
...
.method public getNativeFragment()Landroid/app/Fragment;
    ...
    invoke-virtual {v5}, Lcom/facebook/internal/FragmentWrapper;->getNativeFragment()Landroid/app/Fragment;
...
.method protected onAttachedToWindow()V
    ...
    invoke-direct {p0, v5}, Lcom/facebook/FacebookButtonBase;->logButtonCreated(Landroid/content/Context;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iput v5, p0, Lcom/facebook/FacebookButtonBase;->overrideCompoundPaddingLeft:I

    add-int/2addr v8, v9

    iput v8, p0, Lcom/facebook/FacebookButtonBase;->overrideCompoundPaddingRight:I

    iput-boolean v6, p0, Lcom/facebook/FacebookButtonBase;->overrideCompoundPadding:Z
    ...
    iput-boolean v7, p0, Lcom/facebook/FacebookButtonBase;->overrideCompoundPadding:Z
...
.method public setFragment(Landroid/app/Fragment;)V
    ...
    iput-object v5, p0, Lcom/facebook/FacebookButtonBase;->parentFragment:Lcom/facebook/internal/FragmentWrapper;
